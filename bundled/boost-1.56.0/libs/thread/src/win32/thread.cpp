...
thread::native_handle_type thread::native_handle() {
    detail::thread_data_ptr local_thread_info = (get_thread_info)();
    return local_thread_info ? (detail::win32::handle) local_thread_info->thread_handle
        ...
        LARGE_INTEGER get_due_time(detail::timeout const &target_time) {
            ...
            if (target_time.relative) {
                detail::win32::ticks_type const elapsed_milliseconds =
                        detail::win32::GetTickCount64()() - target_time.start;
    ...
    namespace no_interruption_point {
        bool non_interruptible_wait(detail::win32::handle handle_to_wait_for, detail::timeout target_time) {
            ...
            do {
                ...
                if (handle_count) {
                    unsigned long const notified_index = detail::win32::WaitForMultipleObjects(handle_count, handles,
                                                                                               false,
                                                                                               using_timer ? INFINITE
                                                                                                           : time_left.milliseconds);
                    if (notified_index < handle_count) {
