...
namespace boost {
    ...
    namespace detail {
        ...
        public:
            ...
            thread_data (BOOST_THREAD_RV_REF(F)
    ...
    class BOOST_THREAD_DECL thread
            {
                    ...
                    static inline detail::thread_data_ptr make_thread_info(BOOST_THREAD_RV_REF(F) f)
                    {
                        return detail::thread_data_ptr(
                                detail::heap_new<detail::thread_data<typename boost::remove_reference<F>::type> >(
                                        boost::forward<F>(f)));
                    }
#endif
...
namespace this_thread {
    ...
    void at_thread_exit(F f) {
        detail::thread_exit_function_base *const thread_exit_func = detail::heap_new<detail::thread_exit_function<F> >(
                f);
