...
#define BOOST_ONCE_INIT boost::once_flag()
    ...
    struct once_flag {
        ...
        BOOST_THREAD_ATTRIBUTE_MAY_ALIAS thread_detail::atomic_int_type
        storage;
    };
...
inline void call_once(once_flag &flag, BOOST_THREAD_RV_REF(Function) f, BOOST_THREAD_RV_REF(ArgTypes)...

args)
{
if (
thread_detail::enter_once_region(flag)
)
{
BOOST_TRY
{
