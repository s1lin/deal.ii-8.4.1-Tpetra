...
namespace future_state {
    enum state {
        uninitialized, waiting, ready, moved, deferred
    };
}
...
namespace detail {
    ...
    public:
        ...
        explicit future_async_shared_state_base (BOOST_THREAD_RV_REF(boost::thread)
    ...
    public:
        explicit future_async_shared_state (BOOST_THREAD_FWD_REF(Fp)

        f) :

        base_type (thread( &

        future_async_shared_state::run, this,
        boost::forward<Fp>(f)
        ))
        {
        }
    ...
    public:
        explicit future_deferred_shared_state (BOOST_THREAD_FWD_REF(Fp)
...
namespace detail {
    ...
    public:
        ...
        explicit basic_future(const shared_future<R> &)
    ...
    public:
        ...
        basic_future (BOOST_THREAD_RV_REF(basic_future)
        ...
        basic_future &operator=(BOOST_THREAD_RV_REF(basic_future) other)
...
public:
    ...
    BOOST_THREAD_FUTURE (BOOST_THREAD_RV_REF(BOOST_THREAD_FUTURE)
    ...
    BOOST_THREAD_FUTURE &operator=(BOOST_THREAD_RV_REF(BOOST_THREAD_FUTURE) other)
...
//        }
    ...
    typename boost::disable_if<is_void < R2>, move_dest_type>
...
//        }
    ...
    shared_future (BOOST_THREAD_RV_REF(shared_future)
    ...
    shared_future(BOOST_THREAD_RV_REF(BOOST_THREAD_FUTURE<R>) other)

    BOOST_NOEXCEPT :
    base_type(boost::move(static_cast<base_type &>(BOOST_THREAD_RV(other)))) {
    }

    shared_future &operator=(BOOST_THREAD_RV_REF(shared_future) other)
    ...
    shared_future &operator=(BOOST_THREAD_RV_REF(BOOST_THREAD_FUTURE<R>) other)
    ...
    template<typename R2>
    typename boost::disable_if<is_void < R2>, typename detail::shared_state<R>::shared_future_get_result_type>
...
namespace detail {
    /// Copy construction from a shared_future
    template<typename R>
    inline basic_future<R>::basic_future(const shared_future<R> &other)
...
public:
    ...
    // Assignment
    promise (BOOST_THREAD_RV_REF(promise)

    rhs)
    BOOST_NOEXCEPT :
            future_(BOOST_THREAD_RV(rhs).future_), future_obtained(BOOST_THREAD_RV(rhs)
    .future_obtained)
    {
    ...
    promise &operator=(BOOST_THREAD_RV_REF(promise) rhs)
...
public:
    ...
    // Assignment
    promise(BOOST_THREAD_RV_REF(promise) rhs)
...
namespace boost {
    ...
    namespace detail {
        ...
        public:
            ...
            task_shared_state (BOOST_THREAD_RV_REF(F)
    ...
    public:
        ...
        template<class F>
        explicit packaged_task (BOOST_THREAD_FWD_REF(F)
        ...
        // assignment
        packaged_task (BOOST_THREAD_RV_REF(packaged_task)
        ...
        packaged_task &operator=(BOOST_THREAD_RV_REF(packaged_task) other)
