...
inline void
call_once(once_flag &flag, BOOST_THREAD_RV_REF(Function) f, BOOST_THREAD_RV_REF(A) a, BOOST_THREAD_RV_REF(ArgTypes)...
...
BOOST_VERIFY(!
::boost::detail::win32::WaitForSingleObject(
        ctx
