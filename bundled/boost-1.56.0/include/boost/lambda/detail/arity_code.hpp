...
// RETHROW means, that a rethrow expression is used somewhere in the lambda_functor.
        ...
        struct get_arity {
            ...
            BOOST_STATIC_CONSTANT(int,
                                  value = detail::get_arity_<typename boost::remove_cv<typename boost::remove_reference<T>::type>::type>::value);
...
template<class T>
struct get_tuple_arity {
    BOOST_STATIC_CONSTANT(int, value = get_arity<typename T::head_type>::value |
