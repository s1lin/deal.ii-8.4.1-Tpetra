...
// the apply function
BOOST_STATIC_ASSERT(!(
boost::is_float<plain_A>::value &&boost::is_float<plain_B>::value
));
...
typedef typename
plain_return_type_2<logical_action < Act>, plain_A, plain_B>
::type type;
...
typedef typename
plain_return_type_2<relational_action < Act>, plain_A, plain_B>
::type type;
};
