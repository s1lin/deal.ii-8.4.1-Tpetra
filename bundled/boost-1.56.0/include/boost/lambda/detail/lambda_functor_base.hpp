...
// 'cannot bind temporaries to non-const references' errors.
            ...
            struct has_null_type {
                BOOST_STATIC_CONSTANT(bool, value = (is_null_type<typename Tuple::head_type>::value ||
...
// the explicit_return_type_action case -----------------------------------
        ...
        class lambda_functor_base<explicit_return_type_action < RET>
...
//  Function actions, casts, throws,... all go via these classes.
    ...
    class lambda_functor_base<action < 0, Act>
...
BOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(1)
    ...
    typedef typename
    deduce_argument_types < Args, tuple < CALL_REFERENCE_TYPES > > ::type
    rets_t;
