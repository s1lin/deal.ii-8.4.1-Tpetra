...
// implementation of xml_text_archive
        ...
        basic_xml_iarchive<Archive>::load_override(object_id_type
        & t, int) {
    ...
    basic_xml_iarchive<Archive>::load_override(version_type
    & t, int) {
...
basic_xml_iarchive<Archive>::load_override(class_id_type
& t, int){
...
basic_xml_iarchive<Archive>::load_override(tracking_type
& t, int){
