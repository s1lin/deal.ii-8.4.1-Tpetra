...
/// @cond
        ...
        namespace detail {
            ...
            struct group_functions {
                ...
                static node_ptr
                get_prev_to_first_in_group(const slist_node_ptr &bucket_node, const node_ptr &first_in_group) {
                ...
                static void
                erase_from_group(const slist_node_ptr &end_ptr, const node_ptr &to_erase_ptr, detail::true_) {
                ...
                static node_ptr get_last_in_group(const node_ptr &n, detail::false_) { return n; }

                static void init_group(const node_ptr &n, true_) { group_algorithms::init(n); }
            ...
            public:
                incremental_rehash_rollback
                        ...
                        : source_bucket_(source_bucket), destiny_bucket_(destiny_bucket), split_traits_(split_traits),
                          released_(false) {}
            ...
            struct node_functions {
                static void
                store_hash(typename NodeTraits::node_ptr p, std::size_t h, true_) { return NodeTraits::set_hash(p, h); }
            ...
            inline std::size_t hash_to_bucket_split(std::size_t hash_value, std::size_t bucket_cnt, std::size_t split) {
                std::size_t bucket_number = detail::hash_to_bucket(hash_value, bucket_cnt,
                                                                   detail::bool_<Power2Buckets>());
                if (Incremental)
...
//!a hash container.
        ...
        struct downcast_node_to_value_t
            ...
            typedef typename detail::add_const_if_c
                    <typename ValueTraits::node_traits::node, IsConst>::type &intermediate_argument_type;
            typedef typename pointer_traits
...
//value from the iterator and detect the bucket
        ...
        struct bucket_plus_vtraits : public ValueTraits {
            ...
            //bucket_value_traits
            //
            const bucket_plus_vtraits &get_bucket_value_traits() const { return *this; }

            bucket_plus_vtraits &get_bucket_value_traits() { return *this; }
            ...
            //value traits
            //
            const value_traits &priv_value_traits() const { return *this; }

            value_traits &priv_value_traits() { return *this; }

            //bucket_traits
            //
            const bucket_traits &priv_bucket_traits() const { return this->bucket_traits_; }

            bucket_traits &priv_bucket_traits() { return this->bucket_traits_; }

            //bucket operations
            bucket_ptr priv_bucket_pointer() const { return this->priv_bucket_traits().bucket_begin(); }

            typename slist_impl::size_type
            priv_bucket_count() const { return this->priv_bucket_traits().bucket_count(); }
            ...
            siterator
            priv_invalid_local_it() const { return this->priv_bucket_traits().bucket_begin()->before_begin(); }
            ...
            static siterator priv_get_previous(bucket_type &b, siterator i, detail::true_)   //optimize multikey
            {
                ...
                typename bucket_type::node &n = first_in_group
                                                ? *group_functions_t::get_prev_to_first_in_group(b.end().pointed_node(),
                                                                                                 elem)
            ...
            std::size_t priv_get_bucket_num_no_hash_store(siterator it, detail::true_)    //optimize multikey
            {
                ...
                slist_node_ptr bb = group_functions_t::get_bucket_before_begin
                        (f->end().pointed_node(), l->end().pointed_node(),
            ...
            static std::size_t
            priv_stored_hash(slist_node_ptr, detail::false_)  //NO store_hash (This should never be called)
            {
                BOOST_INTRUSIVE_INVARIANT_ASSERT(0);
                return 0;
            }

            node &priv_value_to_node(value_type &v) { return *this->priv_value_traits().to_node_ptr(v); }
...
//Stores bucket_plus_vtraits plust the hash function
        ...
        struct bucket_hash_t
                : public detail::ebo_functor_holder
                        <typename get_hash<VoidOrKeyHash, typename bucket_plus_vtraits<ValueTraits, BucketTraits>::value_traits::value_type
                        >::type
                        > {
            ...
            bucket_hash_t(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits, const hasher &h)
                    :  detail::ebo_functor_holder<hasher>(h),
                       internal(val_traits, ::boost::forward<BucketTraitsType>(b_traits)) {}

            const hasher &priv_hasher() const { return this->detail::ebo_functor_holder<hasher>::get(); }

            hasher &priv_hasher() { return this->detail::ebo_functor_holder<hasher>::get(); }
            ...
            std::size_t
            priv_stored_or_compute_hash(const value_type &v, detail::false_) const  //For store_hash == false
...
//non-empty bucket shall not be cached.
        ...
        struct bucket_hash_equal_t
                : public detail::ebo_functor_holder //equal
                        <typename get_equal_to<VoidOrKeyEqual, typename bucket_plus_vtraits<ValueTraits, BucketTraits>::value_traits::value_type
                        >::type
                        > {
            ...
            typedef typename get_equal_to<VoidOrKeyEqual, typename value_traits::value_type
            >::type value_equal;
            ...
            template<class BucketTraitsType>
            bucket_hash_equal_t(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits,
            ...
            bucket_ptr priv_get_cache() { return this->internal.internal.priv_bucket_pointer(); }

            void priv_set_cache(const bucket_ptr &) {}

            size_type priv_get_cache_bucket_num() { return 0u; }
            ...
            const value_equal &priv_equal() const { return this->detail::ebo_functor_holder<value_equal>::get(); }

            value_equal &priv_equal() { return this->detail::ebo_functor_holder<value_equal>::get(); }
...
//non-empty bucket shall be cached.
        ...
        struct bucket_hash_equal_t<VoidOrKeyHash, VoidOrKeyEqual, ValueTraits, BucketTraits, true>
            ...
            typedef typename get_equal_to
                    <VoidOrKeyEqual, typename value_traits::value_type>::type value_equal;
            typedef typename bucket_hash_type::hasher hasher;
            typedef BucketTraits bucket_traits;
            ...
            bucket_ptr &priv_get_cache() { return cached_begin_; }

            const bucket_ptr &priv_get_cache() const { return cached_begin_; }

            void priv_set_cache(const bucket_ptr &p) { cached_begin_ = p; }

            std::size_t priv_get_cache_bucket_num() {
                return this->cached_begin_ - this->internal.internal.priv_bucket_pointer();
            }

            void priv_initialize_cache() { this->cached_begin_ = this->internal.internal.priv_invalid_bucket(); }
            ...
            void priv_erasure_update_cache() {
                if (this->cached_begin_ != this->internal.internal.priv_invalid_bucket()) {
                    ...
                    for (const size_type num_buckets = this->internal.internal.priv_bucket_count();
                         current_n < num_buckets; ++current_n, ++this->priv_get_cache()) {
...
//Stores bucket_hash_equal_t and split_traits
                        ...
                        0 != (BoolFlags & hash_bool_flags::incremental_pos), SizeType, int>   //split_traits
        {
            ...
            template<class BucketTraitsType>
            hashdata_internal(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits, const hasher &h,
                              const value_equal &e)
                    :  internal(val_traits, ::boost::forward<BucketTraitsType>(b_traits), h, e) {}

            split_traits &priv_split_traits() { return *this; }

            const split_traits &priv_split_traits() const { return *this; }

            ~hashdata_internal() { this->priv_clear_buckets(); }

            void priv_clear_buckets() {
                this->internal.internal.internal.priv_clear_buckets
                        (this->internal.priv_get_cache(), this->internal.internal.internal.priv_bucket_count()
...
//Stores hashdata_internal and size_traits
                        ...
                        <0 != (BoolFlags & hash_bool_flags::constant_time_size_pos), SizeType> //size_traits
        {
            ...
            typedef hashdata_internal
                    <SizeType, BoolFlags & (hash_bool_flags::incremental_pos |
                                            hash_bool_flags::cache_begin_pos), VoidOrKeyHash, VoidOrKeyEqual, ValueTraits, BucketTraits> internal_type;
            typedef ValueTraits value_traits;
            typedef typename internal_type::value_equal value_equal;
            typedef typename internal_type::hasher hasher;
            typedef BucketTraits bucket_traits;
            ...
            template<class BucketTraitsType>
            hashtable_data_t ( BOOST_FWD_REF(BucketTraitsType)

            b_traits,
            const hasher &h
            ,
            const value_equal &e,
            const value_traits &val_traits
            )
            :
            internal(val_traits, ::boost::forward<BucketTraitsType>(b_traits), h, e
            )
...
//! inserting or erasing elements. Iterators are only invalidated when rehashing.
        ...
        class hashtable_impl
                : private hashtable_data_t
                        <SizeType, BoolFlags &
                                   hashtable_data_bool_flags_mask, VoidOrKeyHash, VoidOrKeyEqual, ValueTraits, BucketTraits> {
            typedef hashtable_data_t
                    <SizeType, BoolFlags &
                               hashtable_data_bool_flags_mask, VoidOrKeyHash, VoidOrKeyEqual, ValueTraits, BucketTraits> data_type;
        ...
        public:
            ...
            static const bool power_2_buckets =
                    incremental || (0 != (BoolFlags & hash_bool_flags::power_2_buckets_pos));
        ...
        private:
            ...
            node_cast_adaptor<detail::node_disposer<Disposer, value_traits, CircularSListAlgorithms>, slist_node_ptr, node_ptr>
            make_node_disposer(const Disposer &disposer) const {
                return node_cast_adaptor
                        <detail::node_disposer<Disposer, value_traits, CircularSListAlgorithms>, slist_node_ptr, node_ptr>
        ...
        public:
            ...
            typedef detail::transform_iterator
                    <typename slist_impl::iterator, downcast_node_to_value_t
        ...
        public:
            ...
            //!   *this is disposed.
            explicit hashtable_impl(const bucket_traits &b_traits, const hasher &hash_func = hasher(),
            ...
            //! <b>Effects</b>: to-do
            //!
            hashtable_impl (BOOST_RV_REF(hashtable_impl)

            x)
            :

            data_type ( ::boost::move(x
   ...
   ~hashtable_impl();
            ...
            //!
            //! <b>Throws</b>: Nothing.
            iterator begin() { return iterator(this->priv_begin(), &this->get_bucket_value_traits()); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            iterator end() { return iterator(this->priv_invalid_local_it(), 0); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            const_iterator cend() const { return const_iterator(this->priv_invalid_local_it(), 0); }
            ...
            hasher hash_function() const { return this->priv_hasher(); }
            ...
            key_equal key_eq() const { return this->priv_equal(); }
            ...
            void clone_from(const hashtable_impl &src, Cloner cloner, Disposer disposer) {
                ...
                if (!constant_time_size || !src.empty()) {
                    ...
                    if (!incremental && (src_bucket_count >= dst_bucket_count)) {
                        ...
                        typedef node_cast_adaptor<detail::node_disposer<Disposer, value_traits, CircularSListAlgorithms>, slist_node_ptr, node_ptr> NodeDisposer;
                        typedef node_cast_adaptor<detail::node_cloner<Cloner, value_traits, CircularSListAlgorithms>, slist_node_ptr, node_ptr> NodeCloner;
                        ...
                        for (constructed = 0; constructed < dst_bucket_count; ++constructed) {
                            dst_buckets[constructed].clone_from
                                    (src_buckets[constructed], NodeCloner(cloner, &this->priv_value_traits()),
                                     node_disp);
                        }
                        if (src_bucket_count != dst_bucket_count) {
                            ...
                            for (//"constructed" comes from the previous loop
                                ...
                                bucket_type &dst_b =
                                        dst_buckets[detail::hash_to_bucket_split<power_2_buckets, incremental>(
                                                constructed, dst_bucket_count, dst_bucket_count)];
                                bucket_type &src_b = src_buckets[constructed];
                                for (siterator b(src_b.begin()), e(src_b.end()); b != e; ++b) {
                                    dst_b.push_front(
                                            *(NodeCloner(cloner, &this->priv_value_traits())(*b.pointed_node())));
                                }
                            }
                        }
            ...
            void erase(const_iterator i) { this->erase_and_dispose(i, detail::null_disposer()); }
            ...
            void erase(const_iterator b, const_iterator e) { this->erase_and_dispose(b, e, detail::null_disposer()); }
            ...
            void erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer) {
                if (b != e) {
                    ...
                    this->priv_erase_range(before_first_local_it, first_bucket_num, last_local_it, last_bucket_num,
                                           disposer);
            ...
            size_type
            erase_and_dispose(const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, Disposer disposer) {
                size_type bucket_num;
                std::size_t h;
                siterator prev;
            ...
            //!
            //! <b>Throws</b>: If the internal hasher or the equality functor throws.
            iterator find(const_reference value) { return this->find(value, this->priv_hasher(), this->priv_equal()); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            size_type bucket_count() const { return this->priv_bucket_count(); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            size_type bucket_size(size_type n) const { return this->priv_bucket_pointer()[n].size(); }
            ...
            size_type bucket(const key_type &k) const { return this->bucket(k, this->priv_hasher()); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            bucket_ptr bucket_pointer() const { return this->priv_bucket_pointer(); }
            ...
            //! <b>Note</b>:  [this->begin(n), this->end(n)) is a valid range
            //!   containing all of the elements in the nth bucket.
            const_local_iterator begin(size_type n) const { return this->cbegin(n); }
            ...
            //! <b>Note</b>:  [this->begin(n), this->end(n)) is a valid range
            //!   containing all of the elements in the nth bucket.
            const_local_iterator end(size_type n) const { return this->cend(n); }
            ...
            void rehash(const bucket_traits &new_bucket_traits) {
                ...
                for (; n < old_bucket_count; ++n) {
                    ...
                    if (!fast_shrink) {
                        ...
                        const size_type new_n = detail::hash_to_bucket_split<power_2_buckets, incremental>(n,
                                                                                                           new_bucket_count,
                                                                                                           new_bucket_count);
                        if (cache_begin && new_n < new_first_bucket_num)
                            new_first_bucket_num = new_n;
            ...
            bool incremental_rehash(const bucket_traits &new_bucket_traits) {
                ...
                if (new_bucket_traits_size / 2 != cur_bucket_traits &&
                    new_bucket_traits_size != cur_bucket_traits / 2) {
                    return false;
                }
            ...
            /// @cond
        private:
            size_traits &priv_size_traits() { return static_cast<size_traits &>(static_cast<data_type &>(*this)); }

            const size_traits &
            priv_size_traits() const { return static_cast<const size_traits &>(static_cast<const data_type &>(*this)); }

            bucket_ptr
            priv_bucket_pointer() const { return this->data_type::internal.internal.internal.internal.priv_bucket_pointer(); }

            SizeType
            priv_bucket_count() const { return this->data_type::internal.internal.internal.internal.priv_bucket_count(); }

            const bucket_plus_vtraits<ValueTraits, BucketTraits> &
            get_bucket_value_traits() const { return this->data_type::internal.internal.internal.internal.get_bucket_value_traits(); }

            bucket_plus_vtraits<ValueTraits, BucketTraits> &
            get_bucket_value_traits() { return this->data_type::internal.internal.internal.internal.get_bucket_value_traits(); }

            bucket_traits &
            priv_bucket_traits() { return this->data_type::internal.internal.internal.internal.priv_bucket_traits(); }

            const bucket_traits &
            priv_bucket_traits() const { return this->data_type::internal.internal.internal.internal.priv_bucket_traits(); }

            value_traits &
            priv_value_traits() { return this->data_type::internal.internal.internal.internal.priv_value_traits(); }

            const value_traits &
            priv_value_traits() const { return this->data_type::internal.internal.internal.internal.priv_value_traits(); }

            const_value_traits_ptr
            priv_value_traits_ptr() const { return this->data_type::internal.internal.internal.internal.priv_value_traits_ptr(); }

            siterator
            priv_invalid_local_it() const { return this->data_type::internal.internal.internal.internal.priv_invalid_local_it(); }

            split_traits &priv_split_traits() { return this->data_type::internal.priv_split_traits(); }

            const split_traits &priv_split_traits() const { return this->data_type::internal.priv_split_traits(); }

            bucket_ptr priv_get_cache() { return this->data_type::internal.internal.priv_get_cache(); }

            void priv_initialize_cache() { return this->data_type::internal.internal.priv_initialize_cache(); }

            siterator priv_begin() const { return this->data_type::internal.internal.priv_begin(); }

            const value_equal &priv_equal() const { return this->data_type::internal.internal.priv_equal(); }

            value_equal &priv_equal() { return this->data_type::internal.internal.priv_equal(); }

            const hasher &priv_hasher() const { return this->data_type::internal.internal.internal.priv_hasher(); }

            hasher &priv_hasher() { return this->data_type::internal.internal.internal.priv_hasher(); }
            ...
            SizeType
            priv_get_cache_bucket_num() { return this->data_type::internal.internal.priv_get_cache_bucket_num(); }

            void priv_insertion_update_cache(
                    SizeType n) { return this->data_type::internal.internal.priv_insertion_update_cache(n); }
            ...
            void priv_erasure_update_cache_range(SizeType first_bucket_num, SizeType last_bucket_num) {
                return this->data_type::internal.internal.priv_erasure_update_cache_range(first_bucket_num,
                                                                                          last_bucket_num);
            }

            void priv_erasure_update_cache() { return this->data_type::internal.internal.priv_erasure_update_cache(); }
            ...
            void priv_erase_range_impl
                    (size_type bucket_num, siterator before_first_it, siterator end_sit, Disposer disposer,
                ...
                if (before_first_it == b.before_begin() && end_sit == b.end()) {
                    ...
                    while (to_erase != end_sit) {
                        group_functions_t::erase_from_group(end_ptr,
            ...
            void priv_erase_range_impl
                ...
                for (size_type i = first_bucket_num; i < (num_buckets + first_bucket_num); ++i) {
                    ...
                    while (nxt != end_sit) {
                        group_functions_t::init_group(detail::dcast_bucket_ptr<node>(nxt.pointed_node()),
                                                      optimize_multikey_t());
            ...
            void priv_erase_range(siterator before_first_it, size_type first_bucket, siterator last_it,
                                  size_type last_bucket, Disposer disposer) {
                size_type num_erased;
                if (first_bucket == last_bucket) {
                    ...
                    this->priv_erase_range_impl(first_bucket, before_first_it, b[first_bucket].end(), disposer,
                                                num_erased);
                    if (size_type n = (last_bucket - first_bucket - 1))
                        this->priv_erase_range_impl(first_bucket + 1, n, disposer, num_erased);
                    this->priv_erase_range_impl(last_bucket, b[last_bucket].before_begin(), last_it, disposer,
                                                num_erased);
                }
            }
            ...
            {
                return this->data_type::internal.internal.internal.internal.priv_get_bucket_num_no_hash_store(it,
                                                                                                              optimize_multikey_t());
            }
            ...
            template<class KeyType, class KeyHasher, class KeyValueEqual>
            siterator priv_find
                    (const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, size_type &bucket_number,
                     std::size_t &h, siterator &previt) const {
                h = hash_func(key);
            ...
            siterator priv_find_with_hash
                    (const KeyType &key, KeyValueEqual equal_func, size_type &bucket_number, const std::size_t h,
                     siterator &previt) const {
            ...
            iterator
            priv_insert_equal_find(reference value, size_type bucket_num, std::size_t hash_value, siterator it) {
                bucket_type &b = this->priv_bucket_pointer()[bucket_num];
            ...
            std::pair<siterator, siterator> priv_equal_range
                    (const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, size_type &bucket_number_first,
                     size_type &bucket_number_second, size_type &cnt) const {
                std::size_t h;
                cnt = 0;
                siterator prev;
                ...
                for (bucket_number_second = bucket_number_first + 1;
                     bucket_number_second != this->priv_bucket_count(); ++bucket_number_second) {
...
/// @cond
        ...
        template<class T, bool UniqueKeys, class PackedOptions
        >
#else
        ...
        struct make_bucket_traits {
            ...
            detail::if_c<detail::is_same
                    <specified_bucket_traits, default_bucket_traits
                    >::value, detail::bucket_traits_impl<slist_impl>, specified_bucket_traits
            >::type type;
        };
/// @endcond
...
//! same options (either explicitly or implicitly) are used.
        ...
        struct make_hashtable {
            ...
            typedef hashtable_impl
                    <value_traits, typename packed_options::hash, typename packed_options::equal, typename packed_options::size_type, bucket_traits,
        ...
        public:
            ...
            explicit hashtable(const bucket_traits &b_traits, const hasher &hash_func = hasher(),
                               const key_equal &equal_func = key_equal(), const value_traits &v_traits = value_traits())
