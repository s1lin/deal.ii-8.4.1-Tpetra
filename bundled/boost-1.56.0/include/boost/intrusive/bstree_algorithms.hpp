...
//! <tt>static void set_right(node_ptr n, node_ptr right);</tt>
        ...
        public:
            ...
            //!
            //! <b>Throws</b>: Nothing.
            static node_ptr begin_node(const const_node_ptr &header) { return node_traits::get_left(header); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            static node_ptr end_node(const const_node_ptr &header) { return detail::uncast(header); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            static bool unique(const const_node_ptr &node) { return !NodeTraits::get_parent(node); }
            ...
            static void
            replace_node(const node_ptr &node_to_be_replaced, const node_ptr &header, const node_ptr &new_node) {
                if (node_to_be_replaced == new_node)
                    return;
            ...
            static std::pair<node_ptr, node_ptr> bounded_range
                    (const const_node_ptr &header, const KeyType &lower_key, const KeyType &upper_key,
            ...
            static void insert_unique_commit
                    (const node_ptr &header, const node_ptr &new_value,
                     const insert_commit_data &commit_data) { return insert_commit(header, new_value, commit_data); }
            ...
            template<class KeyType, class KeyNodePtrCompare>
            static std::pair<node_ptr, bool> insert_unique_check
                    (const const_node_ptr &header, const node_ptr &hint, const KeyType &key, KeyNodePtrCompare comp,
                     insert_commit_data &commit_data
#ifndef BOOST_INTRUSIVE_DOXYGEN_INVOKED
                    , std::size_t *pdepth = 0
#endif
            ...
            static void clone
                    (const const_node_ptr &source_header, const node_ptr &target_header, Cloner cloner,
                     Disposer disposer) {
        ...
        protected:
            ...
            static void insert_before_check
                    (const node_ptr &header, const node_ptr &pos, insert_commit_data &commit_data
#ifndef BOOST_INTRUSIVE_DOXYGEN_INVOKED
                    , std::size_t *pdepth = 0
#endif
            ) {
            ...
            static void insert_equal_upper_bound_check
                    (const node_ptr &h, const node_ptr &new_node, NodePtrCompare comp, insert_commit_data &commit_data,
                     std::size_t *pdepth = 0) {
                std::size_t depth = 0;
                node_ptr y(h);
                node_ptr x(NodeTraits::get_parent(y));
            ...
            static void set_child(const node_ptr &header, const node_ptr &new_child, const node_ptr &new_parent,
            ...
            static void
            rotate_left(const node_ptr &p, const node_ptr &p_right, const node_ptr &p_parent, const node_ptr &header) {
            ...
            static void
            rotate_right(const node_ptr &p, const node_ptr &p_left, const node_ptr &p_parent, const node_ptr &header) {
                const bool p_was_left(NodeTraits::get_left(p_parent) == p);
        ...
        private:
            ...
            static void vine_to_subtree(const node_ptr &super_root, std::size_t count) {
                ...
                for (node_ptr q = super_root, p = NodeTraits::get_right(
                        super_root); p; q = p, p = NodeTraits::get_right(p)) {
            ...
            static node_ptr clone_subtree
                    (const const_node_ptr &source_parent, const node_ptr &target_parent, Cloner cloner,
