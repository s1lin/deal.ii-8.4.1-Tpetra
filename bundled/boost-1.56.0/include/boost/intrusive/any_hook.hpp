...
//! type when the same options (either explicitly or implicitly) are used.
        ...
        struct make_any_base_hook {
            ...
            typedef generic_hook
                    <get_any_node_algo<typename packed_options::void_pointer>, typename packed_options::tag, packed_options::link_mode, AnyBaseHookId
                ...
                struct pack : public Base {
                    struct proto_value_traits : public old_proto_value_traits {
                        ...
                        typedef typename detail::eval_if_c
                                <detail::internal_base_hook_bool_is_true<old_proto_value_traits>::value, any_to_get_base_pointer_type<old_proto_value_traits>, any_to_get_member_pointer_type<old_proto_value_traits>
                                >::type void_pointer;
