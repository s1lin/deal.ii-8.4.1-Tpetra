...
//! <tt>static void set_next(node_ptr n, node_ptr next);</tt>
        ...
        public:
            ...
            //!
            //! <b>Throws</b>: Nothing.
            static void init_header(const node_ptr &this_node) { NodeTraits::set_next(this_node, this_node); }
            ...
            static void swap_nodes(const node_ptr &this_node, const node_ptr &other_node) {
                ...
                if (!(other_null || other_empty)) {
                    NodeTraits::set_next(this_next == other_node ? other_node : get_previous_node(other_node),
                                         this_node);
                }
                if (!(this_null | this_empty)) {
                    NodeTraits::set_next(other_next == this_node ? this_node : get_previous_node(this_node),
                                         other_node);
                }
                NodeTraits::set_next(this_node,
                                     other_empty ? this_node : (other_next == this_node ? other_node : other_next));
                NodeTraits::set_next(other_node,
                                     this_empty ? other_node : (this_next == other_node ? this_node : this_next));
            }
