...
//! \c constant_time_size<> and \c size_type<>.
        ...
        private:
            ...
            node_ptr get_root_node() { return data_.root_plus_size_.m_header.get_node(); }

            const_node_ptr get_root_node() const { return data_.root_plus_size_.m_header.get_node(); }
        ...
        public:
            ...
            //! <b>Effects</b>: to-do
            //!
            list_impl (BOOST_RV_REF(list_impl)
            ...
            void pop_back() { return this->pop_back_and_dispose(detail::null_disposer()); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            iterator end() { return iterator(this->get_root_node(), this->priv_value_traits_ptr()); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            static const list_impl &container_from_end_iterator(
                    const_iterator end_iterator) { return list_impl::priv_container_from_end_iterator(end_iterator); }
            ...
            //!
            //! <b>Note</b>: Does not affect the validity of iterators and references.
            void shift_backwards(size_type n = 1) { node_algorithms::move_forward(this->get_root_node(), n); }
            ...
            //!
            //! <b>Note</b>: Does not affect the validity of iterators and references.
            void shift_forward(size_type n = 1) { node_algorithms::move_backwards(this->get_root_node(), n); }
            ...
            //!   erased element.
            iterator erase(const_iterator i) { return this->erase_and_dispose(i, detail::null_disposer()); }
            ...
            void merge(list_impl &x) { this->merge(x, std::less<value_type>()); }
            ...
            //!
            //! <b>Note</b>: Iterators and references are not invalidated
            void reverse() { node_algorithms::reverse(this->get_root_node()); }
...
#else
                (const list_impl<ValueTraits, SizeType, ConstantTimeSize, HeaderHolder> &x,
                 const list_impl<ValueTraits, SizeType, ConstantTimeSize, HeaderHolder> &y)
#endif
        ...
        (list_impl<T, Options...> &x, list_impl<T, Options...> &y)
                ...
                (list_impl<ValueTraits, SizeType, ConstantTimeSize, HeaderHolder> &x,
                 list_impl<ValueTraits, SizeType, ConstantTimeSize, HeaderHolder> &y)
#endif
        { x.swap(y); }
