...
//!store a node_traits::node
        ...
        public:
            ...
            static node_ptr to_node_ptr(reference value) { return node_ptr(&(value.*PtrToMember)); }

            static const_node_ptr to_node_ptr(const_reference value) { return node_ptr(&(value.*PtrToMember)); }
