...
//! type when the same options (either explicitly or implicitly) are used.
        ...
        struct make_set_base_hook {
            ...
            typedef generic_hook
                    <get_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>, typename packed_options::tag, packed_options::link_mode, RbTreeBaseHookId
...
//! type when the same options (either explicitly or implicitly) are used.
        ...
        struct make_set_member_hook {
            ...
            typedef generic_hook
            <get_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>
            , member_tag
