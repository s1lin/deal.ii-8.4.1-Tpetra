...
//! \c compare<> and \c priority_compare<>
        ...
        public:
            ...
            treap_set_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                           const priority_compare &pcmp = priority_compare(),
                           const value_traits &v_traits = value_traits())
            ...
            //! <b>Effects</b>: to-do
            //!
            treap_set_impl (BOOST_RV_REF(treap_set_impl)
...
//! same options (either explicitly or implicitly) are used.
        ...
        public:
            ...
            template<class Iterator>
            treap_set(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
            ...
            static treap_set &
            container_from_iterator(iterator it) { return static_cast<treap_set &>(Base::container_from_iterator(it)); }

            static const treap_set &container_from_iterator(
                    const_iterator it) { return static_cast<const treap_set &>(Base::container_from_iterator(it)); }
        };
...
//! \c compare<> and \c priority_compare<>
        ...
        public:
            ...
            //!   or the copy constructor/operator() of the value_compare object throws.
            template<class Iterator>
            treap_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                                const priority_compare &pcmp = priority_compare(),
                                const value_traits &v_traits = value_traits())
            ...
            //! <b>Effects</b>: to-do
            //!
            treap_multiset_impl (BOOST_RV_REF(treap_multiset_impl)
            ...
            treap_multiset_impl &operator=(BOOST_RV_REF(treap_multiset_impl)x) {
                return static_cast<treap_multiset_impl &>(tree_type::operator=(
...
//! same options (either explicitly or implicitly) are used.
        ...
        public:
            ...
            template<class Iterator>
            treap_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                           const priority_compare &pcmp = priority_compare(),
                           const value_traits &v_traits = value_traits())
                    :  Base(b, e, cmp, pcmp, v_traits) {}
