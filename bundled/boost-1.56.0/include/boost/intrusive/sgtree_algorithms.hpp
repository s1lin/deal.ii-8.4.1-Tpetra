...
//! <tt>static void set_right(node_ptr n, node_ptr right);</tt>
        ...
        public:
            ...
            static node_ptr
            erase(const node_ptr &header, const node_ptr &z, std::size_t tree_size, std::size_t &max_tree_size,
            ...
            static node_ptr insert_equal_upper_bound
                    (const node_ptr &h, const node_ptr &new_node, NodePtrCompare comp, std::size_t tree_size,
            ...
            static node_ptr insert_before
                    (const node_ptr &header, const node_ptr &pos, const node_ptr &new_node, std::size_t tree_size,
                     H_Alpha h_alpha, std::size_t &max_tree_size) {
                std::size_t depth;
            ...
            template<class H_Alpha>
            static void
            push_back(const node_ptr &header, const node_ptr &new_node, std::size_t tree_size, H_Alpha h_alpha,
            ...
            template<class H_Alpha>
            static void
            push_front(const node_ptr &header, const node_ptr &new_node, std::size_t tree_size, H_Alpha h_alpha,
                       std::size_t &max_tree_size) {
                std::size_t depth;
