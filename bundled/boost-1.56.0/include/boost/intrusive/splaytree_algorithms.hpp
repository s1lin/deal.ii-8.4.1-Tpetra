...
/// @cond
        namespace detail {
            ...
            struct splaydown_assemble_and_fix_header {
                ...
                splaydown_assemble_and_fix_header(const node_ptr &t, const node_ptr &header, const node_ptr &leftmost,
                                                  const node_ptr &rightmost)
                        : t_(t), null_node_(header), l_(null_node_), r_(null_node_), leftmost_(leftmost),
...
//! <tt>static void set_right(node_ptr n, node_ptr right);</tt>
        ...
        public:
            ...
            static std::size_t count
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::count(header, key, comp); }
            ...
            static node_ptr lower_bound
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::lower_bound(header, key, comp); }
            ...
            static node_ptr upper_bound
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::upper_bound(header, key, comp); }
            ...
            static node_ptr find
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::find(header, key, comp); }
            ...
            static std::pair<node_ptr, node_ptr> equal_range
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::equal_range(header, key, comp); }
            ...
            static std::pair<node_ptr, node_ptr> lower_bound_range
                    (const const_node_ptr &header, const KeyType &key,
                     KeyNodePtrCompare comp) { return bstree_algo::lower_bound_range(header, key, comp); }
            ...
            static void splay_up(const node_ptr &node, const node_ptr &header) { priv_splay_up<true>(node, header); }

            // top-down splay | complexity : logarithmic    | exception : strong, note A
            template<class KeyType, class KeyNodePtrCompare>
            static node_ptr splay_down(const node_ptr &header, const KeyType &key, KeyNodePtrCompare comp,
                                       bool *pfound = 0) { return priv_splay_down<true>(header, key, comp, pfound); }
        ...
        private:
            ...
            static node_ptr
            priv_splay_down(const node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, bool *pfound = 0) {
