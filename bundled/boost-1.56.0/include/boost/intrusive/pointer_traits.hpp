...
//! pointer_traits supplies a uniform interface to certain attributes of pointer-like types.
        ...
        struct pointer_traits {
            ...
            typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
            (boost
            ::intrusive::detail::, Ptr, reference, typename boost::intrusive::detail::unvoid_ref<element_type>::type)
            reference;
            //
            template<class U>
        ...
        private:
            ...
            //priv_pointer_to
            static pointer priv_pointer_to(boost::intrusive::detail::true_, reference r) { return Ptr::pointer_to(r); }
...
//!
        ...
        struct pointer_traits<T *> {
            ...
            //!
            static pointer pointer_to(reference r) { return boost::intrusive::detail::addressof(r); }
