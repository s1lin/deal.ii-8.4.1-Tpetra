        ...
        private:
                ...
                while (1) {
                    ...
                    if (x == x_parent_left) { //x is left child
                        ...
                        if ((!w_left || NodeTraits::get_color(w_left) == NodeTraits::black()) &&
                            ...
                            bstree_algo::rotate_left(x_parent, NodeTraits::get_right(x_parent),
                        ...
                        if ((!w_right || NodeTraits::get_color(w_right) == NodeTraits::black()) &&
                            ...
                            bstree_algo::rotate_right(x_parent, NodeTraits::get_left(x_parent),
                                                      NodeTraits::get_parent(x_parent), header);
                            break;
                        }
                    }
            ...
            static void rebalance_after_insertion(const node_ptr &header, node_ptr p) {
                ...
                while (1) {
                    ...
                    if (p_parent == header || NodeTraits::get_color(p_parent) == NodeTraits::black() ||
                    ...
                    node_ptr const x(
                            p_parent_is_left_child ? NodeTraits::get_right(p_grandparent) : p_grandparent_left);
                    ...
                    if (x && NodeTraits::get_color(x) == NodeTraits::red()) {
                        ...
                        if (p_parent_is_left_child) { //p_parent is left child
                            ...
                            bstree_algo::rotate_right(p_grandparent, p_parent, NodeTraits::get_parent(p_grandparent),
                                                      header);
                            ...
                            bstree_algo::rotate_left(p_grandparent, p_parent, NodeTraits::get_parent(p_grandparent),
                                                     header);
                        }
                        NodeTraits::set_color(p_parent, NodeTraits::black());
                        break;
