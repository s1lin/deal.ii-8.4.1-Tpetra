...
/// @cond
        ...
        struct bstbase3 {
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::pointer)
            pointer;
            typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::const_pointer)
            const_pointer;
            typedef BOOST_INTRUSIVE_IMPDEF(typename pointer_traits<pointer>::element_type)
            value_type;
            typedef BOOST_INTRUSIVE_IMPDEF(value_type)
            key_type;
            typedef BOOST_INTRUSIVE_IMPDEF(typename pointer_traits<pointer>::reference)
            reference;
            typedef BOOST_INTRUSIVE_IMPDEF(typename pointer_traits<const_pointer>::reference)
            const_reference;
            typedef BOOST_INTRUSIVE_IMPDEF(typename pointer_traits<const_pointer>::difference_type)
            difference_type;
            ...
            node_ptr header_ptr() { return holder.root.get_node(); }

            const_node_ptr header_ptr() const { return holder.root.get_node(); }

            const value_traits &get_value_traits() const { return this->holder; }

            value_traits &get_value_traits() { return this->holder; }
            ...
            void replace_node(iterator replace_this, reference with_this) {
                node_algorithms::replace_node(get_value_traits().to_node_ptr(*replace_this), this->header_ptr(),
                                              get_value_traits().to_node_ptr(with_this));
                if (safemode_or_autounlink)
                    node_algorithms::init(replace_this.pointed_node());
            }

            void rebalance() { node_algorithms::rebalance(this->header_ptr()); }
            ...
            static const_iterator s_iterator_to(const_reference value) {
                BOOST_STATIC_ASSERT((!stateful_value_traits));
                return const_iterator(value_traits::to_node_ptr(
            ...
            const_iterator iterator_to(const_reference value) const {
                return const_iterator(this->get_value_traits().to_node_ptr(*pointer_traits<pointer>::const_cast_from(
                        pointer_traits<const_pointer>::pointer_to(value))), this->priv_value_traits_ptr());
            }

            static void init_node(reference value) { node_algorithms::init(value_traits::to_node_ptr(value)); }
        ...
        struct bstbase2
            //Put the (possibly empty) functor in the first position to get EBO in MSVC
                : public detail::ebo_functor_holder<typename get_less<VoidOrKeyComp, typename ValueTraits::value_type
                >::type>, public bstbase3<ValueTraits, AlgoType, HeaderHolder> {
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(value_compare)
            key_compare;
            ...
            const value_compare &comp() const { return this->get(); }

            value_compare &comp() { return this->get(); }
            ...
            //lower_bound
            iterator lower_bound(const_reference value) { return this->lower_bound(value, this->comp()); }

            const_iterator lower_bound(const_reference value) const { return this->lower_bound(value, this->comp()); }
            ...
            //upper_bound
            iterator upper_bound(const_reference value) { return this->upper_bound(value, this->comp()); }
            ...
            const_iterator upper_bound(const_reference value) const { return this->upper_bound(value, this->comp()); }
            ...
            //find
            iterator find(const_reference value) { return this->find(value, this->comp()); }
            ...
            const_iterator find(const_reference value) const { return this->find(value, this->comp()); }
            ...
            equal_range(const_reference value) const { return this->equal_range(value, this->comp()); }
            ...
            std::pair<const_iterator, const_iterator>
            lower_bound_range(const_reference value) const { return this->lower_bound_range(value, this->comp()); }
            ...
            template<class KeyType, class KeyValueCompare>
            std::pair<iterator, iterator> bounded_range
                    (const KeyType &lower_key, const KeyType &upper_key, KeyValueCompare comp, bool left_closed,
                     bool right_closed) {
                detail::key_nodeptr_comp <KeyValueCompare, value_traits>
                        key_node_comp(comp, &this->get_value_traits());
                std::pair<node_ptr, node_ptr> ret
            ...
            std::pair<const_iterator, const_iterator> bounded_range
                    (const_reference lower_value, const_reference upper_value, bool left_closed,
            ...
            template<class KeyType, class KeyValueCompare>
            std::pair<iterator, bool> insert_unique_check
                    (const_iterator hint, const KeyType &key, KeyValueCompare key_value_comp,
...
//that doesn't inherit from size_holder
        ...
        struct bstbase_hack
            ...
            size_traits &sz_traits() { return static_cast<size_traits &>(*this); }

            const size_traits &sz_traits() const { return static_cast<const size_traits &>(*this); }
        };
...
//Specialization for ConstantTimeSize == false
        ...
        struct bstbase_hack<ValueTraits, VoidOrKeyComp, false, SizeType, AlgoType, HeaderHolder>
            ...
            size_traits &sz_traits() { return s_size_traits; }

            const size_traits &sz_traits() const { return s_size_traits; }
            ...
            ~bstbase() {
                if (is_safe_autounlink<value_traits::link_mode>::value) {
                    node_algorithms::clear_and_dispose
                            (this->header_ptr(), detail::node_disposer<detail::null_disposer, value_traits, AlgoType>
...
//! \c compare<>.
        ...
        public:
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(ValueTraits)
            value_traits;
            typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::pointer)
            pointer;
            typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::const_pointer)
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(typename pointer_traits<const_pointer>::difference_type)
            difference_type;
            typedef BOOST_INTRUSIVE_IMPDEF(SizeType)
            size_type;
            typedef BOOST_INTRUSIVE_IMPDEF(typename data_type::value_compare)
            value_compare;
            typedef BOOST_INTRUSIVE_IMPDEF(value_compare)
            key_compare;
            typedef BOOST_INTRUSIVE_IMPDEF(iterator_type)
            iterator;
            typedef BOOST_INTRUSIVE_IMPDEF(const_iterator_type)
            const_iterator;
            typedef BOOST_INTRUSIVE_IMPDEF(boost
            ::intrusive::detail::reverse_iterator <iterator>)
            reverse_iterator;
            typedef BOOST_INTRUSIVE_IMPDEF(boost
            ::intrusive::detail::reverse_iterator <const_iterator>)
            const_reverse_iterator;
            typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::node_traits)
            node_traits;
            typedef BOOST_INTRUSIVE_IMPDEF(typename node_traits::node)
            node;
            typedef BOOST_INTRUSIVE_IMPDEF(typename node_traits::node_ptr)
            node_ptr;
        ...
        public:
            ...
            bstree_impl(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                        const value_traits &v_traits = value_traits())
                    : data_type(cmp, v_traits) {
            ...
            //! <b>Effects</b>: to-do
            //!
            bstree_impl (BOOST_RV_REF(bstree_impl)
            ...
            size_type size() const {
                if (constant_time_size)
                    ...
                    return (size_type)
                    node_algorithms::size(this->header_ptr());
                }
            }
            ...
            void clone_from(const bstree_impl &src, Cloner cloner, Disposer disposer) {
                ...
                if (!src.empty()) {
                    ...
                    node_algorithms::clone
                            (const_node_ptr(src.header_ptr()), node_ptr(this->header_ptr()),
                             detail::node_cloner<Cloner, value_traits, AlgoType>(cloner, &this->get_value_traits()),
                             detail::node_disposer<Disposer, value_traits, AlgoType>(disposer,
            ...
            iterator insert_equal(const_iterator hint, reference value) {
                ...
                iterator ret(node_algorithms::insert_equal
                                     (this->header_ptr(), hint.pointed_node(), to_insert, key_node_comp),
            ...
            //! <b>Note</b>: Invalidates the iterators (but not the references)
            //!    to the erased elements. No destructors are called.
            size_type erase(const_reference value) { return this->erase(value, this->comp()); }
            ...
            size_type count(const_reference value) const { return size_type(this->count(value, this->comp())); }
            ...
            size_type count(const_reference value) { return size_type(this->count(value, this->comp())); }
...
//! same options (either explicitly or implicitly) are used.
        ...
        struct make_bstree {
            ...
            typedef bstree_impl
                    <value_traits, typename packed_options::compare, typename packed_options::size_type, packed_options::constant_time_size, BsTreeAlgorithms, header_holder_type
        ...
        public:
            ...
            bstree(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
                    : Base(cmp, v_traits) {}

            template<class Iterator>
            bstree(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                   const value_traits &v_traits = value_traits())
                    :  Base(unique, b, e, cmp, v_traits) {}

            bstree (BOOST_RV_REF(bstree)
            ...
            static bstree &
            container_from_iterator(iterator it) { return static_cast<bstree &>(Base::container_from_iterator(it)); }

            static const bstree &container_from_iterator(
                    const_iterator it) { return static_cast<const bstree &>(Base::container_from_iterator(it)); }
        };
