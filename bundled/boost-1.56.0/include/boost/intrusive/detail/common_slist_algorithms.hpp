    ...
    namespace intrusive {
        namespace detail {
            ...
            public:
                ...
                static void init(const node_ptr &this_node) { NodeTraits::set_next(this_node, node_ptr()); }
                ...
                static bool inited(const const_node_ptr &this_node) { return !NodeTraits::get_next(this_node); }
