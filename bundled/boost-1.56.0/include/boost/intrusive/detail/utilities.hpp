...
//
            ...
            to_raw_pointer(const Pointer &p) { return boost::intrusive::detail::to_raw_pointer(p.operator->()); }
...
//and the one passed as an argument
            ...
            public:
                void operator()(const node_ptr &p) { NodeAlgorithms::init(p); }
            };
            ...
            struct size_holder {
                ...
                SizeType get_size() const { return size_; }

                void set_size(SizeType size) { size_ = size; }

                void decrement() { --size_; }

                void increment() { ++size_; }

                void increase(SizeType n) { size_ += n; }

                void decrease(SizeType n) { size_ -= n; }
            ...
            struct key_nodeptr_comp
                ...
                template<class T>
                const T &key_forward(const T &key,
                                     typename enable_if_c<!is_node_ptr<T>::value>::type * = 0) const { return key; }
            ...
            struct dummy_constptr {
                ...
                ConstVoidPtr get_ptr() const { return ConstVoidPtr(); }
            };
            ...
            struct constptr {
                ...
                const void *get_ptr() const { return boost::intrusive::detail::to_raw_pointer(const_void_ptr_); }
            ...
            struct select_constptr {
                typedef typename detail::if_c
                        <store_ptr, constptr<VoidPointer>, dummy_constptr<VoidPointer>
                        >::type type;
            };
            ...
            struct add_const_if_c {
                typedef typename detail::if_c
                        <Add, typename detail::add_const<T>::type, T
                        >::type type;
            };
            ...
            template<class Hook>
            void destructor_impl(Hook &hook,
                                 detail::link_dispatch<safe_link>) {  //If this assertion raises, you might have destroyed an object
            ...
            template<class Hook>
            void destructor_impl(Hook &hook, detail::link_dispatch<auto_unlink>) { hook.unlink(); }
...
#undef BOOST_INTRUSIVE_BSR_INTRINSIC
            ...
            struct builtin_clz_dispatch<unsigned long> {
                static unsigned long call(unsigned long n) { return __builtin_clzl(n); }
            };

            template<>
            struct builtin_clz_dispatch<unsigned int> {
                static unsigned int call(unsigned int n) { return __builtin_clz(n); }
            };
            ...
            struct node_to_value
                    : public detail::select_constptr
                            <typename pointer_traits
                                    <typename ValueTraits::pointer>::template rebind_pointer<void>::type, is_stateful_value_traits<ValueTraits>::value
                            >::type {
                static const bool stateful_value_traits = is_stateful_value_traits<ValueTraits>::value;
                typedef typename detail::select_constptr
                        <typename pointer_traits
                                <typename ValueTraits::pointer>::
                        template rebind_pointer<void>::type, stateful_value_traits>::type Base;
...
//This is not standard, but should work with all compilers
            ...
            public:
                ...
                operator T *() { return (T * )(rawbuf); }

                operator const T *() const { return (const T *) (rawbuf); }
            ...
            public:
                ...
                reference operator[](difference_type off) const { return this->m_current[-off]; }
...
// trivial header node holder
            ...
            struct default_header_holder : public NodeTraits::node {
                ...
                node_ptr get_node() { return pointer_traits<node_ptr>::pointer_to(*static_cast< node * >(this)); }
...
*/
        ...
        public:
            ...
            static pointer to_value_ptr(const node_ptr &n) { return Functor::to_value_ptr(to_hook_ptr(n)); }

            static const_pointer to_value_ptr(const const_node_ptr &n) { return Functor::to_value_ptr(to_hook_ptr(n)); }

        private:
            static hook_ptr to_hook_ptr(const node_ptr &n) { return hook_ptr(&*static_cast<hook_type *>(&*n)); }
        ...
        struct iiterator {
            ...
            typedef std::iterator
                    <Category, value_type, difference_type, pointer, reference
                    > iterator_traits;
        ...
        struct iiterator_members {
            ...
            StoredPointer get_ptr() const { return ptr_; }
        ...
        struct iiterator_members<NodePtr, StoredPointer, false> {
            ...
            StoredPointer get_ptr() const { return StoredPointer(); }
