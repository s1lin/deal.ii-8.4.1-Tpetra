...
/// @cond
        ...
        template
                <class NodeTraits, class Tag, link_mode_type LinkMode, base_hook_type BaseHookType
                >
...
/// @endcond
        ...
        template
                <class GetNodeAlgorithms, class Tag, link_mode_type LinkMode, base_hook_type BaseHookType
                >
        class generic_hook
            /// @cond
            ...
            //from the hook.
                : public detail::if_c
                        <detail::is_same<Tag, member_tag>::value, typename GetNodeAlgorithms::type::node,
        ...
        /// @endcond
    {
        ...
        typedef hooktags_impl
                <typename GetNodeAlgorithms::type::node_traits, Tag, LinkMode, BaseHookType> hooktags;

        node_ptr this_ptr() { return pointer_traits<node_ptr>::pointer_to(static_cast<node &>(*this)); }
        ...
        generic_hook &operator=(const generic_hook &) { return *this; }
