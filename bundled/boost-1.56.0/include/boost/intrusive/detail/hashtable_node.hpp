...
#undef BOOST_INTRUSIVE_64_BIT_SIZE_T
            ...
            public:
                ...
                bucket_traits_impl (BOOST_RV_REF(bucket_traits_impl)
                ...
                const bucket_ptr &bucket_begin() const { return buckets_; }

                size_type bucket_count() const { return buckets_len_; }
            ...
            struct reduced_slist_node_traits {
                typedef typename detail::eval_if_c
                        <hash_reduced_slist_node_traits<NodeTraits>::value, apply_reduced_slist_node_traits<NodeTraits>, detail::identity<NodeTraits>
                        >::type type;
            };
            ...
            struct get_slist_impl {
                ...
                struct type : make_slist
                                      <typename NodeTraits::node, boost::intrusive::value_traits<trivial_traits>, boost::intrusive::constant_time_size<false>, boost::intrusive::size_type<std::size_t>
                                      >::type {
                };
            };
        ...
        class hashtable_iterator {
            typedef std::iterator
                    <std::forward_iterator_tag, typename BucketValueTraits::value_traits::value_type, typename pointer_traits<typename BucketValueTraits::value_traits::value_type *>::difference_type, typename detail::add_const_if_c
                            <typename BucketValueTraits::value_traits::value_type, IsConst>::type *, typename detail::add_const_if_c
        ...
        public:
            ...
            explicit hashtable_iterator(siterator ptr, const BucketValueTraits *cont)
                    : slist_it_(ptr), traitsptr_(cont ? pointer_traits<const_bucketvaltraits_ptr>::pointer_to(*cont)
            ...
            const siterator &slist_it() const { return slist_it_; }
        ...
        public:
            ...
            friend bool operator!=(const hashtable_iterator &i, const hashtable_iterator &i2) { return !(i == i2); }
            ...
            const const_bucketvaltraits_ptr &get_bucket_value_traits() const { return traitsptr_; }

            const value_traits &priv_value_traits() const { return traitsptr_->priv_value_traits(); }

            const bucket_traits &priv_bucket_traits() const { return traitsptr_->priv_bucket_traits(); }
