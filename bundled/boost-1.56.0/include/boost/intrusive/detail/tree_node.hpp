...
// node oriented bidirectional iterator:
        ...
        public:
            ...
            const node_ptr &pointed_node() const { return members_.nodeptr_; }
        ...
        public:
            ...
            friend bool operator!=(const tree_iterator &l, const tree_iterator &r) { return !(l == r); }

            reference operator*() const { return *operator->(); }

            pointer operator->() const { return this->operator_arrow(detail::bool_<stateful_value_traits>()); }

            const_value_traits_ptr get_value_traits() const { return members_.get_ptr(); }
        ...
        private:
            pointer operator_arrow(detail::false_) const { return ValueTraits::to_value_ptr(members_.nodeptr_); }
