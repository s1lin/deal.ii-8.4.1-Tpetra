...
//! type when the same options (either explicitly or implicitly) are used.
        ...
        struct make_avl_set_base_hook {
            ...
            typedef generic_hook
                    <get_avl_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>, typename packed_options::tag, packed_options::link_mode, AvlTreeBaseHookId
...
//! type when the same options (either explicitly or implicitly) are used.
        ...
        struct make_avl_set_member_hook {
            ...
            typedef generic_hook
            <get_avl_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>
            , member_tag
