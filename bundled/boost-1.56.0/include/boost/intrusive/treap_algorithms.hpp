...
//! <tt>static void set_right(node_ptr n, node_ptr right);</tt>
        ...
        public:
            ...
            static std::pair<node_ptr, bool> insert_unique_check
                    (const const_node_ptr &header, const KeyType &key, KeyNodePtrCompare comp,
                     KeyNodePtrPrioCompare pcomp, insert_commit_data &commit_data) {
        ...
        private:
            ...
            static void rebalance_check_and_commit
                    (const node_ptr &h, const node_ptr &new_node, NodePtrPriorityCompare pcomp,
                     insert_commit_data &commit_data) {
            ...
            static void rebalance_after_insertion_check
                    (const const_node_ptr &header, const const_node_ptr &up, const Key &k, KeyNodePriorityCompare pcomp,
