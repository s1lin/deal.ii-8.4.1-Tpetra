...
//! \c compare<>.
        ...
        public:
            ...
            avl_set_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                         const value_traits &v_traits = value_traits())
                    : tree_type(true, b, e, cmp, v_traits) {}

            //! @copydoc ::boost::intrusive::avltree::avltree(avltree &&)
            avl_set_impl (BOOST_RV_REF(avl_set_impl)
...
//! same options (either explicitly or implicitly) are used.
        ...
        public:
            ...
            explicit avl_set(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
                    : Base(cmp, v_traits) {}
            ...
            static avl_set &
            container_from_iterator(iterator it) { return static_cast<avl_set &>(Base::container_from_iterator(it)); }

            static const avl_set &container_from_iterator(
                    const_iterator it) { return static_cast<const avl_set &>(Base::container_from_iterator(it)); }
        };
...
//! \c compare<>.
        ...
        public:
            ...
            //! @copydoc ::boost::intrusive::avltree::avltree(bool,Iterator,Iterator,const value_compare &,const value_traits &)
            template<class Iterator>
            avl_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                              const value_traits &v_traits = value_traits())
                    : tree_type(false, b, e, cmp, v_traits) {}

            //! @copydoc ::boost::intrusive::avltree::avltree(avltree &&)
            avl_multiset_impl (BOOST_RV_REF(avl_multiset_impl)
            ...
            avl_multiset_impl &operator=(BOOST_RV_REF(avl_multiset_impl) x) {
                return static_cast<avl_multiset_impl &>(tree_type::operator=(
...
//! same options (either explicitly or implicitly) are used.
        ...
        public:
            ...
            template<class Iterator>
            avl_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                         const value_traits &v_traits = value_traits())
                    :  Base(b, e, cmp, v_traits) {}
            ...
            static const avl_multiset &container_from_iterator(
                    const_iterator it) { return static_cast<const avl_multiset &>(Base::container_from_iterator(it)); }
        };
