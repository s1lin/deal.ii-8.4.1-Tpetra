...
//! \c compare<> and \c priority_compare<>
            ...
            /// @cond
                : public bstree_impl<ValueTraits, VoidOrKeyComp, SizeType, ConstantTimeSize, BsTreeAlgorithms, HeaderHolder>,
                  public detail::ebo_functor_holder
                          <typename get_prio
                                  <VoidOrPrioComp, typename bstree_impl
        ...
        public:
            ...
            typedef get_prio
                    <VoidOrPrioComp, typename tree_type::value_type> get_prio_type;
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(treap_algorithms
            <node_traits>)
            node_algorithms;
            typedef BOOST_INTRUSIVE_IMPDEF(typename get_prio_type::type)
            priority_compare;
        ...
        private:
            ...
            const priority_compare &priv_pcomp() const { return static_cast<const prio_base &>(*this).get(); }

            priority_compare &priv_pcomp() { return static_cast<prio_base &>(*this).get(); }
        ...
        public:
            ...
            treap_impl(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                       const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
                    : tree_type(cmp, v_traits), prio_base(pcmp) {
                if (unique)
            ...
            treap_impl (BOOST_RV_REF(treap_impl)
            ...
            //!
            //! <b>Throws</b>: Nothing.
            iterator top() { return this->tree_type::root(); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            const_iterator top() const { return this->ctop(); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            const_iterator ctop() const { return this->tree_type::root(); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            reverse_iterator rtop() { return reverse_iterator(this->top()); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            const_reverse_iterator rtop() const { return const_reverse_iterator(this->top()); }
            ...
            //!
            //! <b>Throws</b>: Nothing.
            const_reverse_iterator crtop() const { return const_reverse_iterator(this->top()); }
            ...
            priority_compare priority_comp() const { return this->priv_pcomp(); }
            ...
            iterator insert_equal(reference value) {
                ...
                iterator ret(node_algorithms::insert_equal_upper_bound
                                     (this->tree_type::header_ptr(), to_insert, key_node_comp, key_node_pcomp),
            ...
            iterator insert_equal(const_iterator hint, reference value) {
                ...
                iterator ret(node_algorithms::insert_equal
                                     (this->tree_type::header_ptr(), hint.pointed_node(), to_insert, key_node_comp,
                                      key_node_pcomp), this->priv_value_traits_ptr());
                this->tree_type::sz_traits().increment();
                return ret;
            }
            ...
            std::pair<iterator, bool> insert_unique(reference value) {
                ...
                std::pair<iterator, bool> ret = insert_unique_check(value, this->value_comp(), this->priv_pcomp(),
                                                                    commit_data);
                if (!ret.second)
                    return ret;
            ...
            iterator insert_unique(const_iterator hint, reference value) {
                insert_commit_data commit_data;
                std::pair<iterator, bool> ret = insert_unique_check(hint, value, this->value_comp(), this->priv_pcomp(),
                                                                    commit_data);
                if (!ret.second)
                    return ret.first;
            ...
            iterator insert_before(const_iterator pos, reference value) {
                ...
                iterator ret(node_algorithms::insert_before
                                     (this->tree_type::header_ptr(), pos.pointed_node(), to_insert, pcomp),
                             this->priv_value_traits_ptr());
                this->tree_type::sz_traits().increment();
                return ret;
            }
            ...
            void clear_and_dispose(Disposer disposer) {
                node_algorithms::clear_and_dispose(this->tree_type::header_ptr(),
                                                   detail::node_disposer<Disposer, value_traits, TreapAlgorithms>(
...
//! same options (either explicitly or implicitly) are used.
        ...
        struct make_treap {
            ...
            typedef treap_impl
                    <value_traits, typename packed_options::compare, typename packed_options::priority, typename packed_options::size_type, packed_options::constant_time_size, header_holder_type
        ...
        public:
            ...
            template<class Iterator>
            treap(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                  const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
            ...
            static treap &
            container_from_iterator(iterator it) { return static_cast<treap &>(Base::container_from_iterator(it)); }

            static const treap &container_from_iterator(
                    const_iterator it) { return static_cast<const treap &>(Base::container_from_iterator(it)); }
        };
