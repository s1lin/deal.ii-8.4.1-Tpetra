...
//! This function does not use float point operations.
            ...
            struct h_alpha_sqrt2_t {
                ...
                std::size_t operator()(std::size_t n) const { return calculate_h_sqrt2(n); }
            };
...
/////////////////////////////////////////////////////////////
            ...
            struct alpha_by_max_size_t {
                ...
                float operator()(std::size_t max_tree_size) const { return float(max_tree_size) * alpha_; }
            ...
            struct alpha_holder {
                ...
                alpha_holder()
                        : max_tree_size_() { set_alpha(0.70711f); } // ~1/sqrt(2)
                ...
                h_alpha_t get_h_alpha_t() const { return h_alpha_t(/*alpha_, */inv_minus_logalpha_); }

                multiply_by_alpha_t get_multiply_by_alpha_t() const { return multiply_by_alpha_t(alpha_); }
            ...
            struct alpha_holder<false, SizeType> {
                ...
                float get_alpha() const { return 0.70710677f; }

                void set_alpha(float) {  //alpha CAN't be changed.
                    BOOST_INTRUSIVE_INVARIANT_ASSERT(0);
                }

                h_alpha_t get_h_alpha_t() const { return h_alpha_t(); }

                multiply_by_alpha_t get_multiply_by_alpha_t() const { return multiply_by_alpha_t(); }
...
//! \c compare<>.
        ...
        public:
            ...
            /// @cond
            typedef bstree_impl<ValueTraits, VoidOrKeyComp, SizeType, true, SgTreeAlgorithms, HeaderHolder> tree_type;
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(sgtree_algorithms
            <node_traits>)
            node_algorithms;
        ...
        public:
            ...
            typedef BOOST_INTRUSIVE_IMPDEF(typename node_algorithms::insert_commit_data)
            insert_commit_data;
            ...
            sgtree_impl(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                        const value_traits &v_traits = value_traits())
                    : tree_type(cmp, v_traits) {
                if (unique)
            ...
            sgtree_impl (BOOST_RV_REF(sgtree_impl)

            x)
            :

            tree_type (::boost::move(

            static_cast<tree_type&>(x))),
            alpha_traits(x
            .
        ...
        private:
            ...
            const alpha_traits &get_alpha_traits() const { return *this; }

            alpha_traits &get_alpha_traits() { return *this; }

            h_alpha_t get_h_alpha_func() const { return this->get_alpha_traits().get_h_alpha_t(); }

            multiply_by_alpha_t
            get_alpha_by_max_size_func() const { return this->get_alpha_traits().get_multiply_by_alpha_t(); }
        ...
        public:
            ...
            iterator insert_equal(reference value) {
                ...
                node_ptr p = node_algorithms::insert_equal_upper_bound
                        (this->tree_type::header_ptr(), to_insert, key_node_comp, (size_type) this->size(),
                         this->get_h_alpha_func(), max_tree_size);
            ...
            iterator insert_unique_commit(reference value, const insert_commit_data &commit_data) {
                ...
                node_algorithms::insert_unique_commit
                        (this->tree_type::header_ptr(), to_insert, commit_data, (std::size_t) this->size(),
                         this->get_h_alpha_func(), max_tree_size);
                this->tree_type::sz_traits().increment();
                this->max_tree_size_ = (size_type) max_tree_size;
            ...
            iterator insert_before(const_iterator pos, reference value) {
                ...
                node_ptr p = node_algorithms::insert_before
                        (this->tree_type::header_ptr(), pos.pointed_node(), to_insert, (size_type) this->size(),
                         this->get_h_alpha_func(), max_tree_size);
                this->tree_type::sz_traits().increment();
                this->max_tree_size_ = (size_type) max_tree_size;
                return iterator(p, this->priv_value_traits_ptr());
            ...
            void push_back(reference value) {
                ...
                node_algorithms::push_back
                        (this->tree_type::header_ptr(), to_insert, (size_type) this->size(), this->get_h_alpha_func(),
                         max_tree_size);
                this->tree_type::sz_traits().increment();
                this->max_tree_size_ = (size_type) max_tree_size;
            }
            ...
            iterator erase(const_iterator i) {
                ...
                node_algorithms::erase
                        (this->tree_type::header_ptr(), to_erase, (std::size_t) this->size(), max_tree_size,
            ...
            size_type erase(const_reference value) { return this->erase(value, this->value_comp()); }
            ...
            float balance_factor() const { return this->get_alpha_traits().get_alpha(); }
...
//! same options (either explicitly or implicitly) are used.
        ...
        struct make_sgtree {
            ...
            typedef sgtree_impl
                    <value_traits, typename packed_options::compare, typename packed_options::size_type, packed_options::floating_point, header_holder_type
        ...
        public:
            ...
            explicit sgtree(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
                    : Base(cmp, v_traits) {}

            template<class Iterator>
            sgtree(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(),
                   const value_traits &v_traits = value_traits())
            ...
            static sgtree &
            container_from_iterator(iterator it) { return static_cast<sgtree &>(Base::container_from_iterator(it)); }

            static const sgtree &container_from_iterator(
                    const_iterator it) { return static_cast<const sgtree &>(Base::container_from_iterator(it)); }
        };
