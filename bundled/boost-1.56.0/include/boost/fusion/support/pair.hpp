...
namespace boost {
    namespace fusion {
        ...
        struct pair {
            ...
            BOOST_FUSION_GPU_ENABLED
            pair(Second2 &&val, typename boost::enable_if<is_convertible < Second2, Second>
        ...
        const& val) {
        return
        pair<First, typename detail::as_fusion_element<Second>::type>(val);
    }
