...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            vector_data1(U0 &&_0, typename boost::enable_if<is_convertible < U0, T0>
...
# endif
        ...
        template<typename T0>
        struct vector1
                : vector_data1<T0>, sequence_base<vector1<T0> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            explicit
            vector1(U0 &&_0, typename boost::enable_if<is_convertible < U0, T0>
...
# endif
            ...
            BOOST_FUSION_GPU_ENABLED
            vector1(
                    Sequence const &seq, typename boost::disable_if<is_convertible < Sequence, T0>
            ...
            BOOST_FUSION_GPU_ENABLED
            vector1(
                    Sequence &seq, typename boost::disable_if<is_convertible < Sequence, T0>
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            vector_data2(U0 &&_0, U1 &&_1, typename boost::enable_if<is_convertible < U0, T0>
...
# endif
        ...
        template<typename T0, typename T1>
        struct vector2
                : vector_data2<T0, T1>, sequence_base<vector2<T0, T1> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            vector_data3(U0 &&_0, U1 &&_1, U2 &&_2, typename boost::enable_if<is_convertible < U0, T0>
...
# endif
        ...
        template<typename T0, typename T1, typename T2>
        struct vector3
                : vector_data3<T0, T1, T2>, sequence_base<vector3<T0, T1, T2> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            vector_data4(U0 &&_0, U1 &&_1, U2 &&_2, U3 &&_3, typename boost::enable_if<is_convertible < U0, T0>
...
# endif
        ...
        template<typename T0, typename T1, typename T2, typename T3>
        struct vector4
                : vector_data4<T0, T1, T2, T3>, sequence_base<vector4<T0, T1, T2, T3> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            BOOST_FUSION_GPU_ENABLED
            vector_data5(U0 &&_0, U1 &&_1, U2 &&_2, U3 &&_3, U4 &&_4, typename boost::enable_if<is_convertible < U0, T0>
            ...
            m0 (std::forward<U0>(_0)), m1(std::forward<U1>(_1)), m2(std::forward<U2>(_2)), m3(std::forward<U3>(_3)),
            m4(std::forward<U4>(_4)) {}

            vector_data5(
                    vector_data5 &&other)
                    : m0(std::forward<T0>(other.m0)), m1(std::forward<T1>(other.m1)), m2(std::forward<T2>(other.m2)),
                      m3(std::forward<T3>(other.m3)), m4(std::forward<T4>(other.m4)) {}
...
# endif
        ...
        template<typename T0, typename T1, typename T2, typename T3, typename T4>
        struct vector5
                : vector_data5<T0, T1, T2, T3, T4>, sequence_base<vector5<T0, T1, T2, T3, T4> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            m0 (std::forward<U0>(_0)), m1(std::forward<U1>(_1)), m2(std::forward<U2>(_2)), m3(std::forward<U3>(_3)),
            m4(std::forward<U4>(_4)), m5(std::forward<U5>(_5)) {}
...
# endif
        ...
        template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5>
        struct vector6
                : vector_data6<T0, T1, T2, T3, T4, T5>, sequence_base<vector6<T0, T1, T2, T3, T4, T5> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            m0 (std::forward<U0>(_0)), m1(std::forward<U1>(_1)), m2(std::forward<U2>(_2)), m3(std::forward<U3>(_3)),
            m4(std::forward<U4>(_4)), m5(std::forward<U5>(_5)), m6(std::forward<U6>(_6)) {}
...
# endif
        ...
        template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
        struct vector7
                : vector_data7<T0, T1, T2, T3, T4, T5, T6>, sequence_base<vector7<T0, T1, T2, T3, T4, T5, T6> > {
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
            ...
            m0 (std::forward<U0>(_0)), m1(std::forward<U1>(_1)), m2(std::forward<U2>(_2)), m3(std::forward<U3>(_3)),
            m4(std::forward<U4>(_4)), m5(std::forward<U5>(_5)), m6(std::forward<U6>(_6)), m7(std::forward<U7>(_7)),
            m8(std::forward<U8>(_8)), m9(std::forward<U9>(_9)) {}
