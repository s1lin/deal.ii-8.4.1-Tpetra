...
namespace boost {
    namespace fusion {
        ...
        struct transform_view : sequence_base<transform_view<Sequence1, Sequence2, F> > {
            ...
            first1() const { return fusion::begin(seq1); }

            BOOST_FUSION_GPU_ENABLED
                    first2_type

            first2() const { return fusion::begin(seq2); }

            BOOST_FUSION_GPU_ENABLED
                    last1_type

            last1() const { return fusion::end(seq1); }

            BOOST_FUSION_GPU_ENABLED
                    last2_type

            last2() const { return fusion::end(seq2); }

            transform_type f;
            typename mpl::if_<traits::is_view < Sequence1>, Sequence1, Sequence1&>
            ::type seq1;
            typename mpl::if_<traits::is_view < Sequence2>, Sequence2, Sequence2&>
            ::type seq2;
