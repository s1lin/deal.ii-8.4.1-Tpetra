...
<
        StateRef, BOOST_FUSION_FOLD_IMPL_FIRST_IT_META_TRANSFORM(
...
inline typename result_of::BOOST_FUSION_FOLD_NAME<
        Seq, State const, F
>::type
BOOST_FUSION_FOLD_NAME(Seq
& seq,
State const &state, F
f)
{
return
result_of::BOOST_FUSION_FOLD_NAME<Seq, State const, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::BOOST_FUSION_FOLD_NAME<Seq const, State const, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::BOOST_FUSION_FOLD_NAME<Seq, State, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::BOOST_FUSION_FOLD_NAME<Seq const, State, F>::call(
        state,
        seq,
        f
);
