...
namespace boost {
    namespace fusion {
        namespace detail {
            ...
            struct iter_fold_impl {
                ...
                result_of_first_unrollediter_fold<
                        StateRef, typename result_of::begin<Seq>::type, F, SeqSize
                >::type
                        type;
                BOOST_FUSION_GPU_ENABLED
                static type
        ...
        f) {
        return
        result_of::iter_fold<Seq, State const, F>::call(
                state,
                seq,
                f
        );
    ...
    f) {
    return
    result_of::iter_fold<Seq const, State const, F>::call(
            state,
            seq,
            f
    );
...
{
return
result_of::iter_fold<Seq, State, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::iter_fold<Seq const, State, F>::call(
        state,
        seq,
        f
);
