...
namespace boost {
    namespace fusion {
        ...
        f) {
        return
        result_of::reverse_fold<Seq, State const, F>::call(
                state,
                seq,
                f
        );
    ...
    f) {
    return
    result_of::reverse_fold<Seq const, State const, F>::call(
            state,
            seq,
            f
    );
...
{
return
result_of::reverse_fold<Seq, State, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::reverse_fold<Seq const, State, F>::call(
        state,
        seq,
        f
);
