...
namespace boost {
    namespace fusion {
        namespace detail {
            ...
            struct reverse_iter_fold_impl {
                ...
                result_of_first_unrolledreverse_iter_fold<
                        StateRef, typename fusion::result_of::prior<typename result_of::end<Seq>::type>::type, F, SeqSize
                >::type
                        type;
                BOOST_FUSION_GPU_ENABLED
                static type
            ...
            struct result_of_reverse_iter_fold
                    : reverse_iter_fold_impl<
                            result_of::size<Seq>::value, typename add_reference<
        ...
        inline typename result_of::reverse_iter_fold<
                Seq, State const, F
        >::type
        reverse_iter_fold(Seq
        & seq,
        State const &state, F
        f) {
        return
        result_of::reverse_iter_fold<Seq, State const, F>::call(
                state,
                seq,
                f
        );
    ...
    f) {
    return
    result_of::reverse_iter_fold<Seq const, State const, F>::call(
            state,
            seq,
            f
    );
...
{
return
result_of::reverse_iter_fold<Seq, State, F>::call(
        state,
        seq,
        f
);
...
{
return
result_of::reverse_iter_fold<Seq const, State, F>::call(
        state,
        seq,
        f
);
