    ...
    namespace fusion {
        namespace result_of {
            ...
            struct compute_erase_last // put this in detail!!!
            {
                ...
                typedef typename
                mpl::if_<
                        result_of::equal_to<first_type, seq_last_type>, first_type, typename result_of::next<first_type>::type
                >::type
                        type;
        ...
        struct erase {
            ...
            typedef typename
            fusion_default_help<
                    Last, typename compute_erase_last<Sequence, First>::type
            >::type
                    LastType;
