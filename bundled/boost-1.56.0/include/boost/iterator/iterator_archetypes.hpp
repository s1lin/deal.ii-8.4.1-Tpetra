...
namespace boost {
    ...
    namespace iterator_archetypes {
        enum {
            readable_iterator_bit = 1, writable_iterator_bit = 2, swappable_iterator_bit = 4, lvalue_iterator_bit = 8
        };
...
namespace detail {
    ...
    struct operator_brackets
            ...
            >, mpl::identity<writable_operator_brackets<Value> >, mpl::if_<
                    iterator_archetypes::has_access <
                    AccessCategory, iterator_archetypes::readable_iterator_t
            >, readable_operator_brackets<Value>, no_operator_brackets
    >
    >
...
Derived &operator+(std::ptrdiff_t,
                   traversal_archetype_<Derived, Value, random_access_traversal_tag> const &) { return static_object<Derived>::get(); }
...
std::ptrdiff_t operator-(traversal_archetype_<Derived, Value, random_access_traversal_tag> const &,
                         traversal_archetype_<Derived, Value, random_access_traversal_tag> const &) { return 0; }

template<class Derived, class Value>
bool operator<(traversal_archetype_<Derived, Value, random_access_traversal_tag> const &,
               traversal_archetype_<Derived, Value, random_access_traversal_tag> const &) { return true; }
...
namespace detail {
    ...
    struct iterator_archetype_base
        ...
        typedef typename detail::facade_iterator_category<
                TraversalCategory, typename mpl::eval_if<
                        iterator_archetypes::has_access <
                        AccessCategory, iterator_archetypes::writable_iterator_t
                >, remove_const < Value>
        , add_const <Value>
        ...
        typedef boost::iterator<
                iterator_category, Value, typename traversal_archetype_base<
                        Value, AccessCategory, TraversalCategory
                >::difference_type, typename access::pointer, typename access::reference
