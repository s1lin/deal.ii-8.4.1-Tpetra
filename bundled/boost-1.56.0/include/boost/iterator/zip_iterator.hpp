...
namespace boost {
    ...
    namespace detail {
        ...
        struct dereference_iterator {
            ...
            template<typename Iterator>
            typename apply<Iterator>::type operator()(Iterator const &it) { return *it; }
        };
        ...
        namespace tuple_impl_specific {
            ...
            struct tuple_meta_transform_impl {
                typedef tuples::cons<
                        typename mpl::apply1<
                                typename mpl::lambda<UnaryMetaFun>::type, typename Tuple::head_type
                        >::type, typename tuple_meta_transform<
                                typename Tuple::tail_type, UnaryMetaFun
                        >::type
                > type;
            };
            ...
            struct tuple_meta_transform
                    : mpl::eval_if<
                            boost::is_same<Tuple, tuples::null_type>, mpl::identity < tuples::null_type>,
        ...
        struct tuple_meta_accumulate_impl {
            typedef typename mpl::apply2<
                    typename mpl::lambda<BinaryMetaFun>::type, typename Tuple::head_type, typename tuple_meta_accumulate<
                            typename Tuple::tail_type, BinaryMetaFun, StartType
                    >::type
            >::type type;
        };
        ...
        struct tuple_meta_accumulate
              ...
              >
#endif
                        , mpl::identity < StartType>, tuple_meta_accumulate_impl<
...
# define BOOST_TUPLE_ALGO_RECURSE
    ...
    tuples::null_type BOOST_TUPLE_ALGO(tuple_transform)
            (tuples::null_type const &, Fun BOOST_TUPLE_ALGO_TERMINATOR) { return tuples::null_type(); }
    ...
    BOOST_TUPLE_ALGO(tuple_transform)(
        ...
        typedef typename tuple_meta_transform<
                BOOST_DEDUCED_TYPENAME Tuple::tail_type, Fun
        >::type transformed_tail_type;

        return tuples::cons <
               BOOST_DEDUCED_TYPENAME
        mpl::apply1 <
        Fun, BOOST_DEDUCED_TYPENAME
        Tuple::head_type
        > ::type
...
struct minimum_traversal_category_in_iterator_tuple {
    ...
    typedef typename tuple_impl_specific::tuple_meta_accumulate<
            tuple_of_traversal_tags, minimum_category<>, random_access_traversal_tag
    >::type type;
};
...
public:
    ...
    const IteratorTuple &get_iterator_tuple() const { return m_iterator_tuple; }
...
template<typename IteratorTuple>
zip_iterator<IteratorTuple>
make_zip_iterator(IteratorTuple t) { return zip_iterator<IteratorTuple>(t); }
