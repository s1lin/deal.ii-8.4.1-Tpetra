...
#define M1(z, n, data)                                                                      \
        ...
        {};
            ...
            BOOST_PP_INC (BOOST_MPL_STRING_MAX_PARAMS), M1,
            ~
            )
#undef M0
#undef M1
...
#define M0(z, n, data)                                                                        \
        ...
        {                                                                                           \
            ...
            BOOST_PP_INC (BOOST_MPL_STRING_MAX_PARAMS), M0,
            ~
            )
#undef M0
        };
        ...
        struct push_back_impl<mpl::string_tag> {
            ...
            struct apply {
                ...
                typename mpl::push_back<
                        typename mpl::copy<
                                Sequence, mpl::back_inserter<mpl::string<> >
                        >::type, Value
                >::type
                        type;
            };
...
#define M0(z, n, data)                                                                        \
        ...
        {                                                                                           \
            ...
            BOOST_MPL_STRING_MAX_PARAMS, M0,
            ~
            )
#undef M0

            template<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS,
            int C
            ), typename Value>
            struct apply<mpl::string<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)>, Value, false> {
                typedef
                mpl::string<
                        BOOST_PP_ENUM_PARAMS(BOOST_PP_DEC(BOOST_MPL_STRING_MAX_PARAMS),
                                             C), BOOST_MPL_MULTICHAR_PUSH_BACK(
                                BOOST_PP_CAT(C, BOOST_PP_DEC(BOOST_MPL_STRING_MAX_PARAMS)), Value::value)
                >
                        type;
            };
        };
            ...
            struct apply {
                ...
                typename mpl::push_front<
                        typename mpl::reverse_copy<
                                Sequence, mpl::front_inserter<string<> >
                        >::type, Value
                >::type
                        type;
            };
...
#undef M0
            ...
            struct apply<mpl::string<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)>, Value, false> {
                typedef
                mpl::string<
                        BOOST_MPL_MULTICHAR_PUSH_FRONT(C0, Value::value), BOOST_PP_ENUM_SHIFTED_PARAMS(
...
#undef M0
        ...
        struct string {
            /// INTERNAL ONLY
            enum {
                front_ = C0, back_ = BOOST_PP_CAT(C, BOOST_PP_DEC(BOOST_MPL_STRING_MAX_PARAMS))
            };
