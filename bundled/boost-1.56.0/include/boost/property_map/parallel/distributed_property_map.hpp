    ...
    namespace parallel {
        ...
        namespace detail {
            ...
            struct maybe_put_in_lvalue_pm {
                ...
                static inline void
                do_put(PropertyMap, const Key &, const Value &) { BOOST_ASSERT(false); }
            };
            ...
            template<typename PropertyMap, typename Key, typename Value>
            inline void
            maybe_put_impl(PropertyMap, const Key &, const Value &, ...) { BOOST_ASSERT(false); }
 ...
 */
        ...
        private:
            ...
            struct handle_message {
                ...
                handle_multiput
                        (int source, int tag,
                         const std::vector<unsafe_pair < local_key_type, value_type>
