...
namespace boost {
    namespace chrono {
        ...
        public:
             ...
             */
            explicit duration_fmt(duration_style style)
            ...
            BOOST_TRY
            {
                ...
                BOOST_TRY
                {
                    ...
                    if (bool(opfx)) {
                        ...
                        } else if (std::use_facet<duration_put < CharT> >
                                   (os.getloc()).put(os, os, os.fill(), d).failed()) {
                            err = std::ios_base::badbit;
                        }
                        os.width(0);
                    }
            ...
            BOOST_TRY
            {
                ...
                if (bool(ipfx)) {
                    if (!std::has_facet<duration_get < CharT> > (is.getloc())) {
                        ...
                        std::use_facet<duration_get < CharT> >
