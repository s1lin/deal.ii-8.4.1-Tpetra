...
namespace boost {
    ...
    namespace detail // lcast_to_unsigned
    {
        template<class T>
        inline
        BOOST_DEDUCED_TYPENAME boost::make_unsigned<T>::type
...
namespace detail // lcast_put_unsigned
{
    ...
    public:
        ...
        CharT *convert() {
            ...
            BOOST_STATIC_ASSERT(std::numeric_limits<T>::digits10<
            CHAR_MAX);
#endif
    ...
    private:
        inline bool main_convert_itaration()
...
inline bool parse_inf_nan_impl(const CharT *begin, const CharT *end, T &value, const CharT *lc_NAN, const CharT *lc_nan,
                               const CharT *lc_INFINITY, const CharT *lc_infinity, const CharT opening_brace,
...
#  pragma warning(disable:4244) 
    ...
    inline bool lcast_ret_float(T &value, const CharT *begin, const CharT *const end) {
        ...
        typedef BOOST_DEDUCED_TYPENAME mantissa_holder_type
        <T>::type
        mantissa_type;
        ...
        while (begin != end) {
            if (found_decimal) {
                ...
                } else if (Traits::eq(*begin, decimal_point) || Traits::eq(*begin, lowercase_e) ||
                           Traits::eq(*begin, capital_e)) {
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
        ...
        bool shl_real_type(long double val, wchar_t *begin) {
            using namespace std;
            finish = start + swprintf(begin, CharacterBufferSize,
                                      L"%.*Lg", static_cast<int>(boost::detail::lcast_get_precision<long double>()),
                                      val);
            return finish > start;
        }
