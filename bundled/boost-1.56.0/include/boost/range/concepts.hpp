...
#define BOOST_RANGE_CONCEPT_ASSERT( x )
...
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME iterator_traversal
            <Iterator>::type
            traversal_category;
        ...
        struct ForwardIteratorConcept
            ...
            ::detail::iterator_traits<Iterator>::difference_type difference_type;
        ...
        struct BidirectionalIteratorConcept
            ...
            BOOST_RANGE_CONCEPT_ASSERT((
                                               Convertible <
                                               BOOST_DEDUCED_TYPENAME
                                               BidirectionalIteratorConcept::traversal_category,
    ...
    private:
        iterator i;
        BOOST_DEDUCED_TYPENAME range_value<T>::type
        v;
#endif
    };
    ...
    struct BidirectionalRangeConcept : ForwardRangeConcept<T> {
        ...
        BOOST_RANGE_CONCEPT_ASSERT(
                (range_detail::BidirectionalIteratorConcept<BOOST_DEDUCED_TYPENAME BidirectionalRangeConcept::const_iterator>));
#endif
    };
    ...
    struct RandomAccessRangeConcept : BidirectionalRangeConcept<T> {
        ...
        BOOST_RANGE_CONCEPT_ASSERT(
                (range_detail::RandomAccessIteratorConcept<BOOST_DEDUCED_TYPENAME RandomAccessRangeConcept::const_iterator>));
#endif
    };
