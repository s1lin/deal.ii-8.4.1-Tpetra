...
namespace boost {
    ...
    namespace detail {
        ...
        struct is_volatile_rval_filter {
            ...
            BOOST_STATIC_CONSTANT(bool, value = ::boost::detail::cv_traits_imp<BOOST_TT_AUX_CV_TRAITS_IMPL_PARAM(
                    T)>::is_volatile);
...
//* is a type T declared volatile - is_volatile<T>
    ...
    BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T, is_volatile, T &,
