...
// Abrahams, and then ported here by Doug Gregor.
    namespace detail {
        ...
        class type_with_alignment_imp {
            ...
            typedef typename mpl::if_c<
                    ::boost::detail::is_aligned<::boost::alignment_of<t1>::value, Align>::value, t1, ::boost::detail::max_align
            >::type align_t;

            BOOST_STATIC_CONSTANT(std::size_t, found = alignment_of<align_t>::value
            );

            BOOST_STATIC_ASSERT(found
            >= Align);
            BOOST_STATIC_ASSERT(found
            % Align == 0);
    ...
    namespace detail {
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a2,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a4,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a8,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a16,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a32,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a64,
        true)
        BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod, ::boost::tt_align_ns::a128,
        true)
    }
#endif
