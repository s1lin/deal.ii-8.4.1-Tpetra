...
// condition: Ret!=void and Ret!=dont_care and the operator does not return void
        ...
        struct operator_returns_Ret<Lhs, Rhs, Ret, false> {
            ...
            BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>())
...
// this is done with redefinition of "operator," that returns no_operator or has_operator
        ...
        struct operator_exists {
            ...
            BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP make
                                  <Rhs>()), make<has_operator>()
...
BOOST_TT_AUX_BOOL_TRAIT_DEF3(BOOST_TT_TRAIT_NAME, Lhs, Rhs = Lhs, Ret = ::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,
                                                                                                    _impl)
::dont_care, (
