...
// This namespace ensures that argument-dependent name lookup does not mess things up.
        namespace BOOST_JOIN
        (BOOST_TT_TRAIT_NAME,_impl) {
...
// - value==false -> operator BOOST_TT_TRAIT_OP does not return void
        ...
        struct operator_returns_void {
            ...
            BOOST_STATIC_CONSTANT(bool,
                                  value = (sizeof(::boost::type_traits::yes_type) == sizeof(returns_void((make<Lhs>()
                                  BOOST_TT_TRAIT_OP, returns_void_t())
...
// condition: Ret!=void and Ret!=dont_care and the operator does not return void
        ...
        struct operator_returns_Ret<Lhs, Ret, false> {
            ...
            BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP)
...
// this is done with redefinition of "operator," that returns no_operator or has_operator
        ...
        struct operator_exists {
            ...
            BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP), make<has_operator>()
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(BOOST_TT_TRAIT_NAME, Lhs, Ret = ::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)
::dont_care, (
::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl
