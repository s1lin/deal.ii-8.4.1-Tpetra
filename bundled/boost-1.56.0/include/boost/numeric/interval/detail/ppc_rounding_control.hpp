        ...
        namespace interval_lib {
            namespace detail {
                ...
                struct ppc_rounding_control {
                    ...
                    static void
                    set_rounding_mode(const rounding_mode mode) { __asm__ __volatile__ ("mtfsf 255,%0" : : "f"(mode)); }

                    static void
                    get_rounding_mode(rounding_mode &mode) { __asm__ __volatile__ ("mffs %0" : "=f"(mode)); }
