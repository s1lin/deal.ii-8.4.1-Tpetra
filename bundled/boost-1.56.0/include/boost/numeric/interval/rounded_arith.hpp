 ...
 */
            ...
            struct rounded_arith_exact : Rounding {
                ...
                template<class U>
                T conv_down(U const &v) { return v; }

                template<class U>
                T conv_up(U const &v) { return v; }
...
# define BOOST_UP(EXPR) this->upward();     return this->force_rounding(EXPR)
                ...
                template<class U>
                T conv_down(U const &v) { BOOST_DN(v); }

                template<class U>
                T conv_up(U const &v) { BOOST_UP(v); }
...
# define BOOST_UP_NEG(EXPR) return -this->force_rounding(EXPR)
                ...
                template<class U>
                T conv_down(U const &v) { BOOST_UP_NEG(-v); }
