 ...
 */
        ...
        interval <T, Policies> intersect(const interval <T, Policies> &x,
            ...
            if (interval_lib::detail::test_input(x, y))
                return interval<T, Policies>::empty();
            const T &l = max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y.lower());
            const T &u = min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y.upper());
        ...
        interval <T, Policies> hull(const interval <T, Policies> &x,
            ...
            return interval<T, Policies>(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y.lower()),
                    max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y.upper()), true);
        }
        ...
        interval <T, Policies> hull(const interval <T, Policies> &x, const T &y) {
            ...
            return interval<T, Policies>(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y),
                    max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y), true);
        }
        ...
        interval <T, Policies> hull(const T &x, const interval <T, Policies> &y) {
            ...
            return interval<T, Policies>(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.lower()),
                    max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.upper()), true);
        }
 ...
 */
        ...
        T norm(const interval <T, Policies> &x) {
            ...
            BOOST_USING_STD_MAX();
            return max
            BOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<T>(-x.lower()), x.upper());
        }
        ...
        interval <T, Policies> abs(const interval <T, Policies> &x) {
            ...
            BOOST_USING_STD_MAX();
            return I(static_cast<T>(0), max
            BOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<T>(-x.lower()), x.upper()), true);
        }

        template<class T, class Policies> inline
        interval <T, Policies> max

        BOOST_PREVENT_MACRO_SUBSTITUTION(const interval <T, Policies> &x,
                                         const interval <T, Policies> &y) {
            typedef interval <T, Policies> I;
            if (interval_lib::detail::test_input(x, y))
                return I::empty();
            BOOST_USING_STD_MAX();
            return I(max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y.lower()), max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y.upper()), true);
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const interval <T, Policies> &x, const T &y) {
            ...
            BOOST_USING_STD_MAX();
            return I(max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y), max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y), true);
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const T &x, const interval <T, Policies> &y) {
            ...
            BOOST_USING_STD_MAX();
            return I(max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.lower()), max
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.upper()), true);
        }

        template<class T, class Policies> inline
        interval <T, Policies> min
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const interval <T, Policies> &x,
            ...
            BOOST_USING_STD_MIN();
            return I(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y.lower()), min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y.upper()), true);
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const interval <T, Policies> &x, const T &y) {
            ...
            BOOST_USING_STD_MIN();
            return I(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y), min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x.upper(), y), true);
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const T &x, const interval <T, Policies> &y) {
            ...
            BOOST_USING_STD_MIN();
            return I(min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.lower()), min
            BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.upper()), true);
        }
