...
namespace boost {
    namespace numeric {
        namespace ublas {
            ...
            begin(vector_expression<ExprT>
            & e) {
            return

            detail::begin_impl<typename ExprT::type_category>::apply (e());
        }
    ...
    begin(matrix_expression<ExprT>
    & e) {
    return

    detail::begin_impl<typename ExprT::type_category, TagT, typename ExprT::orientation_category>::apply (e());
}
