...
namespace boost {
     ...
     */
            ...
            public:
                ...
                BOOST_UBLAS_INLINE
                void
                resize_packed_preserve(size_type size1, size_type size2, size_type lower = 0, size_type upper = 0) {
                    size1_ = size1;
                    size2_ = size2;
                    lower_ = lower;
                    upper_ = upper;
            ...
            return data () [layout_type::element (k, (std::max) (size1_, size2_),
                ...
                operator=(const banded_matrix &m) {
                    size1_ = m.size1_;
                    size2_ = m.size2_;
                    lower_ = m.lower_;
                    upper_ = m.upper_;
                ...
                BOOST_UBLAS_INLINE
                        banded_matrix
                &
                assign_temporary (banded_matrix
                &m) {
                    swap(m);
                    return *this;
                }
     ...
     */
        ...
        reference operator () (size_type i, size_type j) const {
            ...
            return const_cast<reference>(zero_);
                ...
                operator=(const banded_adaptor &m) {
                ...
                BOOST_UBLAS_INLINE
                        banded_adaptor
                &
                assign_temporary (banded_adaptor
                &m) {
                    *this = m;
                    return *this;
                }
