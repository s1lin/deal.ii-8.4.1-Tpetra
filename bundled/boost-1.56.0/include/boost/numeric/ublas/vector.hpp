...
namespace boost {
    namespace numeric {
        namespace ublas {
            ...
            typedef vector<T, bounded_array < T, N> >
            vector_type;
            public:
            ...
            template<class A2>
            // Allow vector<T,bounded_array<N> construction
            BOOST_UBLAS_INLINE
            ...
            operator=(const bounded_vector &v) {
                vector_type::operator=(v);
                return *this;
            }
        ...
        template<class T, class ALLOC>
        typename unit_vector<T, ALLOC>::const_value_type unit_vector<T, ALLOC>::one_(
        ...
        public:
            ...
            operator=(const scalar_vector &v) {
                size_ = v.size_;
                value_ = v.value_;
                return *this;
            }
