...
namespace boost {
    namespace numeric {
        namespace ublas {
            ...
            struct promote_traits {
                ...
                static const std::size_t size = sizeof(
                        type_deduction_detail::test<
                                typename base_type::x_type, typename base_type::y_type
            ...
            ::type inline operator+(I in1, std::complex<R> const &in2) {
                return R(in1) + in2;
            }
            ...
            ::type inline operator+(std::complex<R> const &in1, I in2) {
                return in1 + R(in2);
            }
            ...
            BOOST_UBLAS_INLINE
            void
            increment(I &it, const I &it_end, typename I::difference_type compare, packed_random_access_iterator_tag) {
