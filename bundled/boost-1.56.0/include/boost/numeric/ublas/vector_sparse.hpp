...
namespace boost {
     ...
     */
            ...
            public:
                ...
                i) {
                    ...
                    std::pair<subiterator_type, bool> ii(
                            data().insert(typename array_type::value_type(i, value_type/*zero*/())));
            ...
            return reference (*this, i);
                ...
                operator=(const mapped_vector &v) {
                    if (this != &v) {
                        size_ = v.size_;
                        data() = v.data();
                    }
     ...
     */
            ...
            public:
                ...
                BOOST_UBLAS_INLINE
                typename index_array_type::size_type
            ...
            public:
                ...
                i) const {
                    const_subiterator_type it(
                            detail::lower_bound(index_data_.begin(), index_data_.begin() + filled_, k_based(i),
                                                std::less<size_type>()));
            ...
            return reference (*this, i);
                ...
                const_reference t
                    ...
                    BOOST_UBLAS_CHECK(
                            filled_ == 0 || filled_ == typename index_array_type::size_type(n) || *it != k_based(i),
            ...
            public:
                ...
                // BOOST_UBLAS_INLINE This function seems to be big. So we do not let the compiler inline it.
                const_iterator find(size_type i) const {
                    return const_iterator(*this, detail::lower_bound(index_data_.begin(), index_data_.begin() + filled_,
                                                                     k_based(i), std::less<size_type>()));
                }
            ...
            private:
                void storage_invariants() const {
                    ...
                    BOOST_UBLAS_CHECK(filled_ <= capacity_, internal_logic());
                    BOOST_UBLAS_CHECK((0 == filled_) || (zero_based(index_data_[filled_ - 1]) < size_),
                                      internal_logic());
                }
     ...
     */
            ...
            public:
                ...
                BOOST_UBLAS_INLINE
                void set_filled(const typename index_array_type::size_type &sorted,
            ...
            return reference (*this, i);
                ...
                void push_back(size_type i, const_reference t) {
                    ...
                    BOOST_UBLAS_CHECK(sorted_ && (filled_ == 0 || index_data_[filled_ - 1] < k_based(i)),
                                      external_logic());
                    if (filled_ >= capacity_)
                        reserve(2 * filled_, true);
                    BOOST_UBLAS_CHECK(filled_ < capacity_, internal_logic());
