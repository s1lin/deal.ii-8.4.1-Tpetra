        ...
        namespace ublas {
            ...
            public:
                ...
                compressed_matrix_view(index_type n_rows, index_type n_cols, array_size_type nnz,
                                       const rowptr_array_type &iptr, const index_array_type &jptr,
            ...
            private:
                ...
                const_pointer find_element(index_type i, index_type j) const {
                    ...
                    const_subiterator_type it_start = boost::next(
                            vector_view_traits<index_array_type>::begin(index2_data_), itv);
                    const_subiterator_type it_end = boost::next(
                            vector_view_traits<index_array_type>::begin(index2_data_), itv_next);
                ...
                const_subiterator_type find_index_in_row(const_subiterator_type it_start, const_subiterator_type it_end,
            ...
            private:
                void storage_invariants() const {
                    BOOST_UBLAS_CHECK(index1_data_[layout_type::size_M(size1_, size2_)] == k_based(nnz_),
                                      external_logic());
                }
            ...
            make_compressed_matrix_view(typename vector_view_traits<JA>::value_type n_rows,
                                        ...
                                        typename vector_view_traits<JA>::size_type nnz, const IA &ia, const JA &ja,
                                        const TA &ta) {
