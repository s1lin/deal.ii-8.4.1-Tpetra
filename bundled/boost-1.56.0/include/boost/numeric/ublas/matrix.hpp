...
namespace boost {
     ...
     */
            ...
            typedef matrix<T, L, bounded_array < T, M * N> >
            matrix_type;
            public:
    ...
    template<class A2>
    // Allow matrix<T, L, bounded_array<M,N> > construction
    BOOST_UBLAS_INLINE
    ...
    operator=(const bounded_matrix &m) {
        matrix_type::operator=(m);
        return *this;
    }
    ...
    operator=(const matrix <T, L2, A2> &m) {
        matrix_type::operator=(m);
        return *this;
    }
...
public:
    ...
    BOOST_UBLAS_INLINE
            vector_of_vector
    &
    assign_temporary (vector_of_vector
    &m) {
        swap(m);
        return *this;
    }
...
public:
    ...
    BOOST_UBLAS_INLINE
            identity_matrix
    &
    assign_temporary (identity_matrix
    &m) {
        swap(m);
        return *this;
    }
...
template<class T, class ALLOC>
const typename identity_matrix<T, ALLOC>::value_type identity_matrix<T, ALLOC>::one_(
        1); // ISSUE: need 'one'-traits here
...
public:
    ...
    operator=(const scalar_matrix &m) {
        size1_ = m.size1_;
        size2_ = m.size2_;
        value_ = m.value_;
        return *this;
    ...
    BOOST_UBLAS_INLINE
            scalar_matrix
    &
    assign_temporary (scalar_matrix
    &m) {
        swap(m);
        return *this;
    }
