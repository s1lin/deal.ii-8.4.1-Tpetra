...
// #endif
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_unary_traits<const E, scalar_identity < typename E::value_type>
            >
            ...
            public:
                ...
                public:
                    ...
                    const_iterator(const self_type &vb, size_type i,
                            ...
                            container_const_reference<self_type>(vb), i_(i), it1_(it1), it1_end_(it1_end), it2_(it2),
                            it2_end_(it2_end) {}
            ...
            public:
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    const_iterator(const self_type &vbs, const const_subiterator1_type &it1,
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_scalar_unary_traits<E, vector_sum < E>
            >
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_scalar_unary_traits<E, vector_norm_1 < E>
            >
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_scalar_unary_traits<E, vector_norm_2 < E>
            >
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_scalar_unary_traits<E, vector_norm_inf < E>
            >
            ...
            template<class E>
            BOOST_UBLAS_INLINE
            typename vector_scalar_unary_traits<E, vector_index_norm_inf < E>
            >

            ::result_type
            index_norm_inf(const vector_expression <E> &e) {
                typedef typename vector_scalar_unary_traits<E,
                        vector_index_norm_inf < E> >::expression_type expression_type;
                return expression_type(e());
            }
            ...
            inner_prod(const vector_expression <E1> &e1,
                ...
                typedef typename vector_scalar_binary_traits<E1, E2, vector_inner_prod < E1, E2,
                        typename promote_traits<typename E1::value_type,
                typename E2::value_type > ::promote_type > > ::expression_type
                expression_type;
                return expression_type(e1(), e2());
            }
            ...
            prec_inner_prod(const vector_expression <E1> &e1,
                ...
                typedef typename vector_scalar_binary_traits<E1, E2, vector_inner_prod < E1, E2,
                        typename type_traits<typename promote_traits<typename E1::value_type,
                typename E2::value_type > ::promote_type > ::precision_type > > ::expression_type
                expression_type;
                return expression_type(e1(), e2());
            }
