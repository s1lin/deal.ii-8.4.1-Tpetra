        ...
        namespace ublas {
            ...
            public:
                ...
                void serialize(Archive &ar, const unsigned int /* file_version */) {
                    ar & serialization::make_nvp("base",
                                                 boost::serialization::base_object<std::map<I, T /*, ALLOC */> >(
                                                         *this));
                }
            };
            ...
            public:
                ...
                const_iterator find(key_type i) const {
                    const_iterator it(detail::lower_bound(begin(), end(), value_type(i, mapped_type(0)),
                ...
                iterator find(key_type i) {
                    iterator it(detail::lower_bound(begin(), end(), value_type(i, mapped_type(0)),
                                                    detail::less_pair<value_type>()));
                    if (it == end() || it->first != i)
                        it = end();
                    return it;
                ...
                const_iterator lower_bound(key_type i) const {
                    return detail::lower_bound(begin(), end(), value_type(i, mapped_type(0)),
                                               detail::less_pair<value_type>());
                }
