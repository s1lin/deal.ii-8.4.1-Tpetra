...
namespace boost {
     ...
     */
        ...
        reference operator [] (size_type i) const {
            ...
            operator=(const matrix_column &mc) {
                // ISSUE need a temporary, proxy can be overlaping alias
        ...
        return
        matrix_column<M> (data, j
        );
    }
    template<class M>
    BOOST_UBLAS_INLINE
    const matrix_column<const M>
    ...
    public:
        ...
        project(const range_type &r1, const range_type &r2) const {
            return matrix_range < matrix_type >
                   (data_, r1_.compose(r1.preprocess(data_.size1())), r2_.compose(r2.preprocess(data_.size2())), 0);
        }
        ...
        operator=(const matrix_range &mr) {
    ...
    public:
        ...
        find1(int rank, size_type i, size_type j) const {
        ...
        find1(int rank, size_type i, size_type j) {
        ...
        find2(int rank, size_type i, size_type j) const {
        ...
        find2(int rank, size_type i, size_type j) {
        ...
        public:
            ...
            operator-(const const_iterator1 &it) const {
                BOOST_UBLAS_CHECK((*this)().same_closure(it()), external_logic());
                return it_ - it.it_;
            }
        ...
        public:
            ...
            operator-(const iterator1 &it) const {
                BOOST_UBLAS_CHECK((*this)().same_closure(it()), external_logic());
                return it_ - it.it_;
            }
        ...
        public:
            ...
            operator-(const const_iterator2 &it) const {
                BOOST_UBLAS_CHECK((*this)().same_closure(it()), external_logic());
                return it_ - it.it_;
            }
        ...
        public:
            ...
            operator-(const iterator2 &it) const {
                BOOST_UBLAS_CHECK((*this)().same_closure(it()), external_logic());
                return it_ - it.it_;
            }
    ...
    return
    matrix_range<M> (data, range_type(start1, stop1), range_type(start2, stop2)
    );
}
template<class M>
BOOST_UBLAS_INLINE
...
subrange(const M &data, typename M::size_type start1, typename M::size_type stop1, typename M::size_type start2,
         typename M::size_type stop2) {
    typedef basic_range<typename M::size_type, typename M::difference_type> range_type;
    return matrix_range <
    const M> (data, range_type(start1, stop1), range_type(start2, stop2));
}
...
return
matrix_range<M> (data, r1, r2
);
}
template<class M>
BOOST_UBLAS_INLINE
const matrix_range<const M>
...
template<class M>
BOOST_UBLAS_INLINE
const matrix_range<M>

project(const matrix_range<M> &data, const typename matrix_range<M>::range_type &r1,
        const typename matrix_range<M>::range_type &r2) {
...
public:
    ...
    project(const range_type &r1, const range_type &r2) const {
        return matrix_slice < matrix_type >
               (data_, s1_.compose(r1.preprocess(data_.size1())), s2_.compose(r2.preprocess(data_.size2())), 0);
    }
    ...
    project(const slice_type &s1, const slice_type &s2) const {
        return matrix_slice < matrix_type >
               (data_, s1_.compose(s1.preprocess(data_.size1())), s2_.compose(s2.preprocess(data_.size2())), 0);
    }
    ...
    operator=(const matrix_slice &ms) {
...
return
matrix_slice<M> (data, slice_type(start1, stride1, size1), slice_type(start2, stride2, size2)
);
}
template<class M>
BOOST_UBLAS_INLINE
...
subslice(const M &data, typename M::size_type start1, typename M::difference_type stride1, typename M::size_type size1,
         typename M::size_type start2, typename M::difference_type stride2, typename M::size_type size2) {
    typedef basic_slice<typename M::size_type, typename M::difference_type> slice_type;
    return matrix_slice <
    const M> (data, slice_type(start1, stride1, size1), slice_type(start2, stride2, size2));
}
...
return
matrix_slice<M> (data, s1, s2
);
}
template<class M>
BOOST_UBLAS_INLINE
const matrix_slice<const M>
...
template<class M>
BOOST_UBLAS_INLINE
const matrix_slice<M>

project(const matrix_slice<M> &data, const typename matrix_range<M>::range_type &r1,
        const typename matrix_range<M>::range_type &r2) {
    return data.project(r1, r2);
}
...
project(const matrix_slice<M> &data, const typename matrix_slice<M>::slice_type &s1,
        const typename matrix_slice<M>::slice_type &s2) {
...
public:
    ...
    BOOST_UBLAS_INLINE
    matrix_indirect(const matrix_closure_type &data, const indirect_array_type &ia1, const indirect_array_type &ia2,
                    int):
            data_(data), ia1_(ia1.preprocess(data.size1())), ia2_(ia2.preprocess(data.size2())) {}
    ...
    // Critical is that matrix_type and data_ (vector_closure_type) are const correct
    BOOST_UBLAS_INLINE
            matrix_indirect<matrix_type, indirect_array_type>

    project(const range_type &r1, const range_type &r2) const {
        return matrix_indirect < matrix_type, indirect_array_type >
                                              (data_, ia1_.compose(r1.preprocess(data_.size1())), ia2_.compose(
    ...
    project(const slice_type &s1, const slice_type &s2) const {
        return matrix_indirect < matrix_type, indirect_array_type >
                                              (data_, ia1_.compose(s1.preprocess(data_.size1())), ia2_.compose(
    ...
    project(const indirect_array_type &ia1, const indirect_array_type &ia2) const {
        return matrix_indirect < matrix_type, indirect_array_type >
                                              (data_, ia1_.compose(ia1.preprocess(data_.size1())), ia2_.compose(
...
template<class M, class A>
BOOST_UBLAS_INLINE
const matrix_indirect<const M, indirect_array < A>
>
...
project(const M &data, const indirect_array <A> &ia1, const indirect_array <A> &ia2) {
    ...
    return matrix_indirect <
    const M, indirect_array < A > > (data, ia1, ia2);
}

template<class M, class IA>
BOOST_UBLAS_INLINE
        matrix_indirect<M, IA>
project (matrix_indirect<M, IA>
&data,
...
template<class M, class IA>
BOOST_UBLAS_INLINE
const matrix_indirect<M, IA>

project(const matrix_indirect<M, IA> &data, const typename matrix_indirect<M, IA>::range_type &r1,
        const typename matrix_indirect<M, IA>::range_type &r2) {
    return data.project(r1, r2);
}
...
project(const matrix_indirect<M, IA> &data, const typename matrix_indirect<M, IA>::slice_type &s1,
        const typename matrix_indirect<M, IA>::slice_type &s2) {
    return data.project(s1, s2);
}
...
BOOST_UBLAS_INLINE
        matrix_indirect<M, indirect_array < A>
>
project (matrix_indirect<M, indirect_array < A>
> &data,
const indirect_array <A> &ia1,
const indirect_array <A> &ia2
) {
...
template<class M, class A>
BOOST_UBLAS_INLINE
const matrix_indirect<M, indirect_array < A>
>

project(const matrix_indirect<M, indirect_array < A>
