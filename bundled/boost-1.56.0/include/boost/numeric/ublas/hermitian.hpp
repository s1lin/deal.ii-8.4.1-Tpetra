     ...
     */
            ...
            public:
                ...
                hermitian_matrix(size_type size):
                        ...
                        data_(triangular_type::packed_size(layout_type(), size, size)) {
                }
                ...
                operator()(size_type i, size_type j) const {
                    ...
                    if (triangular_type::other(i, j))
                        ...
                        return type_traits<value_type>::conj(
                                data()[triangular_type::element(layout_type(), j, size_, i, size_)]);
                }
            ...
            return reference (*this, i, j, type_traits<value_type>::conj (data () [triangular_type::element (layout_type (), j, size_, i, size_)]));
                ...
                t) {
                    ...
                    if (triangular_type::other(i, j)) {
                        ...
                        return (data()[triangular_type::element(layout_type(), j, size_, i,
                                                                size_)] = type_traits<value_type>::conj(t));
                    }
                }
        ...
        true_reference insert_element (size_type i, size_type j, value_type t) {
            ...
            if (triangular_type::other (i, j))
                ...
                BOOST_UBLAS_INLINE
                        hermitian_adaptor
                &
                assign_temporary (hermitian_adaptor
                &m) {
                    *this = m;
                    return *this;
                }
                    ...
                    if (triangular_type::other(i, j)) {
                        ...
                        if (triangular_type::other(i, size2())) {
                            ...
                            return const_iterator2(*this, 0, 0,
                                                   ...
                                                   data().find2(rank, size1(), size2()),
                                                   data().find2(rank, size2(), size2()));
                        }
                    }
                }
