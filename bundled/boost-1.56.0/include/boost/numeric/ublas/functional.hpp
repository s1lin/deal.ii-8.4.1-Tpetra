    ...
    namespace numeric {
        namespace ublas {
            ...
            struct vector_inner_prod :
                ...
                const I1 &it1_end, I2
                it2,
                const I2 &it2_end, sparse_bidirectional_iterator_tag
                ) {
                    result_type t = result_type(0);
            ...
            struct matrix_matrix_prod :
                ...
                const I1 &it1_end, I2
                it2,
                const I2 &it2_end, packed_random_access_iterator_tag
                ) {
                    result_type t = result_type(0);
                    difference_type it1_size(it1_end - it1);
                    difference_type it2_size(it2_end - it2);
            ...
            struct basic_row_major {
                ...
                size_type size_j
                    ...
                    BOOST_UBLAS_CHECK(
                            size == 0 || size / 2 < (std::numeric_limits<size_type>::max) () / size /* +1/2 */,
                            bad_size());
                ...
                BOOST_UBLAS_INLINE
                        size_type
                index_M (size_type
                index1, size_type /* index2 */) {
                    return index1;
                }
                static
                BOOST_UBLAS_INLINE
                        size_type
                index_m (size_type /* index1 */, size_type
                index2) {
                    return index2;
                }
                static
                ...
                BOOST_UBLAS_INLINE
                        size_type
                size_m (size_type /* size_i */, size_type
                size_j) {
                    return size_j;
                }
            };
            ...
            struct basic_full {
                ...
                BOOST_UBLAS_INLINE
                        size_type
                restrict2 (size_type /* i */, size_type
                j) {
                    return j;
                }
                static
                ...
                BOOST_UBLAS_INLINE
                        size_type
                mutable_restrict2 (size_type /* i */, size_type
                j) {
                    return j;
                }
            };
            ...
            namespace detail {
                ...
                struct transposed_structure {
                    ...
                    BOOST_UBLAS_INLINE
                            size_type
                    global_mutable_restrict1 (size_type
                    index1,
                    size_type size1, size_type
                    index2,
                    size_type size2
                    ...
                    BOOST_UBLAS_INLINE
                            size_type
                    global_mutable_restrict2 (size_type
                    index1,
                    size_type size1, size_type
                    index2,
                    size_type size2
            ...
            struct basic_lower {
                ...
                restrict2 (size_type
                i,
                size_type j, size_type /* size1 */, size_type /* size2 */) {
                ...
                BOOST_UBLAS_INLINE
                        size_type
                global_restrict2 (size_type /* index1 */, size_type /* size1 */, size_type
                index2,
                size_type size2
                ) {
                ...
                BOOST_UBLAS_INLINE
                        size_type
                global_mutable_restrict2 (size_type /* index1 */, size_type /* size1 */, size_type
                index2,
                size_type size2
                ) {
                    return (std::max)(size_type(0), (std::min)(size2, index2));
