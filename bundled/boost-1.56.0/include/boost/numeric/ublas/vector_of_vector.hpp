            ...
            public:
                ...
                public:
                    ...
                    const_iterator1(const self_type &m, int rank, size_type i, size_type j,
                                    const const_vectoriterator_type &itv, const const_subiterator_type &it):
                    ...
                    index1() const {
                        ...
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_M(itv_.index(), it_.index()) < (*this)().size1(),
                                              bad_index());
                    ...
                    index2() const {
                        BOOST_UBLAS_CHECK(*this != (*this)().find1(0, (*this)().size1(), j_), bad_index());
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_m(itv_.index(), it_.index()) < (*this)().size2(),
                                              bad_index());
                            return layout_type::index_m(itv_.index(), it_.index());
                        } else {
                            return j_;
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    iterator1(self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv,
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    iterator2(self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv,
                              const subiterator_type &it):
                            container_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it) {}
