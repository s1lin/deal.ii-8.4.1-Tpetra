...
namespace boost {
    ...
    */
            ...
            public:
...
#ifndef BOOST_UBLAS_STRICT_MATRIX_SPARSE
                    const size_type element = layout_type::element(i, size1_, j, size2_);
                    std::pair<subiterator_type, bool> ii(
                            data().insert(typename array_type::value_type(element, value_type/*zero*/())));
                ...
                BOOST_UBLAS_INLINE
                        true_reference
                insert_element (size_type
                i,
                size_type j, const_reference
                t) {
                ...
                operator=(const mapped_matrix &m) {
                    if (this != &m) {
                        size1_ = m.size1_;
                        size2_ = m.size2_;
                        data() = m.data();
            ...
            public:
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    const_iterator1(const self_type &m, int rank, size_type i, size_type j,
                                    const const_subiterator_type &it):
                            container_const_reference<self_type>(m), rank_(rank), i_(i), j_(j), it_(it) {}

                    BOOST_UBLAS_INLINE
                    const_iterator1(const iterator1 &it):
                            container_const_reference<self_type>(it()), rank_(it.rank_), i_(it.i_), j_(it.j_),
                            it_(it.it_) {}
                    ...
                    index1() const {
                        ...
                        if (rank_ == 1) {
                            const self_type &m = (*this)();
                            BOOST_UBLAS_CHECK(
                                    layout_type::index_i((*it_).first, m.size1(), m.size2()) < (*this)().size1(),
                                    bad_index());
                    ...
                    index2() const {
                        if (rank_ == 1) {
                            const self_type &m = (*this)();
                            BOOST_UBLAS_CHECK(
                                    layout_type::index_j((*it_).first, m.size1(), m.size2()) < (*this)().size2(),
                                    bad_index());
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    const_iterator2(const self_type &m, int rank, size_type i, size_type j,
                                    const const_subiterator_type &it):
                            container_const_reference<self_type>(m), rank_(rank), i_(i), j_(j), it_(it) {}
            ...
            public:
                ...
                operator()(size_type i, size_type j) {
                    ...
                    std::pair<subiterator_type, bool> ii(vd.insert(
                            typename array_type::value_type::second_type::value_type(element2, value_type/*zero*/())));
                ...
                t) {
                    ...
                    vector_data_value_type &vd(data()[element1]);
                    std::pair<subiterator_type, bool> ii(
                            vd.insert(typename vector_data_value_type::value_type(element2, t)));
                    BOOST_UBLAS_CHECK((ii.first)->first == element2, internal_logic());   // broken map
                    if (!ii.second)     // existing element
                        (ii.first)->second = t;
                    return (ii.first)->second;
                ...
                BOOST_UBLAS_INLINE
                        mapped_vector_of_mapped_vector
                &
                assign_temporary (mapped_vector_of_mapped_vector
                &m) {
                    swap(m);
                    return *this;
                }
            ...
            public:
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    const_iterator1(const self_type &m, int rank, size_type i, size_type j,
                                    const vector_const_subiterator_type &itv, const const_subiterator_type &it):
                            container_const_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it) {}

                    BOOST_UBLAS_INLINE
                    const_iterator1(const iterator1 &it):
                            container_const_reference<self_type>(it()), rank_(it.rank_), i_(it.i_), j_(it.j_),
                            itv_(it.itv_), it_(it.it_) {}
                    ...
                    index1() const {
                        BOOST_UBLAS_CHECK(*this != (*this)().find1(0, (*this)().size1(), j_), bad_index());
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_M((*itv_).first, (*it_).first) < (*this)().size1(),
                                              bad_index());
                    ...
                    index2() const {
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_m((*itv_).first, (*it_).first) < (*this)().size2(),
                                              bad_index());
                            return layout_type::index_m((*itv_).first, (*it_).first);
                        } else {
                            return j_;
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    iterator1(self_type &m, int rank, size_type i, size_type j, const vector_subiterator_type &itv,
                ...
                public:
                    ...
                    BOOST_UBLAS_INLINE
                    iterator2(self_type &m, int rank, size_type i, size_type j, const vector_subiterator_type &itv,
                              const subiterator_type &it):
                            container_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it) {}
            ...
            public:
                ...
                compressed_matrix():
                        ...
                        index1_data_(layout_type::size_M(size1_, size2_) + 1), index2_data_(capacity_),
            ...
            public:
                ...
                size_type j
                    ...
                    const_subiterator_type it(
                            detail::lower_bound(it_begin, it_end, k_based(element2), std::less<size_type>()));
                ...
                t) {
                    ...
                    BOOST_UBLAS_CHECK(it == it_end || *it != k_based(element2),
                                      internal_logic());   // duplicate bound by lower_bound
                    ++filled2_;
                ...
                operator=(const compressed_matrix &m) {
                    if (this != &m) {
                        size1_ = m.size1_;
                        size2_ = m.size2_;
                ...
                BOOST_UBLAS_INLINE
                        compressed_matrix
                &
                assign_temporary (compressed_matrix
                &m) {
                    swap(m);
                    return *this;
                }
            ...
            public:
                ...
                const_iterator1 find1(int rank, size_type i, size_type j, int direction = 1) const {
                    for (;;) {
                        ...
                        const_subiterator_type it(
                                detail::lower_bound(it_begin, it_end, k_based(address2), std::less<size_type>()));
                        if (rank == 0)
                            return const_iterator1(*this, rank, i, j, itv, it);
                ...
                public:
                    ...
                    index1() const {
                        BOOST_UBLAS_CHECK(*this != (*this)().find1(0, (*this)().size1(), j_), bad_index());
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_M(itv_ - (*this)().index1_data_.begin(),
                                                                   (*this)().zero_based(*it_)) < (*this)().size1(),
                                              bad_index());
                            return layout_type::index_M(itv_ - (*this)().index1_data_.begin(),
                                                        (*this)().zero_based(*it_));
                        } else {
                            return i_;
                        }
                    ...
                    index2() const {
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(layout_type::index_m(itv_ - (*this)().index1_data_.begin(),
                                                                   (*this)().zero_based(*it_)) < (*this)().size2(),
                                              bad_index());
                            return layout_type::index_m(itv_ - (*this)().index1_data_.begin(),
                                                        (*this)().zero_based(*it_));
                        } else {
            ...
            private:
                void storage_invariants() const {
                    ...
                    BOOST_UBLAS_CHECK(filled1_ > 0 && filled1_ <= layout_type::size_M(size1_, size2_) + 1,
                                      internal_logic());
                    BOOST_UBLAS_CHECK(filled2_ <= capacity_, internal_logic());
            ...
            private:
                BOOST_UBLAS_INLINE
                        array_size_type
                restrict_capacity (array_size_type
                non_zeros) const {
                    // minimum non_zeros
            ...
            public:
                ...
                size_type j
                    ...
                    size_type element1(layout_type::index_M(i, j));
                    size_type element2(layout_type::index_m(i, j));
                    vector_const_subiterator_type itv_begin(
                            detail::lower_bound(index1_data_.begin(), index1_data_.begin() + filled_, k_based(element1),
                                                std::less<size_type>()));
                    vector_const_subiterator_type itv_end(
                            detail::upper_bound(index1_data_.begin(), index1_data_.begin() + filled_, k_based(element1),
                                                std::less<size_type>()));
                ...
                void erase_element(size_type i, size_type j) {
                    ...
                    size_type element2 = layout_type::index_m(i, j);
                    sort();
                    vector_subiterator_type itv_begin(
                            detail::lower_bound(index1_data_.begin(), index1_data_.begin() + filled_, k_based(element1),
                                                std::less<size_type>()));
                    vector_subiterator_type itv_end(
                            detail::upper_bound(index1_data_.begin(), index1_data_.begin() + filled_, k_based(element1),
                                                std::less<size_type>()));
                ...
                operator=(const coordinate_matrix &m) {
                    if (this != &m) {
                        size1_ = m.size1_;
                        size2_ = m.size2_;
                        capacity_ = m.capacity_;
                ...
                BOOST_UBLAS_INLINE
                        coordinate_matrix
                &
                assign_temporary (coordinate_matrix
                &m) {
                    swap(m);
                    return *this;
                }
                ...
                void push_back(size_type i, size_type j, const_reference t) {
                    ...
                    BOOST_UBLAS_CHECK(sorted_ &&
                                      (filled_ == 0 ||
                                       ...
                                       (index1_data_[filled_ - 1] == k_based(element1) &&
                                        index2_data_[filled_ - 1] < k_based(element2))), external_logic());
                    if (filled_ >= capacity_)
                        reserve(2 * filled_, true);
                    BOOST_UBLAS_CHECK(filled_ < capacity_, internal_logic());
                    index1_data_[filled_] = k_based(element1);
            ...
            public:
                ...
                const_iterator1 find1(int rank, size_type i, size_type j, int direction = 1) const {
                    ...
                    for (;;) {
                        ...
                        vector_const_subiterator_type itv_begin(
                                detail::lower_bound(index1_data_.begin(), index1_data_.begin() + filled_,
                                                    k_based(address1), std::less<size_type>()));
                        vector_const_subiterator_type itv_end(
                                detail::upper_bound(index1_data_.begin(), index1_data_.begin() + filled_,
                                                    k_based(address1), std::less<size_type>()));
                ...
                public:
                    ...
                    index1() const {
                        ...
                        if (rank_ == 1) {
                            BOOST_UBLAS_CHECK(
                                    layout_type::index_M((*this)().zero_based(*itv_), (*this)().zero_based(*it_)) <
