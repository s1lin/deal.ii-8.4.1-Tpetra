    ...
    namespace numeric {
        namespace ublas {
            ...
            public:
                ...
                operator=(const bounded_array &a) {
                    if (this != &a) {
                        resize(a.size_);
                        std::copy(a.data_, a.data_ + a.size_, data_);
                    }
...
// MSVC does not like arrays of size 0 in base classes.  Hence, this conditionally changes the size to 1
...
#else
                BOOST_UBLAS_BOUNDED_ARRAY_ALIGN value_type
                data_
                [N];
#endif
            };
            ...
            public:
                ...
                operator=(const array_adaptor &a) {
                    if (this != &a) {
                        resize(a.size_);
                        std::copy(a.data_, a.data_ + a.size_, data_);
                    }
            ...
            public:
                ...
                compose(const basic_range &r) const {
            ...
            public:
                ...
                compose(const basic_range<size_type, difference_type> &r) const {
                ...
                compose(const basic_slice &s) const {
            ...
            public:
                ...
                compose(const basic_slice<size_type, difference_type> &s) const {
                ...
                compose(const indirect_array &ia) const {
