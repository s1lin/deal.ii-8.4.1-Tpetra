...
// forward declaration
                ...
                size_t integrate_const(
                    ...
                    while (less_eq_with_sign(static_cast<Time>(time + time_step), end_time, dt)) {
                        obs(start_state, time);
                        real_steps += detail::integrate_adaptive(stepper, system, start_state, time, time + time_step,
                                                                 dt,
                ...
                size_t integrate_const(
                    ...
                    while (less_with_sign(static_cast<Time>(time + dt), end_time, dt)) {
                        ...
                        } else if (less_with_sign(st.current_time(), end_time,
                                                  st.current_time_step())) { // do the last step ending exactly on the end point
