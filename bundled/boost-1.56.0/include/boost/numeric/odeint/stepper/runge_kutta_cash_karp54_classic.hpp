    ...
    namespace numeric {
        namespace odeint {
            ...
            public :
                ...
                runge_kutta_cash_karp54_classic(const algebra_type &algebra = algebra_type()) : stepper_base_type(
                        algebra) {}
                ...
                void do_step_impl(System system, const StateIn &in, const DerivIn &dxdt, time_type t, StateOut &out,
                    ...
                    stepper_base_type::m_algebra.for_each6(xerr, dxdt, m_k3.m_v, m_k4.m_v, m_k5.m_v, m_k6.m_v,
                                                           typename operations_type::template scale_sum5<time_type, time_type, time_type, time_type, time_type>(
                ...
                void do_step_impl(System system, const StateIn &in, const DerivIn &dxdt, time_type t, StateOut &out,
                    ...
                    stepper_base_type::m_algebra.for_each7(m_x_tmp.m_v, in, dxdt, m_k2.m_v, m_k3.m_v, m_k4.m_v,
                                                           m_k5.m_v,
