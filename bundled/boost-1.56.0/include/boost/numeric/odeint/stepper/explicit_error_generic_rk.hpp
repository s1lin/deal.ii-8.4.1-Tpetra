            ...
            public:
                ...
                void do_step_impl(System system, const StateIn &in, const DerivIn &dxdt,
                    ...
                    detail::template generic_rk_call_algebra<StageCount, algebra_type>()(stepper_base_type::m_algebra,
                                                                                         xerr, dxdt, m_F,
                                                                                         detail::generic_rk_scale_sum_err<StageCount, operations_type, value_type, time_type>(
                                                                                                 m_b2, dt));
                }
                ...
                void do_step_impl(System system, const StateIn &in, const DerivIn &dxdt,
                    ...
                    m_rk_algorithm.do_step(stepper_base_type::m_algebra, system, in, dxdt, t, out, dt, m_x_tmp.m_v,
                                           m_F);
                }
