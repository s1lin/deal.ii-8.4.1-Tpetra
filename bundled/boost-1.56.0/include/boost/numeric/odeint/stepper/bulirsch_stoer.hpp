            ...
            public:
                ...
                try_step(System system, StateInOut &x, const DerivIn &dxdt, time_type &t, time_type &dt) {
                    m_xnew_resizer.adjust_size(x, detail::bind(
                            &controlled_error_bs_type::template resize_m_xnew<StateInOut>, detail::ref(*this),
                            detail::_1));
            ...
            private:
                ...
                controlled_step_result try_step_v1(System system, StateInOut &x, time_type &t, time_type &dt) {
                    ...
                    m_dxdt_resizer.adjust_size(x, detail::bind(
                            &controlled_error_bs_type::template resize_m_dxdt<StateInOut>, detail::ref(*this),
                            detail::_1));
                    sys(x, m_dxdt.m_v, t);
                ...
                */
                ...
                /* calculates the optimal step size for a given error and stage number */
                {
                    ...
                    if (error == 0.0)
                        ...
                        fac = max
                        BOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<value_type>(facmin / STEPFAC4), min
                        BOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<value_type>(1.0 / facmin), fac));
                    }
                    return h * fac;
                }
