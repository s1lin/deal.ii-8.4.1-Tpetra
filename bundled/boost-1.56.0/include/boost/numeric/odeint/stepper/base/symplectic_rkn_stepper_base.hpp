        ...
        namespace odeint {
            ...
            private:
                ...
                void do_step_impl(System system, const StateIn &in, time_type t, StateOut &out, time_type dt,
                    ...
                    m_dqdt_resizer.adjust_size(coor_in, detail::bind(
                            &internal_stepper_base_type::template resize_dqdt<coor_in_type>, detail::ref(*this),
                            detail::_1));
                    m_dpdt_resizer.adjust_size(momentum_in, detail::bind(
                            &internal_stepper_base_type::template resize_dpdt<momentum_in_type>, detail::ref(*this),
                            detail::_1));
