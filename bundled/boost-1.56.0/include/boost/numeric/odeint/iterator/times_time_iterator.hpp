        ...
        namespace odeint {
            ...
            public:
                times_time_iterator(Stepper stepper, System sys, State &s,
                        ...
                        : times_iterator_impl<iterator_type, Stepper, System, State, TimeIterator, detail::ode_state_time_iterator_tag, StepperTag>(
                        stepper, sys, s, t_start, t_end, dt) {}
            ...
            times_time_iterator<Stepper, System, State, TimeIterator> make_times_time_iterator_begin(
                ...
                return times_time_iterator<Stepper, System, State, TimeIterator>(stepper, system, x, t_start, t_end,
                                                                                 dt);
            }
            ...
            make_times_time_range(
                ...
                return std::make_pair(
                        times_time_iterator<Stepper, System, State, TimeIterator>(stepper, system, x, t_start, t_end,
                                                                                  dt),
