...
/// INTERNAL ONLY
        ...
        struct base_unit_converter_base<Source, BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Source,
        ...
        namespace detail {
            ...
            struct get_default_conversion_impl {
                ...
                struct apply {
                    ...
                    typedef typename reduce_unit<typename get_default_conversion<source>::type>::type new_source;
                    typedef typename get_default_conversion_impl<
                            N - 1>::template apply<typename Begin::next> next_iteration;
            ...
            struct get_default_conversion_impl<0> {
                template<class Begin>
                struct apply {
                    typedef unit <dimensionless_type, heterogeneous_system<
...
#define BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)\
    ...
    >::is_defined
            ...
            template<class Source, class Dest>
            struct call_base_unit_converter
                    : call_base_unit_converter_impl<BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source,
                                                                                                      Dest)>::template apply<Source, Dest> {
            };

            template<class Source, class Dest>
            struct call_base_unit_converter<Source, BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Dest,
                                                                                        typename Source::dimension_type)>
                    :
