...
// generally useful utilies.
            ...
            struct divide_equation {
                ...
                struct apply {
                    typedef list<typename mpl::divides<typename Begin::item, Divisor>::type, typename divide_equation<
                            N - 1>::template apply<typename Begin::next, Divisor>::type> type;
                };
            };
...
// row reduce the matrix.
            ...
            struct create_row_of_identity {
                typedef list<static_rational<0>, typename create_row_of_identity<
                        Column - 1, TotalColumns - 1>::type> type;
            };
...
// not the last row and not zero.
            ...
            struct determine_extra_equations_skip_zeros_impl<false, false> {
                ...
                struct apply {
                    ...
                    typedef typename determine_extra_equations_impl<RemainingRows -
                                                                    1>::template apply<typename RowsBegin::next, typename RowsBegin::item>::type next_equations;
            ...
            struct determine_extra_equations<RemainingColumns, true> {
                ...
                struct apply {
                    typedef typename determine_extra_equations<RemainingColumns - 1, true>::template apply<
                            RowsBegin,
                            TotalColumns,
                            list < typename create_row_of_identity<
                                    TotalColumns - RemainingColumns, TotalColumns>::type, Result>
                    >::type type;
                };
            };
                ...
                struct apply {
                    ...
                    typedef list<
                            typename eliminate_from_pair_of_equations_impl<
                                    (current_row::size::value) - 1>::template apply<
...
// The first internal element which is not zero.
            ...
            struct invert_strip_leading_zeroes<false, false> {
                ...
                struct apply {
                    ...
                    typedef typename divide_equation<(current_row::size::value -
                                                      1)>::template apply<typename current_row::next, current_value>::type new_equation;
...
// One of the initial zeroes
            ...
            struct invert_strip_leading_zeroes<true, false> {
                ...
                struct apply {
                    ...
                    typedef typename next::identity_pivot_row identity_pivot_row;
                    typedef list<
                            typename eliminate_from_pair_of_equations_impl<(current_row::size::value -
                                                                            1)>::template apply<
                                    typename current_row::next,
                                    pivot_row,
                                    typename current_row::item,
...
// Should never happen.
            ...
            struct invert_impl {
                ...
                struct apply {
                    typedef typename invert_handle_inital_rows<
                            RowsBegin::size::value - N>::template apply<RowsBegin, IdentityBegin> process_column;
            ...
            struct make_identity {
                template<int Size>
                struct apply {
                    typedef list<typename create_row_of_identity<Size - N, Size>::type, typename make_identity<
                            N - 1>::template apply<Size>::type> type;
                };
            };
...
// list<rational> expand_dimensions(dimension_list, list<base_dimension>);
            ...
            struct create_unit_matrix {
                ...
                struct apply {
                    typedef typename create_unit_matrix<
                            N - 1>::template apply<typename Begin::next, Dimensions>::type next;
