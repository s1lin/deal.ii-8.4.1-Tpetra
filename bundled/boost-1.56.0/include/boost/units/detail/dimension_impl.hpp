...
// the first remaining element of the sequence.
            ...
            struct insertion_sort_dims_mpl_sequence {
                ...
                struct apply {
                    typedef typename insertion_sort_dims_mpl_sequence<
                            N - 1>::template apply<typename mpl::next<Begin>::type>::type next;
            ...
            typedef typename insertion_sort_dims_impl<list<T, Next>::size::value>::template apply<list < T, Next> >
            ::type type;
        };
