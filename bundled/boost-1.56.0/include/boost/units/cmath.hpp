...
namespace boost {
    ...
    namespace units {
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return isfinite
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value());
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return isgreater
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value());
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(abs
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(ceil
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return quantity_type::from_value(copysign
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(fabs
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(floor
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return quantity_type::from_value(fdim
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return quantity_type::from_value(fmax
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return quantity_type::from_value(fmin
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1, const quantity <Unit, Y> &q2) {
            ...
            return quantity_type::from_value(hypot
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }
...
//}
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q1,
            ...
            return quantity_type::from_value(nextafter
            BOOST_PREVENT_MACRO_SUBSTITUTION(q1.value(), q2.value()));
        }

        template<class Unit, class Y>
        inline
        quantity <Unit, Y> nexttoward
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(round
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
        ...
        BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity <Unit, Y> &q) {
            ...
            return quantity_type::from_value(trunc
            BOOST_PREVENT_MACRO_SUBSTITUTION(q.value()));
        }
...
/// acos of dimensionless quantity returning angle in same system
        ...
        acos(const quantity <unit<dimensionless_type, homogeneous_system < System>>, Y
...
/// asin of dimensionless quantity returning angle in same system
    ...
    asin(const quantity <unit<dimensionless_type, homogeneous_system < System>>, Y
...
atan(const quantity <unit<dimensionless_type, homogeneous_system < System>>, Y
...
atan2(const quantity <unit<Dimension, homogeneous_system < System>>, Y
...
template<class Y, class Dimension, class System>
quantity <angle::radian_base_unit::unit_type, Y>
atan2(const quantity <unit<Dimension, heterogeneous_system < System>>, Y
...
using std::atan2;
return
quantity<angle::radian_base_unit::unit_type, Y>::from_value(atan2(y.value(), x.value())
);
}
