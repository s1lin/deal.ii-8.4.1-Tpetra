...
// to specify na explicitly.
        ...
        struct make_system<T0, T1, na, na, na, na, na, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    list < T0, list < T1, dimensionless_type> > >::type> type;
        };

        template<class T0, class T1, class T2>
        struct make_system<T0, T1, T2, na, na, na, na, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    list < T0, list < T1, list < T2, dimensionless_type> > > >::type> type;
        };

        template<class T0, class T1, class T2, class T3>
        struct make_system<T0, T1, T2, T3, na, na, na, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    list < T0, list < T1, list < T2, list < T3, dimensionless_type> > > > >::type> type;
        };

        template<class T0, class T1, class T2, class T3, class T4>
        struct make_system<T0, T1, T2, T3, T4, na, na, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    list < T0, list < T1, list < T2, list < T3, list < T4, dimensionless_type> > > > > >::type> type;
        };
        ...
        struct make_system<T0, T1, T2, T3, T4, T5, na, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    list < T0,
                    list < T1, list < T2, list < T3, list < T4, list < T5, dimensionless_type> > > > > > >::type> type;
        };
        ...
        struct make_system<T0, T1, T2, T3, T4, T5, T6, na, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    ...
                    list < T1,
                    list < T2,
                    list < T3, list < T4, list < T5, list < T6, dimensionless_type> > > > > > > >::type> type;
        };
        ...
        struct make_system<T0, T1, T2, T3, T4, T5, T6, T7, na, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    ...
                    list < T2,
                    list < T3,
                    list < T4, list < T5, list < T6, list < T7, dimensionless_type> > > > > > > > >::type> type;
        };
        ...
        struct make_system<T0, T1, T2, T3, T4, T5, T6, T7, T8, na> {
            typedef homogeneous_system<typename detail::insertion_sort<
                    ...
                    list < T3,
                    list < T4,
                    list < T5, list < T6, list < T7, list < T8, dimensionless_type> > > > > > > > > >::type> type;
        };
        ...
        struct make_system {
            typedef homogeneous_system<typename detail::insertion_sort<
                    ...
                    list < T4,
                    list < T5,
                    list < T6, list < T7, list < T8, list < T9, dimensionless_type> > > > > > > > > > >::type> type;
        };
