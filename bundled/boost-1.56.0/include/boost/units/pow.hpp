...
/// raise a value to an integer power.
        ...
        inline typename power_typeof_helper<Y, static_rational < N> >
...
/// raise @c float to a @c static_rational power.
    ...
    typedef power_typeof_helper<double, static_rational < N, D> >
    base;
...
template<long N, class Y>
typename root_typeof_helper<Y, static_rational < N> >
