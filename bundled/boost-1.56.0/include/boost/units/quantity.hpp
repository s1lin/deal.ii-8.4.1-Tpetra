...
/// class declaration
    ...
    public:
        ...
        quantity(const quantity<Unit, YY> &source,
                 typename boost::enable_if<detail::is_non_narrowing_conversion < YY, Y>
        ...
        explicit quantity(const quantity<Unit, YY> &source,
                          typename boost::disable_if<detail::is_non_narrowing_conversion < YY, Y>
        ...
        val_ (conversion_helper<quantity<Unit2, YY>, this_type>::convert(source)
...
/// also allowed.
    ...
    public:
        ...
        val_(conversion_helper<quantity<unit < dimensionless_type, System2>, Y2>, this_type
        >
        ::convert(source)
        .
...
{
typedef X value_type;
typedef typename multiply_typeof_helper<unit < Dim, System>,Unit >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
{
typedef X value_type;
typedef typename multiply_typeof_helper<Unit, unit < Dim, System> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
{
typedef X value_type;
typedef typename power_typeof_helper<unit < Dim, System>,static_rational<-1> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
typedef typename power_typeof_helper<Unit, static_rational < -1> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
{
typedef typename divide_typeof_helper<X, X>::type value_type;
typedef typename divide_typeof_helper<unit < Dim, System>,Unit >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
{
typedef X value_type;
typedef typename divide_typeof_helper<Unit, unit < Dim, System> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
};
...
{
typedef typename power_typeof_helper<Y, static_rational < N, D> >
::type value_type;
typedef typename power_typeof_helper<Unit, static_rational < N, D> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
...
{
typedef typename root_typeof_helper<Y, static_rational < N, D> >
::type value_type;
typedef typename root_typeof_helper<Unit, static_rational < N, D> >
::type unit_type;
typedef quantity <unit_type, value_type> type;
...
template<class System,
        ...
        class Y>
inline
typename multiply_typeof_helper<unit < Dim, System>,Y >

::type
operator*(const unit <Dim, System> &, const Y &rhs) {
    typedef typename multiply_typeof_helper<unit < Dim, System>,Y > ::type
    type;
...
template<class System,
        ...
        class Y>
inline
typename divide_typeof_helper<unit < Dim, System>,Y >

::type
operator/(const unit <Dim, System> &, const Y &rhs) {
    typedef typename divide_typeof_helper<unit < Dim, System>,Y > ::type
    type;
...
template<class System,
        ...
        class Y>
inline
typename multiply_typeof_helper<Y, unit < Dim, System> >
...
template<class System,
        ...
        class Y>
inline
typename divide_typeof_helper<Y, unit < Dim, System> >
...
template<class Unit,
        class X>
inline
typename multiply_typeof_helper<quantity < Unit, X>,X >

::type
operator*(const quantity <Unit, X> &lhs, const X &rhs) {
    typedef typename multiply_typeof_helper<quantity < Unit, X>,X > ::type
    type;
...
template<class Unit,
        class X>
inline
typename multiply_typeof_helper<X, quantity < Unit, X> >
...
template<class Unit,
        class X>
inline
typename divide_typeof_helper<quantity < Unit, X>,X >

::type
operator/(const quantity <Unit, X> &lhs, const X &rhs) {
    typedef typename divide_typeof_helper<quantity < Unit, X>,X > ::type
    type;
...
template<class Unit,
        class X>
inline
typename divide_typeof_helper<X, quantity < Unit, X> >
...
template<class System1,
        ...
        class Y>
inline
typename multiply_typeof_helper<unit < Dim1, System1>,quantity <Unit2, Y> >

::type
operator*(const unit <Dim1, System1> &, const quantity <Unit2, Y> &rhs) {
    typedef typename multiply_typeof_helper<unit < Dim1, System1>,quantity < Unit2, Y > > ::type
    type;
...
template<class System1,
        ...
        class Y>
inline
typename divide_typeof_helper<unit < Dim1, System1>,quantity <Unit2, Y> >

::type
operator/(const unit <Dim1, System1> &, const quantity <Unit2, Y> &rhs) {
    typedef typename divide_typeof_helper<unit < Dim1, System1>,quantity < Unit2, Y > > ::type
    type;
...
template<class Unit1,
        ...
        class Y>
inline
typename multiply_typeof_helper<quantity < Unit1, Y>,unit <Dim2, System2> >

::type
operator*(const quantity <Unit1, Y> &lhs, const unit <Dim2, System2> &) {
    typedef typename multiply_typeof_helper<quantity < Unit1, Y>,unit < Dim2, System2 > > ::type
    type;
...
template<class Unit1,
        ...
        class Y>
inline
typename divide_typeof_helper<quantity < Unit1, Y>,unit <Dim2, System2> >

::type
operator/(const quantity <Unit1, Y> &lhs, const unit <Dim2, System2> &) {
    typedef typename divide_typeof_helper<quantity < Unit1, Y>,unit < Dim2, System2 > > ::type
    type;
...
template<class Unit, class Y>
typename unary_plus_typeof_helper<quantity < Unit, Y> >
...
template<class Unit, class Y>
typename unary_minus_typeof_helper<quantity < Unit, Y> >
...
template<class Unit1,
        ...
        class Y>
inline
typename add_typeof_helper<quantity < Unit1, X>,quantity <Unit2, Y> >

::type
operator+(const quantity <Unit1, X> &lhs,
          const quantity <Unit2, Y> &rhs) {
    typedef typename add_typeof_helper<quantity < Unit1, X>,quantity < Unit2, Y > > ::type
    type;
...
template<class Unit1,
        ...
        class Y>
inline
typename subtract_typeof_helper<quantity < Unit1, X>,quantity <Unit2, Y> >

::type
operator-(const quantity <Unit1, X> &lhs,
          const quantity <Unit2, Y> &rhs) {
    typedef typename subtract_typeof_helper<quantity < Unit1, X>,quantity < Unit2, Y > > ::type
    type;
...
template<class Unit1,
        ...
        class Y>
inline
typename multiply_typeof_helper<quantity < Unit1, X>,quantity <Unit2, Y> >
...
template<class Unit1,
        ...
        class Y>
inline
typename divide_typeof_helper<quantity < Unit1, X>,quantity <Unit2, Y> >
