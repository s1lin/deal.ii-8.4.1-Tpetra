...
/// INTERNAL ONLY
        ...
        typedef unit<typename mpl::times<Dim1, Dim2>::type, homogeneous_system < System> >
        type;
    };
...
{
typedef unit<typename static_power<Dim, static_rational < N, D> >::type,typename static_power<System,
        static_rational < N, D> >::type>
type;
...
template<class Dim, class System>
typename unary_plus_typeof_helper<unit < Dim, System> >
...
template<class Dim, class System>
typename unary_minus_typeof_helper<unit < Dim, System> >
