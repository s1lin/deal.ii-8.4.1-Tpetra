    ...
    namespace date_time {
        ...
        public:
            ...
            data_not_accessible(const std::string &filespec) :
                    std::logic_error(
                            std::string("Unable to locate or access the required datafile. Filespec: " + filespec)) {}
        };
        ...
        private:
            ...
            bool parse_string(string_type &s) {
                ...
                token_iter_type i = boost::make_token_iterator<string_type>(s.begin(), s.end(),
                                                                            boost::escaped_list_separator<char_type>());
                ...
                enum db_fields {
                    ID, STDABBR, STDNAME, DSTABBR, DSTNAME, GMTOFFSET,
