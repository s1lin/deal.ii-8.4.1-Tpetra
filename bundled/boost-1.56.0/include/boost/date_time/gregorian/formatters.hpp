...
namespace boost {
    namespace gregorian {
        ...
        inline std::basic_string <charT> to_simple_string_type(const date_period &d) {
            ...
            string_type d1(date_time::date_formatter<date, date_time::simple_format < charT>, charT>::date_to_string(
                    d.begin()));
            string_type d2(date_time::date_formatter<date, date_time::simple_format < charT>, charT>::date_to_string(
                    d.last()));
        ...
        inline std::basic_string <charT> to_iso_string_type(const date_period &d) {
            ...
            s(date_time::date_formatter < date, date_time::iso_format < charT > , charT > ::date_to_string(d.begin()));
