                ...
                struct apply
                        : mpl::size_t<
                                ::boost::math::static_lcm<
                                        BOOST_MPL_AUX_VALUE_WKND(State)::value, ::boost::alignment_of<Item>::value
                                >::value
                        > {
                };
            };
...
//
            ...
            private: // helpers, for visitor interface (below)
                ...
                void backup_assign_impl(
                        LhsT &lhs_content, mpl::true_ // is_nothrow_move_constructible
                ) {
                ...
                template<typename LhsT>
                void backup_assign_impl(
                        LhsT &lhs_content, mpl::false_ // is_nothrow_move_constructible
                ) {
                    // Backup lhs content...
...
#   endif
            ...
            public: // internal visitor interfaces, cont.
                ...
                template<typename T>
                BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
                internal_visit(boost::recursive_wrapper<T>
                & operand, long)
                {
                ...
                template<typename T>
                BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
                internal_visit(boost::detail::reference_content<T>
                & operand, long)
                {
                    return internal_visit(operand.get(), 1L);
                }
                ...
                template<typename T>
                BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
                internal_visit(boost::detail::variant::backup_holder<T>
                & operand, long)
                {
                    return internal_visit(operand.get(), 1L);
                }
...
//
    ...
    private: // helpers, for typedefs (below)
        ...
        BOOST_STATIC_ASSERT((
                ::boost::mpl::not_<mpl::empty < specified_types>
        >::value
        ));
...
#   endif
        ...
        protected: // helpers, for internal visitor interface (below)
            ...
            void assign_impl(
                    const RhsT &rhs_content, mpl::true_ // has_nothrow_copy, B1 // is_nothrow_move_constructible,
            ...
            void assign_impl(
                    ...
                    mpl::true_ // is_nothrow_move_constructible, B // has_fallback_type
            ) const {
            ...
            void assign_impl(
                    const RhsT &rhs_content, mpl::false_ // has_nothrow_copy,
                    mpl::false_ // is_nothrow_move_constructible, mpl::true_ // has_fallback_type
            ) const {
                // Destroy lhs's content...
                lhs_.destroy_content(); // nothrow
            ...
            void assign_impl(
                    const RhsT &rhs_content, mpl::false_ // has_nothrow_copy,
                    mpl::false_ // is_nothrow_move_constructible, mpl::false_ // has_fallback_type
            ) const {
        ...
        private: // helpers, for internal visitor interface (below)
            ...
            void assign_impl(
                    RhsT &rhs_content, mpl::true_ // has_nothrow_copy, mpl::false_ // is_nothrow_move_constructible,
                    B2 // has_fallback_type
            ) const
            ...
            void assign_impl(
                    RhsT &rhs_content, B // has_nothrow_copy, mpl::true_ // is_nothrow_move_constructible,
                    B2 // has_fallback_type
            ) const
            ...
            template<typename RhsT>
            void assign_impl(
                    RhsT &rhs_content, mpl::false_ // has_nothrow_copy, mpl::false_ // is_nothrow_move_constructible,
    ...
    public: // modifiers
        ...
        typename boost::enable_if_c<
                boost::is_rvalue_reference<T &&>::value && !boost::is_const<T>::value, variant &>::type
        operator=(T &&rhs) {
    ...
    private:
        ...
        internal_apply_visitor_impl(
            ...
            return detail::variant::visitation_impl(
                    internal_which, logical_which, visitor, storage, mpl::false_(), never_uses_backup_flag(),
