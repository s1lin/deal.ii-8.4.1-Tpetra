...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        namespace detail {
            ...
            template
                    <typename Components, typename IfTagged, typename ThenTag, typename DefaultBase = components_non_func_base
                    >
            struct retagged_if
                    : mpl::if_
                              <detail::represents_impl<Components, IfTagged>, detail::changed_tag<Components, IfTagged, ThenTag>, DefaultBase
                              >::type {
            };
            ...
            struct components_impl
                    : detail::retagged_if
                              <detail::components_impl<T *, L>, pointer_tag, /* --> */ function_tag> {
            };
            template<typename T, typename L>
            struct components_impl<T &, L>
                    : detail::retagged_if
                              <detail::components_impl<T *, L>, pointer_tag, /* --> */ reference_tag> {
            };
            ...
            struct cv_func_base
                ...
                typedef typename
                mpl::remove
                        <typename Base::types, typename detail::class_transform<a_class, L>::type>::type
                        types;
            };
            ...
            struct components_impl<T *, L>
                    : mpl::if_
                              <detail::represents_impl<detail::components_impl<T a_class::*, L>, member_pointer_tag>, detail::cv_func_base<detail::components_impl<T a_class::*, L>, T, L>, components_non_func_base
                              >::type {
            };
...
#   define BOOST_FT_variations BOOST_FT_pointer
            ...
            struct components_impl<T C::*, L>
                    : detail::retagged_if
                              <detail::components_impl<typename boost::remove_cv<T>::type *, L>, pointer_tag, /* --> */ member_function_pointer_tag, member_obj_ptr_components<T, C, L> > {
            };
            ...
            struct bcc_class_transform
                    : bcc_class_transform_impl
                              <typename decode_cv
                                      <T, ::boost::function_types::detail::encode_mfp_cv<D>::value
                                      >::type, L
                              > {
            };
            ...
            private:
                ...
                typedef typename
                mpl::advance
                        <typename mpl::begin<typename Base::types>::type, typename mpl::if_
                                <mpl::equal_to <
                                 typename detail::classifier<OrigT>::function_arity, typename Base::function_arity>,
            ...
            struct components_bcc
                    : mpl::if_
                              <detail::represents_impl<detail::components_impl<T, L>, member_function_pointer_tag>, detail::mfp_components<detail::components_impl<T, L>, T, OrigT, L>, detail::components_impl<T, L>
                              >::type {
            };
