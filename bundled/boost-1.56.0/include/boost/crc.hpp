...
//  Implementation detail stuff  ---------------------------------------------//
    ...
    namespace detail {
        ...
        public:
            ...
            static unsigned char align_msb(value_type rem) { return rem >> (Bits - CHAR_BIT); }
        };
        ...
        public:
            ...
            static unsigned char align_msb(value_type rem) { return rem << (CHAR_BIT - Bits); }
        };
        ...
        public:
            ...
            static value_type reflect(value_type x) { return detail::reflector<Bits>::reflect(x); }

            // Compare a byte to the remainder's highest byte
            static unsigned char index(value_type rem, unsigned char x) { return x ^ rem; }
        ...
        public:
            ...
            // Possibly reflect a remainder
            static value_type reflect(value_type x) { return x; }

            // Compare a byte to the remainder's highest byte
            static unsigned char index(value_type rem, unsigned char x) { return x ^ remainder<Bits, (Bits >
                                                                                                      CHAR_BIT)>::align_msb(
                        rem);
            }
...
//  Simple CRC class function definitions  -----------------------------------//
    ...
    crc_basic<Bits>::crc_basic
            ...
            : rem_(initial_remainder), poly_(truncated_polynominal), init_(initial_remainder), final_(final_xor_value),
