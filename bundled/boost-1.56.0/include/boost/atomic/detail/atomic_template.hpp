...
//! Implementation for integers
    ...
    public:
        ...
        compare_exchange_strong(value_type &expected, value_type desired, memory_order success_order,
        ...
        BOOST_NOEXCEPT {
            ...
            const bool res = operations::compare_exchange_strong(m_storage, old_value,
                                                                 static_cast< storage_type >(desired), success_order,
                                                                 failure_order);
            expected = static_cast< value_type >(old_value);
            return res;
        }

        BOOST_FORCEINLINE bool compare_exchange_strong(value_type &expected, value_type desired,
        ...
        BOOST_FORCEINLINE bool
        compare_exchange_weak(value_type &expected, value_type desired, memory_order success_order,
                              memory_order failure_order) volatile
        ...
        BOOST_NOEXCEPT {
            ...
            storage_type old_value = static_cast< storage_type >(expected);
            const bool res = operations::compare_exchange_weak(m_storage, old_value,
                                                               static_cast< storage_type >(desired), success_order,
                                                               failure_order);
            expected = static_cast< value_type >(old_value);
            return res;
        ...
        BOOST_FORCEINLINE bool compare_exchange_weak(value_type &expected, value_type desired,
                                                     memory_order order = memory_order_seq_cst) volatile
...
//! Implementation for user-defined types, such as structs and enums
    ...
    public:
        ...
        BOOST_NOEXCEPT : m_storage(atomics::detail::memcpy_cast<storage_type>(v)) {
        }
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::memcpy_cast<value_type>(
                    operations::exchange(m_storage, atomics::detail::memcpy_cast<storage_type>(v), order));
        }
        ...
        BOOST_NOEXCEPT {
            ...
            const bool res = operations::compare_exchange_strong(m_storage, old_value,
                                                                 atomics::detail::memcpy_cast<storage_type>(desired),
...
//! Implementation for pointers
    ...
    public:
        ...
        BOOST_NOEXCEPT : m_storage(atomics::detail::union_cast<storage_type>(v)) {
        }
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::union_cast<value_type>(
                    operations::fetch_add(m_storage, static_cast< storage_type >(v * sizeof(T)), order));
        }
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::union_cast<value_type>(
                    operations::fetch_sub(m_storage, static_cast< storage_type >(v * sizeof(T)), order));
        }
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::union_cast<value_type>(
                    operations::exchange(m_storage, atomics::detail::union_cast<storage_type>(v), order));
        }
        ...
        BOOST_NOEXCEPT {
            ...
            const bool res = operations::compare_exchange_strong(m_storage, old_value,
                                                                 atomics::detail::union_cast<storage_type>(desired),
                                                                 success_order, failure_order);
...
//! Implementation for void pointers
    ...
    public:
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::union_cast<value_type>(
                    operations::fetch_add(m_storage, static_cast< storage_type >(v), order));
        }
        ...
        volatile BOOST_NOEXCEPT {
            return atomics::detail::union_cast<value_type>(
                    operations::fetch_sub(m_storage, static_cast< storage_type >(v), order));
        }
...
public:
    ...
    BOOST_NOEXCEPT { return this->m_storage; }
