...
namespace boost {
    ...
    namespace detail {
        ...
        private:
            struct match_continuation {
                enum {
                    pos_G2_vertex_loop, pos_fi_adj_loop, pos_dfs_num
                } position;
                        ...
                        while (fi_adj.first != fi_adj.second) {
                            {
                                ...
                                if (invariant2(v) == invariant1(j) && in_S[v] == false) {
                                    ...
                                    BOOST_USING_STD_MAX();
                                    int next_k = max
                                    BOOST_PREVENT_MACRO_SUBSTITUTION(dfs_num_k, max
                                    BOOST_PREVENT_MACRO_SUBSTITUTION(dfs_num[i], dfs_num[j]));
                                    match_continuation new_k;
    ...
    namespace graph {
        namespace detail {
            ...
            struct isomorphism_impl {
                ...
                bool operator()(const Graph1 &g1, const Graph2 &g2, const ArgPack &arg_pack) const {
                    ...
                    index1_map_type index1_map = boost::detail::override_const_property(arg_pack, _vertex_index1_map,
                                                                                        g1, boost::vertex_index);
                    index2_map_type index2_map = boost::detail::override_const_property(arg_pack, _vertex_index2_map,
                                                                                        g2, boost::vertex_index);
                    typedef typename graph_traits<Graph2>::vertex_descriptor vertex2_t;
                    typename std::vector<vertex2_t>::size_type n = (typename std::vector<vertex2_t>::size_type) num_vertices(
                            g1);
                    ...
                    typename boost::parameter::lazy_binding<
                            ...
                            arg_pack[_vertex_invariant1 ||
                                     boost::detail::make_degree_invariant<Graph1, index1_map_type>(g1, index1_map)];
                    typename boost::parameter::lazy_binding<
                            ArgPack,
                            ...
                            arg_pack[_vertex_invariant2 ||
                                     boost::detail::make_degree_invariant<Graph2, index2_map_type>(g2, index2_map)];
        ...
        BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(isomorphism,
        2, 6)
    }

    // Named parameter interface
    BOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(isomorphism,
    2)
