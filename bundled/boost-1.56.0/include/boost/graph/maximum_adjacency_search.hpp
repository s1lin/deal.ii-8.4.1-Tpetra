...
namespace boost {
    ...
    maximum_adjacency_search(const Graph &g, WeightMap weights, MASVisitor vis,
        ...
        BOOST_CONCEPT_ASSERT(
                (boost::Convertible<typename boost::graph_traits<Graph>::directed_category, boost::undirected_tag>));
        ...
        BOOST_CONCEPT_ASSERT(
                (boost::Convertible<vertex_descriptor, typename boost::property_traits<VertexAssignmentMap>::value_type>));
        ...
        namespace detail {
            ...
            struct mas_dispatch {
                ...
                static result_type apply(const Graph &g,
                    ...
                    default_pq_gen_type pq_gen(choose_param(get_param(params, boost::distance_zero_t()), weight_type(
                            0)));

                    typename boost::result_of<default_pq_gen_type(const Graph &, const ArgPack &)>::type pq = pq_gen(g,
                                                                                                                     params);
                    ...
                    boost::maximum_adjacency_search
                            (g,
                             ...
                             params[_vertex_assignment_map |
                                    boost::detail::make_property_map_from_arg_pack_gen<boost::graph::keywords::tag::vertex_assignment_map, vertex_descriptor>(
                                            vertex_descriptor())(g, params)],
                             pq
                            );
                }
            };
    ...
    namespace graph {
        ...
        BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(maximum_adjacency_search,
        1,5)
    } // end namespace graph
