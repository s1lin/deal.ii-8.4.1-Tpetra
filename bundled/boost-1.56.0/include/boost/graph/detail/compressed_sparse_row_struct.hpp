...
namespace boost {
    ...
    namespace detail {
        ...
        public: // GCC 4.2.1 doesn't like the private-and-friend thing
            ...
            bool equal(const csr_out_edge_iterator &other) const { return m_edge == other.m_edge; }
        ...
        make_edge_to_index_pair_iter(const GraphT &g, const VertexIndexMap &index,
                                     Iter it) {
            return boost::transform_iterator<edge_to_index_pair<GraphT, VertexIndexMap>, Iter>(it,
                                                                                               edge_to_index_pair<GraphT, VertexIndexMap>(
                                                                                                       g, index));
        }
