...
namespace boost {
    ...
    measure_influence(const Graph &) { return influence_measure<Graph>(); }
    ...
    measure_prestige(const Graph &) { return prestige_measure<Graph>(); }
...
// These are alias functions, intended to provide a more expressive interface.
    ...
    template<typename Graph, typename Vertex>
    inline typename graph_traits<Graph>::degree_size_type
    influence(const Graph &g, Vertex v) { return degree_centrality(g, v, measure_influence(g)); }


    template<typename Graph, typename Vertex>
    inline typename graph_traits<Graph>::degree_size_type
    prestige(const Graph &g, Vertex v) { return degree_centrality(g, v, measure_prestige(g)); }
