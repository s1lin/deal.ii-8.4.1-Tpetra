...
namespace boost {
    ...
    namespace detail {
        ...
        template<bool IsCallable>
        struct do_call_finish_edge {
        ...
        template<>
        struct do_call_finish_edge<false> {
            template<typename E, typename G, typename Vis>
...
// comparison.
        ...
        void depth_first_visit_impl
            ...
            if (func(u, g)) {
                ...
                stack.push_back(
                        std::make_pair(u, std::make_pair(boost::optional<Edge>(), std::make_pair(ei_end, ei_end))));
            } else {
    ...
    namespace graph {
        ...
        BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(depth_first_search,
        1, 4)
    }

    BOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(depth_first_search,
    1)
