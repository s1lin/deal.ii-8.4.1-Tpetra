...
namespace boost {
    ...
    struct mcr_float {
        ...
        static Float infinity() { return std::numeric_limits<value_type>::infinity(); }
    ...
    namespace detail {
        ...
        struct float_wrapper {
            ...
            static value_type infinity() { return FloatTraits::infinity() * ComparatorProps::multiplier; }

            static value_type epsilon() { return FloatTraits::epsilon() * ComparatorProps::multiplier; }
        ...
        private:
            ...
            float_t mcr_bound() {
                ...
                for (boost::tie(vi, vie) = vertices(m_g);
                vi != vie;
                ++vi)
                {
      ...
      * \brief Finds optimum cycle raio and a critical cycle
        ...
        public:
            ...
            void get_critical_cycle(typename inhr_t::critical_cycle_t &cc) { return cc.swap(m_cc); }

        protected:
            void store_critical_edge(typename inhr_t::edge_t ed,
                                     typename inhr_t::critical_cycle_t &cc) { cc.push_back(ed); }

            void store_critical_cycle(typename inhr_t::critical_cycle_t &cc) { m_cc.swap(cc); }
