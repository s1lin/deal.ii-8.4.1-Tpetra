...
namespace boost {
    ...
    get(get_owner_of_first_tuple_element<OwnerMap, Tuple> o, Tuple t) { return o.get_owner(t); }
    ...
    get(get_owner_of_first_pair_element<OwnerMap> o, std::pair<Vertex, T> p) { return o.get_owner(p); }
            ...
            namespace detail {
...
#endif
                          delta(delta),
                          pg(boost::graph::parallel::process_group_adl(g),
                             boost::parallel::attach_distributed_object()),
                          owner(get(vertex_owner, g)),
                          local(get(vertex_local, g)) { setup_triggers(); }
                ...
                private:
                    ...
                    set_delta(const Graph &g) {
                        ...
                        {
                            max_degree = max
                            BOOST_PREVENT_MACRO_SUBSTITUTION(max_degree, out_degree(u, g));
                            BGL_FORALL_OUTEDGES_T(u, e, g, Graph)
                            max_edge_weight = max
                            BOOST_PREVENT_MACRO_SUBSTITUTION(max_edge_weight, get(weight, e));
                        }
