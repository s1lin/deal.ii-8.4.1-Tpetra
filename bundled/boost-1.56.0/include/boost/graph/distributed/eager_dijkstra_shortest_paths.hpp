...
// Borrowed from BGL's dijkstra_shortest_paths
                ...
                struct parallel_dijkstra_bfs_visitor : bfs_visitor<> {
                    ...
                    void initialize_vertex(Vertex u, Graph &g) { m_vis.initialize_vertex(u, g); }
                ...
                private:
                    vertex_descriptor predecessor_value(vertex_descriptor v) const { return v; }

                    vertex_descriptor
                    predecessor_value(
                            property_traits<dummy_property_map>::reference) const { return graph_traits<Graph>::null_vertex(); }
