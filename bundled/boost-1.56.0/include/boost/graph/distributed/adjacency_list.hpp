...
namespace boost {
     ...
     */
       ...
       */
                struct generator {
                    ...
                    result_type operator()(argument_type v) const { return result_type(owner, v); }
            ...
            template<typename LocalDescriptor>
            inline processor_id_type owner(const global_descriptor<LocalDescriptor> &v) { return v.owner; }

            /// Determine the local portion of the given descriptor
            template<typename LocalDescriptor>
            inline LocalDescriptor local(const global_descriptor<LocalDescriptor> &v) { return v.local; }
            ...
            inline bool
            operator!=(const global_descriptor<LocalDescriptor> &u,
                       const global_descriptor<LocalDescriptor> &v) { return !(u == v); }
     ...
     */
       ...
       */
                ...
                public:
                    ...
                    result_type operator()(argument_type e) const { return map(e, directed_selector()); }
       ...
       */
                ...
                public:
                    ...
                    result_type operator()(argument_type e) const { return map(e, DirectedS()); }
         ...
         */
            ...
            template<typename Edge>
            inline Edge
            local(const edge_descriptor<Edge> &e) { return e.local; }
     ...
     */
            ...
            inline bool
            operator!=(const edge_descriptor<Edge> &e1,
                       const edge_descriptor<Edge> &e2) { return !(e1 == e2); }
     ...
     */
            ...
            remove_in_edge(typename Graph::edge_descriptor e, Graph &g, undirectedS) {
                ...
                for (boost::tie(ei, ei_end) = out_edges(v.local, bg);
                ei != ei_end;
                ++ei)
                {
...
m_local_graph(distribution
.
block_size(process_id(pg), n
), p),
process_group_(pg, boost::parallel::attach_distributed_object()
)
{
...
initialize(first, last, n,
this->

distribution(), vertex_list_selector()
...
typedef typename config_type::VertexListS vertex_list_selector;
initialize(first, last, ep_iter, n,
this->
...
void clear_in_edges_local(vertex_descriptor v, bidirectionalS) { get(vertex_in_edges, base())[v.local].clear(); }
...
// the user.
base_vertex_property_type
build_vertex_property(const vertex_property_type &p) { return build_vertex_property(p, directed_selector()); }
...
lazy_add_vertex_with_property(adjacency_list
& self,
...
send_oob_with_reply(self
.process_group_, owner,
...
lazy_add_edge(adjacency_list
& self,
vertex_descriptor source, vertex_descriptor
target)
:
...
add_local_edge(edge_property_type(), DirectedS()
...
add_local_edge(
const edge_property_type &property, directedS
) const
{
...
put(edge_target_processor_id, self
.
...
return
std::pair<edge_descriptor, bool>(e, inserted
.second);
}
...
PBGL_DISTRIB_ADJLIST_TYPE::lazy_add_edge::
add_local_edge(
const edge_property_type &property, bidirectionalS
) const
{
...
// has been added.
if (self.process_group_.

trigger_context()

== boost::parallel::trc_out_of_band)
send_oob(self
.process_group_, target.owner, msg_nonlocal_edge,
msg_nonlocal_edge_data(result
.first.local, property));
else
send(self
.process_group_, target.owner, msg_nonlocal_edge,
msg_nonlocal_edge_data(result
...
PBGL_DISTRIB_ADJLIST_TYPE::lazy_add_edge::
add_local_edge(
const edge_property_type &property, undirectedS
) const
{
// Add the directed edge
std::pair<edge_descriptor, bool> result
...
{
/// Construct a lazy request to add an edge
lazy_add_edge_with_property(adjacency_list
& self,
vertex_descriptor source,
        vertex_descriptor
target,
...
:
lazy_add_edge(self, source, target
),
property(property) {}
...
if (this->source.owner == this->self.
...
// Add a local edge
return this->
add_local_edge(property, DirectedS()
);
else {
// Request that the remote processor add an edge
boost::parallel::detail::untracked_pair<edge_descriptor, bool> result;
...
return
std::make_pair(make_transform_iterator(vertices(g.base()).first,
...
out_edges(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor v,
const PBGL_DISTRIB_ADJLIST_TYPE& g)
{
BOOST_ASSERT(v
...
typedef PBGL_DISTRIB_ADJLIST_TYPE
impl;
...
::degree_size_type
out_degree(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor v,
const PBGL_DISTRIB_ADJLIST_TYPE& g)
{
BOOST_ASSERT(v
...
typedef PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)
impl;
...
return
std::make_pair(make_transform_iterator(in_edges[v.local].begin(),
                                       generator(g)),
...
typedef PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)
impl;
typedef typename impl::in_edge_generator generator;
...
return
std::make_pair(make_transform_iterator(edges(g.base()).first,
                                       generator(g)),
...
::vertex_descriptor
vertex(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertices_size_type n,
const PBGL_DISTRIB_ADJLIST_TYPE& g)
{
typedef typename PBGL_DISTRIB_ADJLIST_TYPE
...
edge(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)
::vertex_descriptor u,
...
edge(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor u,
typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor v,
const PBGL_DISTRIB_ADJLIST_TYPE& g)
...
adjacent_vertices(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor v,
const PBGL_DISTRIB_ADJLIST_TYPE& g)
{
typedef typename PBGL_DISTRIB_ADJLIST_TYPE
...
return
std::make_pair(iter(out_edges(v, g).first, &g),
...
::lazy_add_edge
add_edge(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor u,
typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor v,
...
return
lazy_add_edge_with_property(g, u, v, p
);
}
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
void
remove_edge(typename PBGL_DISTRIB_ADJLIST_TYPE
::edge_descriptor e,
PBGL_DISTRIB_ADJLIST_TYPE& g)
{
BOOST_ASSERT(source(e, g)
.owner == g.
...
g.
remove_local_edge_from_list(source(e, g), target(e, g), DirectedS()
);
...
graph_detail::erase_if(get(vertex_in_edges, g.base())
[u.local],
Pred(g, predicate
));
}
...
PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)& g)
{
typedef PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)
Graph;
typedef parallel::detail::remove_directed_edge_predicate<Graph,
        Predicate> Pred;
remove_edge_if(Pred(g, predicate), g
.
...
typedef parallel::detail::remove_undirected_edge_predicate<Graph,
        Predicate> Pred;
graph_detail::erase_if(g
.

local_edges(), Pred(g, predicate)
...
::lazy_add_vertex_with_property
add_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
void
remove_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE
::vertex_descriptor u,
PBGL_DISTRIB_ADJLIST_TYPE& g)
{
typedef typename PBGL_DISTRIB_ADJLIST_TYPE
...
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, Property>
...
process_group(), get(global_map_t(), g),
        get(p, g.base()), reduce()
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, vertex_local_index_t>
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, vertex_global_t>
...
/// owner.
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, vertex_owner_t>
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, vertex_local_t>
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
inline typename PBGL_DISTRIB_ADJLIST_TYPE
::local_vertex_descriptor
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, edge_global_t>
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, edge_owner_t>
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, edge_local_t>
...
void
put(Property p, PBGL_DISTRIB_ADJLIST_TYPE& g,
const Key &key,
const Value &v
)
{
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, vertex_index_t>
...
process_group(), get(vertex_global, g),
        get(vi, g.base())
...
template<PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS, typename T, typename Bundle>
typename property_map<PBGL_DISTRIB_ADJLIST_TYPE, T Bundle::*>
