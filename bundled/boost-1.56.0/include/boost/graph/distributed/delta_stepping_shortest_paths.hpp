    ...
    namespace graph {
        namespace distributed {
            ...
            private:
                ...
                void handle_relax_message(Vertex v, const std::pair<Dist, Vertex> &p) { relax(p.second, v, p.first); }
                ...
                void handle_msg_relax(int /*source*/, int /*tag*/,
                                      ...
                                      trigger_receive_context) { handle_relax_message(data.first, data.second); }
