...
// Tag class for a distributed CSR graph
    ...
    compressed_sparse_row_graph(vertices_size_type
    numverts,
    const ProcessGroup &pg = ProcessGroup()
    )
    :
...
inline typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor
BOOST_DISTRIB_CSR_GRAPH_TYPE::null_vertex()
{
return

graph_traits<base_type>::null_vertex();
...
::vertex_descriptor
source(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edge_descriptor e,
...
::vertex_descriptor
target(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edge_descriptor e,
...
out_edges(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor u,
const BOOST_DISTRIB_CSR_GRAPH_TYPE &g
)
{
typedef typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edges_size_type
        edges_size_type;
typedef typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edge_descriptor ed;
...
return
std::make_pair(it(ed(u, u_row_start)),
...
::degree_size_type
out_degree(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor u,
const BOOST_DISTRIB_CSR_GRAPH_TYPE &g
)
{
return
out_degree(get(vertex_local, g, u), g
.
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
ProcessGroup
process_group(const BOOST_DISTRIB_CSR_GRAPH_TYPE &g) { return g.process_group(); }
...
adjacent_vertices(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor u,
const BOOST_DISTRIB_CSR_GRAPH_TYPE &g
)
{
return
adjacent_vertices(get(vertex_local, g, u), g
.
...
explicit vertex_iterator(Vertex
v,
...
::vertex_iterator
        vertex_iterator;
return
std::make_pair(vertex_iterator(0, &g),
...
::edge_iterator ei;
typedef typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edge_descriptor edgedesc;
if (g.

base()

.m_forward.m_rowstart.
...
.m_forward.m_rowstart[src + 1] == 0) ++
src;
return
std::make_pair(ei(g, edgedesc(src, 0), g.base().m_forward.m_rowstart[src + 1]),
...
struct local_vertex {
    ...
    bool operator()(Vertex x) { return get(owner, x) == id; }

    template<typename Vertex>
    bool operator()(Vertex x) const { return get(owner, x) == id; }
...
struct local_edge {
    ...
    template<typename Vertex>
    bool operator()(std::pair <Vertex, Vertex> &x) { return get(owner, x.first) == id; }

    template<typename Vertex>
    bool operator()(const std::pair <Vertex, Vertex> &x) const { return get(owner, x.first) == id; }
...
public:
    ...
    bool operator==(const index_to_vertex_iterator &other) const { return index == other.index; }

    bool operator!=(const index_to_vertex_iterator &other) const { return !(*this == other); }
...
m_process_group(pg),
        ...
        m_base(edges_are_unsorted_global,
               index_to_vertex_iterator<InputIterator, BOOST_DISTRIB_CSR_GRAPH_TYPE
>(edge_begin, *this),
index_to_vertex_iterator<InputIterator, BOOST_DISTRIB_CSR_GRAPH_TYPE>(edge_end, *this),
m_distribution.

block_size(process_id(m_process_group), numverts
...
vertices_size_type numverts,
        edges_size_type
numedges, // This is not used as there is no appropriate BGL ctor
const ProcessGroup &pg,
const GraphProperty &prop
)
:
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
...
std::pair<typename ProcessGroup::process_id_type,
        typename BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor>
get(vertex_global_t, BOOST_DISTRIB_CSR_GRAPH_TYPE& g,
typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor k
)
{
return
...
::vertex_descriptor
vertex(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertices_size_type i,
const BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
return g.
make_vertex_descriptor(g
.
...
edge_range(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor i,
typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor j,
const BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
typedef typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::out_edge_iterator out_edge_iter;
typedef typename BOOST_DISTRIB_CSR_GRAPH_TYPE
...
return
std::make_pair(out_edge_iter(edge_desc(i, idx_begin)),
...
edge(typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor i,
typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::vertex_descriptor j,
const BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
std::make_pair(typename BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor(),
false);
else
return
std::make_pair(*range
...
class property_map<const BOOST_DISTRIB_CSR_GRAPH_TYPE
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
...
typedef property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
local;
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>
...
public:
    ...
    typedef std::pair<ProcessID, detail::csr_edge_descriptor < Vertex, EdgeIndex> >
    value_type;
    typedef value_type reference;
    typedef readable_property_map_tag category;
};
...
get(csr_edge_global_map<ProcessID, Vertex, EdgeIndex>
pm,
...
detail::csr_edge_descriptor<Vertex, EdgeIndex>(k
.
src &local_index_mask, k
.idx));
}
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
...
const int local_index_bits =
        sizeof(vertex_descriptor) * CHAR_BIT - processor_bits;
const typename BOOST_DISTRIB_CSR_GRAPH_TYPE
::edges_size_type local_index_mask =
        typename BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type(-1) >>
processor_bits;
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
...
::edges_size_type
        get(edge_index_t, BOOST_DISTRIB_CSR_GRAPH_TYPE &g,
            typename BOOST_DISTRIB_CSR_GRAPH_TYPE ::edge_descriptor
k)
{
return k.
idx;
...
process_group(), get(edge_global, g),
        get(edge_index, g.base())
...
, Tag> {
typedef BOOST_DISTRIB_CSR_GRAPH_TYPE
graph_type;
...
typedef typename mpl::if_<is_same < typename detail::property_kind_from_graph<base_graph_type, Tag>::type,
        vertex_property_tag>,
vertex_global_map, edge_global_map>
::type
        global_map;
...
template<BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, Tag>
