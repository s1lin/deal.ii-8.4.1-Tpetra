            ...
            namespace detail {
                ...
                struct smaller_weighted_edge {
                    ...
                    operator()(const std::pair<Edge, Weight> &x,
                               const std::pair<Edge, Weight> &y) const { return x.second < y.second ? x : y; }
                };
                ...
                has_same_supervertex(DisjointSets &dset,
                                     const Graph &g) { return do_has_same_supervertex<DisjointSets, Graph>(dset, g); }
                ...
                struct supervertex_edge_descriptor {
                    ...
                    friend inline bool operator==(const self_type &x, const self_type &y) { return x.e == y.e; }
                ...
                source(supervertex_edge_descriptor<Graph> se, const Graph &) { return se.source; }

                template<typename Graph>
                inline typename supervertex_edge_descriptor<Graph>::Vertex
                target(supervertex_edge_descriptor<Graph> se, const Graph &) { return se.target; }
