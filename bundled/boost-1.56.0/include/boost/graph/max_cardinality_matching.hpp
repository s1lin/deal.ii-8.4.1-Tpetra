...
namespace boost {
    ...
    struct extra_greedy_matching {
        ...
        struct select_first {
            inline static vertex_descriptor_t select_vertex(const vertex_pair_t p) { return p.first; }
        };

        struct select_second {
            inline static vertex_descriptor_t select_vertex(const vertex_pair_t p) { return p.second; }
        };
        ...
        static void find_matching(const Graph &g, MateMap mate) {
            ...
            for (typename directed_edges_vector_t::const_iterator itr = edge_list.begin();
    ...
    struct no_matching_verifier {
        inline static bool
        verify_matching(const Graph &, MateMap, VertexIndexMap) { return true; }
    };
