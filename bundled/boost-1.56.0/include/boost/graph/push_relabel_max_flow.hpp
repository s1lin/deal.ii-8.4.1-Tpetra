    ...
    namespace detail {
        ...
        public:
            ...
            void add_to_active_list(vertex_descriptor u, Layer &layer) {
                ...
                max_active = max
                BOOST_PREVENT_MACRO_SUBSTITUTION(get(distance, u), max_active);
                min_active = min
                BOOST_PREVENT_MACRO_SUBSTITUTION(get(distance, u), min_active);
            ...
            push_relabel(Graph &g_,
                ...
                u_iter != u_end;
                ++u_iter)
                for (boost::tie(ei, e_end) = out_edges(*u_iter, g);
                ei != e_end;
                ++ei) {
            ...
            void global_distance_update() {
                ...
                while (!Q.empty()) {
                    ...
                    for (boost::tie(ai, a_end) = out_edges(u, g);
                    ai != a_end;
                    ++ai) {
                        ...
                        if (get(color, v) == ColorTraits::white()
                            ...
                            max_distance = max
                            BOOST_PREVENT_MACRO_SUBSTITUTION(d_v, max_distance);
            ...
            void discharge(vertex_descriptor u) {
                ...
                while (1) {
                    ...
                    for (boost::tie(ai, ai_end) = current[u];
                    ai != ai_end;
                    ++ai) {
                        edge_descriptor a = *ai;
            ...
            void push_flow(edge_descriptor u_v) {
                ...
                flow_delta
                        = min
                BOOST_PREVENT_MACRO_SUBSTITUTION(get(excess_flow, u), get(residual_capacity, u_v));
            ...
            distance_size_type relabel_distance(vertex_descriptor u) {
                ...
                if (min_distance < n) {
                    ...
                    max_distance = max
                    BOOST_PREVENT_MACRO_SUBSTITUTION(min_distance, max_distance);
                }
                return min_distance;
            } // relabel_distance()
            ...
            void convert_preflow_to_flow() {
                ...
                u_iter != u_end;
                ++u_iter)
                for (boost::tie(ai, a_end) = out_edges(*u_iter, g);
                ai != a_end;
                ++ai)
                                    ...
                                    if (get(color, v) == ColorTraits::white()) {
                                        ...
                                        while (1) {
                                            ...
                                            BOOST_PREVENT_MACRO_SUBSTITUTION(delta,
                                                                             get(residual_capacity, *current[v].first));
                                            if (v == u)
                                                break;
                                            else
