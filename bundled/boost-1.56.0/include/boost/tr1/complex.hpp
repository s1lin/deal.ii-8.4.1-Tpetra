...
namespace std {
    ...
    template<class T>
    inline BOOST_TR1_MATH_RETURN(double)
...
#ifndef BOOST_NO_FUNCTION_TEMPLATE_ORDERING
    template<class T>
    inline BOOST_TR1_MATH_RETURN(std::complex<double>)
    ...
    pow(const complex<T> &x, const complex<U> &y) {
        ...
        typedef typename boost::mpl::if_<boost::is_same < result_type, complex<T> >, result_type const&, result_type >
                                                                                                         ::type
        cast1_type;
        typedef typename boost::mpl::if_<boost::is_same < result_type, complex<U> >, result_type const&, result_type >
                                                                                                         ::type
        cast2_type;
        cast1_type x1(x);
        cast2_type y1(y);
