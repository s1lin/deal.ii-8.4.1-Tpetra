 ...
 */
        ...
        public:
            ...
            BOOST_STATIC_ASSERT(total_block
            >= returned_block);
            ...
            BOOST_PREVENT_MACRO_SUBSTITUTION() { return (base_type::min)(); }
            ...
            BOOST_PREVENT_MACRO_SUBSTITUTION() { return (base_type::max)(); }
...
/// \cond \show_deprecated
        ...
        public:
            ...
            BOOST_PREVENT_MACRO_SUBSTITUTION() { return (this->base().min)(); }

            result_type max

            BOOST_PREVENT_MACRO_SUBSTITUTION() { return (this->base().max)(); }
        };
