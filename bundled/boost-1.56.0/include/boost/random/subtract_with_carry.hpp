 ...
 */
        ...
        public:
            ...
            BOOST_PREVENT_MACRO_SUBSTITUTION() { return boost::low_bits_mask_t<w>::sig_bits; }
 ...
 */
        ...
        public:
            ...
            BOOST_PREVENT_MACRO_SUBSTITUTION() { return result_type(0); }

            /** Returns the largest value that the generator can produce. */
            static result_type max

            BOOST_PREVENT_MACRO_SUBSTITUTION() { return result_type(1); }
