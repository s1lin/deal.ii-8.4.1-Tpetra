...
BOOST_PREDEF_DECLARE_TEST(BOOST_LANG_STDCPP,
BOOST_LANG_STDCPP_NAME)
...
BOOST_PREDEF_DECLARE_TEST(BOOST_LANG_STDCPPCLI,
BOOST_LANG_STDCPPCLI_NAME)
...
BOOST_PREDEF_DECLARE_TEST(BOOST_LANG_STDECPP,
