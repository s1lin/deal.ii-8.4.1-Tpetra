...
namespace boost {
    namespace unordered {
        namespace detail {
            ...
            struct rebind_wrap {
                typedef typename Alloc::BOOST_NESTED_TEMPLATE rebind
                <T>::other
                type;
            };
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
    ...
    static typename boost::enable_if_c<
            ...
            ::value>::type
    construct(Alloc &a, T *p, BOOST_FWD_REF(Args)...
    ...
    static typename boost::disable_if_c<
            boost::unordered::detail::has_construct<Alloc, T, Args...>
            ::value>::type
    construct(Alloc &, T *p, BOOST_FWD_REF(Args)...
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
        ...
        inline typename enable_if<use_piecewise < A0>, void>
