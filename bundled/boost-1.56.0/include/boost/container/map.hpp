...
namespace boost {
        ...
        class map
            ///@cond
                : public container_detail::tree
                        <Key, std::pair<const Key, T>, container_detail::select1st < std::pair<const Key, T> >,
                  Compare,
                  Allocator,
                  MapOptions
        ...
        ///@endcond
    {
        ...
        typedef typename BOOST_CONTAINER_IMPDEF(base_t
        ...
        typedef BOOST_CONTAINER_IMPDEF(movable_value_type_impl)
        movable_value_type;
        ...
        map()
            ...
            BOOST_STATIC_ASSERT(
                    (container_detail::is_same<std::pair<const Key, T>, typename Allocator::value_type>::value));
        }
    ...
    template<class InputIterator>
    map( ordered_unique_range_t, InputIterator
    first,
    InputIterator last
    ,
    const Compare &comp = Compare(),
...
std::pair<iterator, bool> insert(const value_type &x) { return this->base_t::insert_unique(x); }
...
//!
//! <b>Complexity</b>: Logarithmic.
std::pair<iterator, bool> insert(const nonconst_value_type &x) { return this->base_t::insert_unique(x); }
...
base_t::insert_unique (boost::move(x));
...
iterator insert(const_iterator position, const value_type &x) { return this->base_t::insert_unique(position, x); }
...
template<class InputIterator>
void insert(InputIterator first, InputIterator last) { this->base_t::insert_unique(first, last); }
...
//!
//! <b>Complexity</b>: log(size())+count(k)
size_type count(const key_type &x) const { return static_cast<size_type>(this->find(x) != this->cend()); }
...
mapped_type &priv_subscript(BOOST_RV_REF(key_type)
mk)
{
key_type &k = mk;
//we can optimize this
...
x)
{
return static_cast<multimap&>(this->
...
//!
//! <b>Complexity</b>: Logarithmic.
iterator insert(const value_type &x) { return this->base_t::insert_equal(x); }

//! <b>Effects</b>: Inserts a new value constructed from x and returns
//!   the iterator pointing to the newly inserted element.
//!
//! <b>Complexity</b>: Logarithmic.
iterator insert(const nonconst_value_type &x) { return this->base_t::insert_equal(x); }
...
base_t::insert_equal (boost::move(x));
...
//!
//! <b>Complexity</b>: Logarithmic.
iterator insert(BOOST_RV_REF(movable_value_type)
x)
{
return this->
...
//! <b>Complexity</b>: Logarithmic in general, but amortized constant if t
//!   is inserted right before p.
iterator insert(const_iterator position, const value_type &x) { return this->base_t::insert_equal(position, x); }
...
//! <b>Complexity</b>: At most N log(size()+N) (N is the distance from first to last)
template<class InputIterator>
void insert(InputIterator first, InputIterator last) { this->base_t::insert_equal(first, last); }
