    ...
    namespace container {
        ...
        namespace stable_vector_detail {
            ...
            struct index_traits {
                ...
                static node_base_ptr_ptr
                ptr_to_node_base_ptr(node_base_ptr &n) { return node_base_ptr_ptr_traits::pointer_to(n); }
                ...
                static index_iterator get_fix_up_end(index_type &index) { return index.end() - (ExtraPointers - 1); }
                ...
                static void initialize_end_node(index_type &index, node_base_type &end_node,
                                                const size_type index_capacity_if_empty) {
                    if (index.empty()) {
        ...
        public:
            ...
            typedef typename ::boost::container::container_detail::if_c
                    <IsConst, typename non_const_ptr_traits::template
        ...
        public:
            ...
            explicit stable_vector_iterator(node_base_ptr p)
            ...
            stable_vector_iterator(stable_vector_iterator<Pointer, false> const &other)

            BOOST_CONTAINER_NOEXCEPT
                    :  m_pn(other.node_pointer()) {}

            node_ptr node_pointer() const

            BOOST_CONTAINER_NOEXCEPT { return node_ptr_traits::static_cast_from(m_pn); }

        public:
            //Pointer like operators
            reference operator*() const

            BOOST_CONTAINER_NOEXCEPT { return node_pointer()->value; }

            pointer operator->() const

            BOOST_CONTAINER_NOEXCEPT { return ptr_traits::pointer_to(this->operator*()); }
            ...
            BOOST_CONTAINER_NOEXCEPT {
                ...
                ++*this;
                return stable_vector_iterator(tmp);
            }
            ...
            BOOST_CONTAINER_NOEXCEPT { return node_ptr_traits::static_cast_from(this->m_pn->up[off])->value; }
            ...
            friend stable_vector_iterator operator+(const stable_vector_iterator &left, difference_type off)
            ...
            friend stable_vector_iterator operator+(difference_type off, const stable_vector_iterator &right)
            ...
            friend difference_type operator-(const stable_vector_iterator &left, const stable_vector_iterator &right)

            BOOST_CONTAINER_NOEXCEPT { return left.m_pn->up - right.m_pn->up; }

            //Comparison operators
            friend bool operator==(const stable_vector_iterator &l, const stable_vector_iterator &r)

            BOOST_CONTAINER_NOEXCEPT { return l.m_pn == r.m_pn; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return l.m_pn->up < r.m_pn->up; }
...
//! \tparam Allocator The allocator used for all internal memory management
        ...
        class stable_vector {
            ...
            node_ptr allocate_one() { return allocator_version_traits_t::allocate_one(this->priv_node_alloc()); }
            ...
            typedef stable_vector_iterator
                    <typename allocator_traits<Allocator>::pointer, false> iterator_impl;
            typedef stable_vector_iterator
                    <typename allocator_traits<Allocator>::pointer, false> const_iterator_impl;
#endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
        public:
        ...
        public:
            ...
            stable_vector &operator=(BOOST_COPY_ASSIGN_REF(stable_vector) x) {
                ...
                if (&x != this) {
                    ...
                    container_detail::assign_alloc(this->index.get_stored_allocator(), x.index.get_stored_allocator(),
                                                   flag);
            ...
            //!
            //! <b>Complexity</b>: Constant.
            allocator_type get_allocator() const { return this->priv_node_alloc(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->priv_node_alloc(); }
            ...
            BOOST_CONTAINER_NOEXCEPT {
                return (this->index.empty()) ? this->end() : iterator(
                        node_ptr_traits::static_cast_from(this->index.front()));
            }
            ...
            BOOST_CONTAINER_NOEXCEPT {
                return (this->index.empty()) ? this->cend() : const_iterator(
                        node_ptr_traits::static_cast_from(this->index.front()));
            }
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->priv_get_end_node()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_iterator(this->priv_get_end_node()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->begin(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->end(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->rbegin(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->rend(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->index.size() <= ExtraPointers; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->index.max_size() - ExtraPointers; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return static_cast<node_reference>(*this->index.front()).value; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return static_cast<const_node_reference>(*this->index.front()).value; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return static_cast<node_reference>(*this->index[this->size() - 1u]).value; }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            iterator insert(const_iterator position, FwdIt first, FwdIt last, typename container_detail::enable_if_c
            ...
            BOOST_CONTAINER_NOEXCEPT { this->erase(--this->cend()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->erase(this->cbegin(), this->cend()); }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator!=(const stable_vector &x, const stable_vector &y) { return !(x == y); }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator>(const stable_vector &x, const stable_vector &y) { return y < x; }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            friend void swap(stable_vector &x, stable_vector &y) { x.swap(y); }
        ...
        private:
            ...
            public:
                ...
                insert_rollback(stable_vector &sv, index_iterator &it_past_constructed,
                                const index_iterator &it_past_new)
            ...
            void priv_clear_pool() {
                if (!this->index.empty() && this->index.back()) {
                    ...
                    multiallocation_chain holder;
                    holder.incorporate_after(holder.before_begin(), node_ptr_traits::static_cast_from(pool_first_ref),
                                             node_ptr_traits::static_cast_from(pool_last_ref), internal_data.pool_size);
            ...
            void priv_put_in_pool(multiallocation_chain &ch) {
                ...
                node_base_ptr &pool_last_ref = this->index.back();
                ch.incorporate_after(ch.before_begin(), node_ptr_traits::static_cast_from(pool_first_ref),
                                     node_ptr_traits::static_cast_from(pool_last_ref), internal_data.pool_size);
            ...
            void priv_build_node_from_it(const node_ptr &p, const index_iterator &up_index, const Iterator &it) {
                ...
                boost::container::construct_in_place
                        (this->priv_node_alloc(), container_detail::addressof(p->value), it);
                //This does not throw
            ...
            void
            priv_build_node_from_convertible(const node_ptr &p, BOOST_FWD_REF(ValueConvertible) value_convertible) {
                //This can throw
                boost::container::allocator_traits<node_allocator_type>::construct
                        (this->priv_node_alloc(), container_detail::addressof(p->value),
            ...
            public:
                ...
                explicit ebo_holder (BOOST_FWD_REF(AllocatorRLValue)
