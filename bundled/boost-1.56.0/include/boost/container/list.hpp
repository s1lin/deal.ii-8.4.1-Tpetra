        ...
        namespace container_detail {
            ...
            struct intrusive_list_type {
                ...
                typedef typename container_detail::bi::make_list
                        <node_type, container_detail::bi::base_hook<typename list_hook<void_pointer>::type>, container_detail::bi::constant_time_size<true>, container_detail::bi::size_type
...
//! \tparam Allocator The allocator used for all internal memory management
        ...
        class list
            ...
            struct ValueCompareToNodeCompare
                ...
                bool operator()(const Node &a) const { return static_cast<const Pred &>(*this)(a.m_data); }
            };
        ...
        public:
            ...
            explicit list(size_type n)
                    : AllocHolder(Allocator()) { this->resize(n); }
            ...
            list(size_type n, const T &value, const Allocator &a = Allocator())
                    : AllocHolder(a) { this->insert(this->cbegin(), n, value); }
            ...
            list(const list &x)
                    : AllocHolder(x) { this->insert(this->cbegin(), x.begin(), x.end()); }
            ...
            AllocHolder (boost::move(

            static_cast<AllocHolder&>(x)))
            {}
            ...
            list(const list &x, const allocator_type &a)
                    : AllocHolder(a) { this->insert(this->cbegin(), x.begin(), x.end()); }
            ...
            list(InpIt first, InpIt last, const Allocator &a = Allocator())
                    : AllocHolder(a) { this->insert(this->cbegin(), first, last); }
            ...
            BOOST_CONTAINER_NOEXCEPT {} //AllocHolder clears the list
            ...
            BOOST_CONTAINER_NOEXCEPT { return allocator_type(this->node_alloc()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->node_alloc(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->icont().begin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->cbegin(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->icont().end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(begin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_iterator(this->non_const_icont().begin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_iterator(this->non_const_icont().end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->cend()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->cbegin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->icont().size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return AllocHolder::max_size(); }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            iterator insert(const_iterator p, FwdIt first, FwdIt last, typename container_detail::enable_if_c
            ...
            BOOST_CONTAINER_NOEXCEPT { this->erase(this->cbegin()); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            void swap(list &x) { AllocHolder::swap(x); }
            ...
            BOOST_CONTAINER_NOEXCEPT { AllocHolder::clear(alloc_version()); }
            ...
            //! <b>Note</b>: Iterators of values obtained from list x now point to elements of
            //!    this list. Iterators of this list and all the references are not invalidated.
            void splice(const_iterator p, BOOST_RV_REF(list) x)

            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<list &>(x)); }
            ...
            void splice(const_iterator p, list &x, const_iterator i)
            ...
            //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
            //!   list. Iterators of this list and all the references are not invalidated.
            void splice(const_iterator p, BOOST_RV_REF(list) x, const_iterator i)

            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<list &>(x), i); }
            ...
            //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
            //!   list. Iterators of this list and all the references are not invalidated.
            void splice(const_iterator p, list &x, const_iterator first, const_iterator last)
            ...
            //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
            //!   list. Iterators of this list and all the references are not invalidated.
            void splice(const_iterator p, BOOST_RV_REF(list) x, const_iterator first, const_iterator last)

            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<list &>(x), first, last); }
            ...
            //!
            //! <b>Note</b>: Non-standard extension
            void splice(const_iterator p, list &x, const_iterator first, const_iterator last, size_type n)
            ...
            //!
            //! <b>Note</b>: Non-standard extension
            void splice(const_iterator p, BOOST_RV_REF(list) x, const_iterator first, const_iterator last, size_type n)

            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<list &>(x), first, last, n); }
            ...
            void remove(const T &value) { this->remove_if(equal_to_value(value)); }
            ...
            void merge(list &x) { this->merge(x, value_less()); }
            ...
            //! <b>Complexity</b>: This function is linear time: it performs at most
            //!   size() + x.size() - 1 comparisons.
            void merge(BOOST_RV_REF(list) x) { this->merge(static_cast<list &>(x)); }
            ...
            //! <b>Note</b>: Iterators and references to *this are not invalidated.
            template<class StrictWeakOrdering>
            void merge(BOOST_RV_REF(list) x, StrictWeakOrdering comp) { this->merge(static_cast<list &>(x), comp); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->icont().reverse(); }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator>(const list &x, const list &y) { return y < x; }
        ...
        private:
            ...
            void priv_push_back(const T &x) { this->insert(this->cend(), x); }

            void priv_push_back(BOOST_RV_REF(T) x) { this->insert(this->cend(), boost::move(x)); }

            void priv_push_front(const T &x) { this->insert(this->cbegin(), x); }

            void priv_push_front(BOOST_RV_REF(T) x) { this->insert(this->cbegin(), boost::move(x)); }
