        ...
        namespace container_detail {
            ...
            public:
                ...
                typedef typename if_c
                        <IsConst, typename boost::intrusive::pointer_traits<Pointer>::template
            ...
            public:
                ...
                BOOST_CONTAINER_NOEXCEPT { return m_ptr; }
            ...
            public:
                ...
                BOOST_CONTAINER_NOEXCEPT { return m_ptr[off]; }
                ...
                BOOST_CONTAINER_NOEXCEPT { return vec_iterator(m_ptr++); }
                ...
                BOOST_CONTAINER_NOEXCEPT { return vec_iterator(x.m_ptr + off); }
                ...
                BOOST_CONTAINER_NOEXCEPT { return left.m_ptr - right.m_ptr; }

                //Comparison operators
                friend bool operator==(const vec_iterator &l, const vec_iterator &r)

                BOOST_CONTAINER_NOEXCEPT { return l.m_ptr == r.m_ptr; }
...
namespace container_detail {
    ...
    struct vector_value_traits {
        ...
        typedef typename container_detail::if_c
                <trivial_dctr, container_detail::null_scoped_destructor_n<Allocator>, container_detail::scoped_destructor_n<Allocator>
                >::type ArrayDestructor;
        //This is the anti-exception array deallocator
        typedef typename container_detail::if_c
                <false//nothrow_copy
                        , container_detail::null_scoped_array_deallocator<Allocator>, container_detail::scoped_array_deallocator<Allocator>
...
//!This struct deallocates and allocated memory
    ...
    public:
        ...
        vector_alloc_holder(uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
                : Allocator(boost::forward<AllocConvertible>(a)), m_start(),
        ...
        void first_allocation_same_allocator_type(size_type cap) { this->first_allocation(cap); }
        ...
        size_type next_capacity(size_type additional_objects) const {
            ...
            get(allocator_traits_type::max_size(this->alloc()), this->m_capacity, additional_objects);
        }
        ...
        BOOST_CONTAINER_NOEXCEPT { return *this; }
        ...
        BOOST_CONTAINER_NOEXCEPT { return m_start; }

        const size_type &capacity() const

        BOOST_CONTAINER_NOEXCEPT { return m_capacity; }

        void start(const pointer &p)

        BOOST_CONTAINER_NOEXCEPT { m_start = p; }

        void capacity(const size_type &c)

        BOOST_CONTAINER_NOEXCEPT { m_capacity = c; }
    };
...
//!This struct deallocates and allocated memory
    ...
    public:
        ...
        template<class AllocConvertible>
        vector_alloc_holder(uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
                : Allocator(boost::forward<AllocConvertible>(a)), m_size(initial_size)  //Size is initialized here...
        {
                  ...
                  m_size(holder.m_size) //Size is initialized here so vector should only call uninitialized_xxx after this
        {
            ::boost::container::uninitialized_move_alloc_n
                    (this->alloc(), container_detail::to_raw_pointer(holder.start()), m_size,
                     container_detail::to_raw_pointer(this->start()));
        }

        template<class OtherAllocator, class OtherAllocatorVersion>
        vector_alloc_holder(BOOST_RV_REF_BEG vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> BOOST_RV_REF_END
                            holder)
                : Allocator(),
                  m_size(holder.m_size) //Initialize it to m_size as first_allocation can only succeed or abort
        {
            ...
            ::boost::container::uninitialized_move_alloc_n
                    (this->alloc(), container_detail::to_raw_pointer(holder.start()), n,
                     container_detail::to_raw_pointer(this->start()));
        }
        ...
        void move_from_empty(
                vector_alloc_holder &) {  //Containers with version 0 allocators can't be moved without move elements one by one
            throw_bad_alloc();
        }
        ...
        BOOST_CONTAINER_NOEXCEPT { return Allocator::internal_storage(); }

        size_type capacity() const

        BOOST_CONTAINER_NOEXCEPT { return Allocator::internal_capacity; }
    ...
    private:
        ...
        void priv_swap_members_impl(vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> &x) {
            ...
            if (this->m_size < x.m_size) {
                boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x,
                                                                   x.m_size);
            } else {
                boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this,
                                                                   this->m_size);
            }
            boost::container::swap_dispatch(this->m_size, x.m_size);
        }
...
public:
   ...
   typedef BOOST_CONTAINER_IMPDEF(const_pointer)                                       const_iterator;
    ...
    const_iterator;
#endif
    typedef BOOST_CONTAINER_IMPDEF(std
...
public:
    ...
    vector(InIt first, InIt last)
            :  m_holder() { this->insert(this->cend(), first, last); }
    ...
    vector(InIt first, InIt last, const allocator_type &a)
            :  m_holder(a) { this->insert(this->cend(), first, last); }
    ...
    vector(const vector &x)
            : m_holder(container_detail::uninitialized_size,
                       allocator_traits_type::select_on_container_copy_construction(x.m_holder.alloc()), x.size()) {
    ...
    vector(BOOST_RV_REF_BEG vector<T, OtherAllocator> BOOST_RV_REF_END x, typename container_detail::enable_if_c
    ...
    vector(BOOST_RV_REF(vector) x, const allocator_type &a)
        ...
        if (x.m_holder.alloc() == a) {
            ...
            ::boost::container::uninitialized_move_alloc_n_source
                    (this->m_holder.alloc(), container_detail::to_raw_pointer(x.m_holder.start()), n,
                     container_detail::to_raw_pointer(this->m_holder.start()));
        }
    }
    ...
    BOOST_CONTAINER_NOEXCEPT {
        boost::container::destroy_alloc_n
                (this->get_stored_allocator(), container_detail::to_raw_pointer(this->m_holder.start()),
    ...
    typename container_detail::enable_if_c
            <container_detail::is_version<OtherAllocator, 0>::value &&
             !container_detail::is_same<OtherAllocator, allocator_type>::value, vector &>::type
    ...
    void assign(InIt first, InIt last
        ...
        if (first == last) {
            ...
            size_type n = static_cast<size_type>(end_pos -
                                                 container_detail::to_raw_pointer(vector_iterator_get_ptr(cur)));
    ...
    void assign(FwdIt first, FwdIt last
        ...
        if (input_sz > old_capacity) {  //If input range is too big, we need to reallocate
            ...
            std::pair<pointer, bool> ret =
                    this->m_holder.allocation_command(allocate_new, input_sz, input_sz, real_cap,
                                                      this->m_holder.start());
    ...
    //!
    //! <b>Complexity</b>: Linear to n.
    void assign(size_type n, const value_type &val) { this->assign(cvalue_iterator(val, n), cvalue_iterator()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->m_holder.alloc(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return iterator(this->m_holder.start()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return const_iterator(this->m_holder.start()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return iterator(this->m_holder.start() + this->m_holder.m_size); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->cend(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->end()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->crbegin(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->begin()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->crend(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return const_iterator(this->m_holder.start() + this->m_holder.m_size); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->end()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->begin()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return !this->m_holder.m_size; }
    ...
    BOOST_CONTAINER_NOEXCEPT { return allocator_traits_type::max_size(this->m_holder.alloc()); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->m_holder.capacity(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return *this->m_holder.start(); }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->m_holder.start()[this->m_holder.m_size - 1]; }
    ...
    BOOST_CONTAINER_NOEXCEPT { return this->m_holder.start()[n]; }
    ...
    BOOST_CONTAINER_NOEXCEPT { return container_detail::to_raw_pointer(this->m_holder.start()); }
...
#include BOOST_PP_LOCAL_ITERATE()
   ...
   iterator insert(const_iterator position, T &&x);
    ...
    template<class FwdIt>
    iterator insert(const_iterator pos, FwdIt first, FwdIt last, typename container_detail::enable_if_c
            <!container_detail::is_convertible<FwdIt, size_type>::value
             && !container_detail::is_input_iterator<FwdIt>::value
            >::type * = 0
    ) {
        container_detail::insert_range_proxy<Allocator, FwdIt, T *> proxy(first);
        return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), std::distance(first, last), proxy,
                                               alloc_version());
    }
    ...
    iterator erase(const_iterator first, const_iterator last) {
        if (first != last) {
            ...
            T *const ptr = container_detail::to_raw_pointer(boost::move
                                                                    (container_detail::to_raw_pointer(
                                                                            vector_iterator_get_ptr(last)), end_pos,
                                                                     container_detail::to_raw_pointer(
                                                                             vector_iterator_get_ptr(first))
                                                                    ));
    ...
    BOOST_CONTAINER_NOEXCEPT_IF((!container_detail::is_version<Allocator, 0>::value))
    {
    ...
    //! <b>Note</b>: Non-standard extension to support static_vector
    template<class OtherAllocator>
    void swap(vector<T, OtherAllocator> &x, typename container_detail::enable_if_c
            <container_detail::is_version<OtherAllocator, 0>::value &&
    ...
    BOOST_CONTAINER_NOEXCEPT { this->priv_destroy_all(); }
    ...
    void insert_ordered_at(size_type element_count, BiDirPosConstIt last_position_it, BiDirSkipConstIt last_skip_it,
...
private:
    ...
    void priv_reserve(size_type, allocator_v0) { throw_bad_alloc(); }
    ...
    void priv_reserve(size_type new_cap, allocator_v1) {
        ...
        this->priv_forward_range_insert_new_allocation
                (container_detail::to_raw_pointer(p), new_cap,
                 container_detail::to_raw_pointer(this->m_holder.start()) + this->m_holder.m_size, 0,
    ...
    void priv_destroy(value_type *p)
    ...
    void priv_destroy_last_n(size_type n)
    ...
    container_detail::insert_copy_proxy<Allocator, T *>
    priv_single_insert_proxy(const T &x) { return container_detail::insert_copy_proxy<Allocator, T *>(x); }

    container_detail::insert_move_proxy<Allocator, T *>
    priv_single_insert_proxy(BOOST_RV_REF(T) x) { return container_detail::insert_move_proxy<Allocator, T *>(x); }
    ...
    void priv_push_back(BOOST_FWD_REF(U) u) {
        if (this->m_holder.m_size < this->m_holder.capacity()) {
            ...
            this->priv_forward_range_insert_no_capacity
                    (vector_iterator_get_ptr(this->cend()), 1, this->priv_single_insert_proxy(::boost::forward<U>(u)),
                     alloc_version());
        }
    }

    container_detail::insert_n_copies_proxy<Allocator, T *>
    priv_resize_proxy(const T &x) { return container_detail::insert_n_copies_proxy<Allocator, T *>(x); }

    container_detail::insert_default_initialized_n_proxy<Allocator, T *>
    priv_resize_proxy(default_init_t) { return container_detail::insert_default_initialized_n_proxy<Allocator, T *>(); }

    container_detail::insert_value_initialized_n_proxy<Allocator, T *>
    priv_resize_proxy(value_init_t) { return container_detail::insert_value_initialized_n_proxy<Allocator, T *>(); }
            ...
            if (!sz) {
                ...
                this->priv_forward_range_insert_new_allocation
                        (container_detail::to_raw_pointer(p), sz,
                         container_detail::to_raw_pointer(this->m_holder.start()), 0, this->priv_dummy_empty_proxy());
            }
        }
    }
        ...
        if (cp) {
            ...
            if (!sz) {
                ...
                if (this->m_holder.allocation_command
                        (shrink_in_place | nothrow_allocation, cp, sz, received_size, this->m_holder.start()).first) {
    ...
    iterator priv_forward_range_insert_at_end
        ...
        return this->priv_forward_range_insert(vector_iterator_get_ptr(this->cend()), n, insert_range_proxy,
                                               allocator_v1());
    }
    ...
    //Absolutely experimental. This function might change, disappear or simply crash!
    template<class BiDirPosConstIt, class BiDirSkipConstIt, class BiDirValueIt>
    void priv_insert_ordered_at(size_type element_count, BiDirPosConstIt last_position_it, bool do_skip,
        ...
        while (insertions_left) {
            ...
            if (new_hole_size > 0) {
                ...
                allocator_traits_type::construct(this->m_holder.alloc(), begin_ptr + pos + insertions_left - 1,
                                                 *(--last_value_it));
                --new_hole_size;
                if (new_hole_size == 0) {
...
private:
    ...
    void priv_forward_range_insert_new_allocation
            (T *const new_start, size_type new_cap, T *const pos, const size_type n,
        ...
        if (old_buffer) {
            new_finish = ::boost::container::uninitialized_move_alloc
                    (this->m_holder.alloc(), container_detail::to_raw_pointer(this->m_holder.start()), pos,
