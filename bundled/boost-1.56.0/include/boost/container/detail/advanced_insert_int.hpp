    ...
    namespace container {
        namespace container_detail {
            ...
            struct insert_n_copies_proxy {
                ...
                void copy_n_and_update(A &, Iterator p, size_type n) const { std::fill_n(p, n, v_); }
            ...
            struct insert_value_initialized_n_proxy {
                ...
                void copy_n_and_update(A &, Iterator, size_type) const { BOOST_ASSERT(false); }
            };
            ...
            insert_move_proxy<A, It>
            get_insert_value_proxy(BOOST_RV_REF(typename std::iterator_traits<It>::value_type) v) {
