...
namespace boost {
    namespace container {
        ...
        public:
            ...
            friend bool operator==(const constant_iterator &i, const constant_iterator &i2) { return i.equal(i2); }

            friend bool operator!=(const constant_iterator &i, const constant_iterator &i2) { return !(i == i2); }

            friend bool operator<(const constant_iterator &i, const constant_iterator &i2) { return i.less(i2); }
            ...
            friend constant_iterator operator+(Difference off, const constant_iterator &right) { return right + off; }
        ...
        public:
            ...
            friend bool
            operator!=(const default_init_construct_iterator &i, const default_init_construct_iterator &i2) {
                return !(i == i2);
            }
        ...
        public:
            ...
            template<class A>
            void construct_in_place(A &a, T *ptr) { (*m_pe)(a, ptr); }
        ...
        private:
            ...
            difference_type distance_to(const this_type &other) const { return difference_type(m_num - other.m_num); }
        };
        ...
        namespace container_detail {
            ...
            struct std_iterator {
                typedef typename std::iterator
                        <typename iiterator_types<IIterator>::iterator_category, typename iiterator_types<IIterator>::value_type, typename iiterator_types<IIterator>::difference_type, typename iiterator_types<IIterator>::const_pointer, typename iiterator_types<IIterator>::const_reference> type;
            };

            template<class IIterator>
            struct std_iterator<IIterator, false> {
                typedef typename std::iterator
                        <typename iiterator_types<IIterator>::iterator_category, typename iiterator_types<IIterator>::value_type, typename iiterator_types<IIterator>::difference_type, typename iiterator_types<IIterator>::pointer, typename iiterator_types<IIterator>::reference> type;
            };
            ...
            public:
                ...
                explicit iterator(IIterator iit)

                BOOST_CONTAINER_NOEXCEPT
                        : m_iit(iit) {}

                iterator(iterator<IIterator, false> const &other)
                ...
                BOOST_CONTAINER_NOEXCEPT { return l.m_iit == r.m_iit; }
                ...
                BOOST_CONTAINER_NOEXCEPT { return (*this->m_iit).get_data(); }
                ...
                BOOST_CONTAINER_NOEXCEPT { return this->m_iit; }
