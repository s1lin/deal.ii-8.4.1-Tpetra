        ...
        namespace container_detail {
            ...
            struct select_private_adaptive_node_pool_impl {
                ...
                private_adaptive_node_pool_impl
                        <fake_segment_manager, unsigned(AlignOnly) * ::boost::container::adaptive_pool_flag::align_only
...
//!nodes allocated per block (NodesPerBlock) are known at compile time.
            template<std::size_t NodeSize, std::size_t NodesPerBlock, std::size_t MaxFreeBlocks, std::size_t OverheadPercent
            >
            ...
            public:
                ...
                private_adaptive_node_pool()
                        : base_t(0, NodeSize, NodesPerBlock, MaxFreeBlocks, (unsigned char) OverheadPercent) {}
            };
