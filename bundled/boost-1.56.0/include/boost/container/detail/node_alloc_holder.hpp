    ...
    namespace container {
        namespace container_detail {
            ...
            struct node_compare
                ...
                wrapped_value_compare &value_comp() { return static_cast<wrapped_value_compare &>(*this); }

                wrapped_value_compare &value_comp() const { return static_cast<const wrapped_value_compare &>(*this); }
            ...
            struct node_alloc_holder {
                ...
                typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(boost
                ::container::container_detail::, ICont,
                value_compare, container_detail::nat)
                ...
                typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(boost
                ::container::container_detail::, ICont,
                wrapped_value_compare, container_detail::nat)
                value_compare;
            ...
            public:
                ...
                explicit node_alloc_holder (BOOST_RV_REF(node_alloc_holder)
                ...
                explicit node_alloc_holder(BOOST_RV_REF(node_alloc_holder) x, const value_compare &c)
                        : members_(boost::move(x.node_alloc()), c) { this->icont().swap(x.icont()); }
                ...
                size_type max_size() const { return allocator_traits_type::max_size(this->node_alloc()); }

                NodePtr allocate_one() { return AllocVersionTraits::allocate_one(this->node_alloc()); }

                void deallocate_one(const NodePtr &p) { AllocVersionTraits::deallocate_one(this->node_alloc(), p); }
...
#include BOOST_PP_LOCAL_ITERATE()
                ...
                NodePtr create_node_from_it(const It &it) {
                    NodePtr p = this->allocate_one();
                    Deallocator node_deallocator(p, this->node_alloc());
                    ::boost::container::construct_in_place(this->node_alloc(), container_detail::addressof(p->m_data),
                                                           it);
                    node_deallocator.release();
                    //This does not throw
                    typedef typename Node::hook_type hook_type;
                    ...
                    if (n) {
                        ...
                        BOOST_TRY{
                                ...
                                while (n--){
                                    ...
                                    ++itbeg;
                                    //This can throw
                                    boost::container::construct_in_place(nalloc, container_detail::addressof(p->m_data),
                                                                         beg);
                                    sdestructor.set(p);
                                    ++beg;
                                    //This does not throw
            ...
            protected:
                struct cloner {
                    ...
                    NodePtr operator()(const Node &other) const { return m_holder.create_node(other.get_data()); }
                ...
                public:
                    ...
                    explicit members_holder (BOOST_FWD_REF(ConvertibleToAlloc)
                ...
                ICont &non_const_icont() const { return const_cast<ICont &>(this->members_.m_icont); }

                ICont &icont() { return this->members_.m_icont; }

                const ICont &icont() const { return this->members_.m_icont; }

                NodeAlloc &node_alloc() { return static_cast<NodeAlloc &>(this->members_); }

                const NodeAlloc &node_alloc() const { return static_cast<const NodeAlloc &>(this->members_); }
