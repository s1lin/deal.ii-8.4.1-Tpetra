...
//!allocated for an object using a STL allocator.
            ...
            private:
                void priv_deallocate(allocator_v1) { m_alloc.deallocate(m_ptr, 1); }

                void priv_deallocate(allocator_v2) { m_alloc.deallocate_one(m_ptr); }
...
//!allocated for an array of objects using a STL allocator.
            ...
            private:
                ...
                void priv_deallocate(const pointer &p, allocator_v1) { AllocTraits::deallocate(m_alloc, p, 1); }

                void priv_deallocate(const pointer &p, allocator_v2) { m_alloc.deallocate_one(p); }
...
//!an object using a STL allocator.
            ...
            private:
                void priv_deallocate(const pointer &p, allocator_v1) { AllocTraits::deallocate(a_, p, 1); }

                void priv_deallocate(const pointer &p, allocator_v2) { a_.deallocate_one(p); }
