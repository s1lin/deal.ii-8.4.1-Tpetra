    ...
    namespace container {
        namespace container_detail {
            ...
            struct tree_value_compare
                ...
                const key_compare &key_comp() const { return static_cast<const key_compare &>(*this); }

                key_compare &key_comp() { return static_cast<key_compare &>(*this); }
                ...
                key_forward(const T &key) const { return key; }

                template<class T>
                typename enable_if_c<!is_key<T>::value, const key_type &>::type
                key_forward(const T &key) const { return KeyOfValue()(key); }
            ...
            struct intrusive_tree_hook<VoidPointer, boost::container::red_black_tree, OptimizeSize> {
                typedef typename container_detail::bi::make_set_base_hook
                        <container_detail::bi::void_pointer<VoidPointer>, container_detail::bi::link_mode<container_detail::bi::normal_link>, container_detail::bi::optimize_size<OptimizeSize>
                        >::type type;
            };
            ...
            struct intrusive_tree_hook<VoidPointer, boost::container::scapegoat_tree, OptimizeSize> {
                typedef typename container_detail::bi::make_bs_set_base_hook
                        <container_detail::bi::void_pointer<VoidPointer>, container_detail::bi::link_mode<container_detail::bi::normal_link>
                        >::type type;
            };
...
//The node to be store in the tree
            ...
            public:
                ...
                typedef tree_node<T, VoidPointer, tree_type_value, OptimizeSize> node_type;
                ...
                template<class V>
                void do_assign(const V &v) { m_data = v; }
                ...
                template<class V>
                void do_move_assign(V &v) { m_data = ::boost::move(v); }
            };
            ...
            public:
                ...
                void operator()(Node &n) { this->icont_.insert_equal(this->icont_.cend(), n); }
            };
            ...
            public:
                ...
                void operator()(Node &n) { this->icont_.push_back(n); }
            };
        ...
        namespace container_detail {
            ...
            template<class NodeType, class NodeCompareType, class SizeType, class HookType, boost::container::tree_type_enum tree_type_value>
            ...
            struct intrusive_tree_dispatch
                ...
                typedef typename container_detail::bi::make_rbtree
                        <NodeType, container_detail::bi::compare<NodeCompareType>, container_detail::bi::base_hook<HookType>, container_detail::bi::constant_time_size<true>, container_detail::bi::size_type<SizeType>
                        >::type type;
            };
            ...
            struct intrusive_tree_dispatch
                ...
                typedef typename container_detail::bi::make_sgtree
                        <NodeType, container_detail::bi::compare<NodeCompareType>, container_detail::bi::base_hook<HookType>, container_detail::bi::floating_point<true>, container_detail::bi::size_type<SizeType>
                        >::type type;
            };
            ...
            private:
                ...
                typedef typename container_detail::tree_node
                        <value_type, void_pointer, tree_type_value, OptimizeSize> node_type;
                ...
                typedef typename intrusive_tree_hook
                        <void_pointer, tree_type_value, OptimizeSize>::type hook_type;
            public:
                typedef typename intrusive_tree_dispatch
                        <node_type, node_compare_type, size_type, hook_type, tree_type_value>::type type;
            };
...
//Trait to detect manually rebalanceable tree types
            ...
            template<>
            struct is_manually_balanceable<red_black_tree> {
                static const bool value = false;
            };

            template<>
            struct is_manually_balanceable<avl_tree> {
                static const bool value = false;
            };

//Proxy traits to implement different operations depending on the
//is_manually_balanceable<>::value
            template<boost::container::tree_type_enum tree_type_value, bool IsManuallyRebalanceable = is_manually_balanceable<tree_type_value>::value>
            ...
            struct intrusive_tree_proxy<tree_type_value, true> {
                template<class Icont>
                static void rebalance(Icont &c) { c.rebalance(); }
            };
...
//where KeyValueCompare is tree_value_compare<Key, Value, KeyCompare, KeyOfValue>
            struct key_node_compare
                ...
                key_forward(const T &node) const { return node.get_data(); }
            ...
            class tree
                    : protected container_detail::node_alloc_holder
                            <A, typename container_detail::intrusive_tree_type
                ...
                typedef typename container_detail::intrusive_tree_type
                        <A, ValComp, Options::tree_type, Options::optimize_size>::type Icont;
                typedef container_detail::node_alloc_holder
                        <A, Icont> AllocHolder;
                typedef typename AllocHolder::NodePtr NodePtr;
                typedef tree<Key, Value, KeyOfValue, KeyCompare, A, Options> ThisType;
            ...
            public:
                ...
                template<class InputIterator>
                tree(ordered_range_t, InputIterator first, InputIterator last, const key_compare &comp = key_compare(),
                ...
                ~tree() {} //AllocHolder clears the tree
                ...
                tree &operator=(BOOST_COPY_ASSIGN_REF(tree) x) {
                    if (&x != this) {
                        ...
                        this->icont().clone_from
                                (x.icont(), RecyclingCloner<AllocHolder, false>(*this, other_tree),
                ...
                tree &operator=(BOOST_RV_REF(tree) x) {
                    ...
                    if (propagate_alloc || allocators_equal) {
                        ...
                        //Now recreate the source tree reusing nodes stored by other_tree
                        this->icont().clone_from
                                (x.icont(), RecyclingCloner<AllocHolder, true>(*this, other_tree),
                                 Destroyer(this->node_alloc()));
            ...
            public:
                // accessors:
                value_compare value_comp() const { return this->icont().value_comp().value_comp(); }

                key_compare key_comp() const { return this->icont().value_comp().value_comp().key_comp(); }

                allocator_type get_allocator() const { return allocator_type(this->node_alloc()); }

                const stored_allocator_type &get_stored_allocator() const { return this->node_alloc(); }

                stored_allocator_type &get_stored_allocator() { return this->node_alloc(); }

                iterator begin() { return iterator(this->icont().begin()); }

                const_iterator begin() const { return this->cbegin(); }

                iterator end() { return iterator(this->icont().end()); }
                ...
                const_iterator cbegin() const { return const_iterator(this->non_const_icont().begin()); }
                ...
                //!
                //! <b>Complexity</b>: Constant.
                const_iterator cend() const { return const_iterator(this->non_const_icont().end()); }
                ...
                void swap(ThisType &x) { AllocHolder::swap(x); }
            ...
            private:
                ...
                std::pair<iterator, bool> emplace_unique_impl(NodePtr p) {
                    ...
                    return std::pair<iterator, bool>
                            (iterator(iiterator(this->icont().insert_unique_commit(*p, data))), true);
                }
...
#include BOOST_PP_LOCAL_ITERATE()
                ...
                void rebalance() { intrusive_tree_proxy_t::rebalance(this->icont()); }
                ...
                friend bool operator!=(const tree &x, const tree &y) { return !(x == y); }

                friend bool operator>(const tree &x, const tree &y) { return y < x; }
