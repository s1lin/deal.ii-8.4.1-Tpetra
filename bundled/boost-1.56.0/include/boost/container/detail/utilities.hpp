...
//////////////////////////////////////////////////////////////////////////////
        ...
        namespace container_detail {
            ...
            enum NextCapacityOption {
                NextCapacityDouble, NextCapacity60Percent
            };
            ...
            iterator_to_raw_pointer(const Iterator &i) { return (to_raw_pointer)((iterator_to_pointer)(i)); }
    ...
    template<class AllocatorType>
    inline void assign_alloc(AllocatorType &l, const AllocatorType &r, container_detail::true_type) { l = r; }
...
template<class AllocatorType>
inline void move_alloc(AllocatorType &l, AllocatorType &r, container_detail::true_type) { l = ::boost::move(r); }
...
/////////////////////////
        ...
        struct are_contiguous_and_same {
            static const bool is_same_io =
                    is_same<typename remove_const<typename ::std::iterator_traits<I>::value_type>::type, typename ::std::iterator_traits<O>::value_type
                    >::value;
        ...
        ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f),
    ...
    template
            <typename I, // I models InputIterator
                    typename F>
    // F models ForwardIterator
    F memmove_n(I f, typename std::iterator_traits<I>::difference_type n, F r)
...
template
        <typename I, // I models InputIterator
                typename F>
// F models ForwardIterator
I memmove_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r)
...
template
        <typename I, // I models InputIterator
                typename F>
// F models ForwardIterator
I memmove_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r)
...
uninitialized_move_alloc(A &, I f, I l, F r)
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_move_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r)
...
uninitialized_move_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r)
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_copy_alloc(A &, I f, I l, F r)
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_copy_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r)
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
uninitialized_copy_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r)
...
template
        <std::size_t MaxTmpBytes, typename A, typename F // F models ForwardIterator
                , typename G // G models ForwardIterator
        >
inline typename container_detail::disable_if_memtransfer_copy_assignable<F, G, void>::type
deep_swap_alloc_n(A &a, F short_range_f, typename allocator_traits<A>::size_type n_i, G large_range_f,
                  typename allocator_traits<A>::size_type n_j) {
...
inline typename container_detail::enable_if_c
        <container_detail::is_memtransfer_copy_assignable<F, G>::value && (MaxTmpBytes <= DeepSwapAllocNMaxStorage) &&
         false, void>::type
deep_swap_alloc_n(A &a, F short_range_f, typename allocator_traits<A>::size_type n_i, G large_range_f,
                  typename allocator_traits<A>::size_type n_j) {
...
deep_swap_alloc_n(A &a, F short_range_f, typename allocator_traits<A>::size_type n_i, G large_range_f,
    ...
    char *large_ptr = static_cast<char *>(static_cast<void *>(container_detail::iterator_to_raw_pointer(
            large_range_f)));
    char *short_ptr = static_cast<char *>(static_cast<void *>(container_detail::iterator_to_raw_pointer(
            short_range_f)));
...
template
        <typename A, typename I // F models InputIterator
                , typename O // G models OutputIterator
        >
void copy_assign_range_alloc_n(A &a, I inp_start, typename allocator_traits<A>::size_type n_i, O out_start,
                               typename allocator_traits<A>::size_type n_o) {
    if (n_o < n_i) {
...
template
        <typename A, typename I // F models InputIterator
                , typename O // G models OutputIterator
        >
void move_assign_range_alloc_n(A &a, I inp_start, typename allocator_traits<A>::size_type n_i, O out_start,
                               typename allocator_traits<A>::size_type n_o) {
    if (n_o < n_i) {
