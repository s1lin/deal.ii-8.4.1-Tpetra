...
namespace boost {
    namespace container {
        ...
        namespace container_detail {
            ...
            static D &force(const S &s) { return *const_cast<D *>((reinterpret_cast<const D *>(&s))); }
...
//!   (e.g. <i>allocator< std::pair<Key, T> > </i>).
        ...
        private:
            ...
            typedef container_detail::flat_tree_value_compare
                    <Compare, container_detail::select1st<std::pair<Key, T> >, std::pair<Key, T> > value_compare_impl;
        ...
        public:
            ...
            typedef BOOST_CONTAINER_IMPDEF(Allocator)
            stored_allocator_type;
            typedef BOOST_CONTAINER_IMPDEF(value_compare_impl)
            value_compare;
            ...
            const_iterator;
            typedef BOOST_CONTAINER_IMPDEF(reverse_iterator_impl)
            reverse_iterator;
            typedef BOOST_CONTAINER_IMPDEF(const_reverse_iterator_impl)
            const_reverse_iterator;
            typedef BOOST_CONTAINER_IMPDEF(impl_value_type)
            movable_value_type;
        ...
        public:
            ...
            flat_map()
                ...
                BOOST_STATIC_ASSERT(
                        (container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
            }
            ...
            template<class InputIterator>
            flat_map(ordered_unique_range_t, InputIterator first, InputIterator last, const Compare &comp = Compare(),
                     const allocator_type &a = allocator_type())
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<iterator>(m_flat_tree.begin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<const_iterator>(m_flat_tree.begin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<iterator>(m_flat_tree.end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<const_iterator>(m_flat_tree.end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<reverse_iterator>(m_flat_tree.rbegin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<reverse_iterator>(m_flat_tree.rend()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<const_iterator>(m_flat_tree.cbegin()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::force_copy<const_iterator>(m_flat_tree.cend()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return m_flat_tree.empty(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return m_flat_tree.size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return m_flat_tree.max_size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return m_flat_tree.capacity(); }
            ...
            void reserve(size_type cnt) { m_flat_tree.reserve(cnt); }
            ...
            void shrink_to_fit() { m_flat_tree.shrink_to_fit(); }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            size_type erase(const key_type &x) { return m_flat_tree.erase(x); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            void swap(flat_map &x) { m_flat_tree.swap(x.m_flat_tree); }
            ...
            BOOST_CONTAINER_NOEXCEPT { m_flat_tree.clear(); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            key_compare key_comp() const { return container_detail::force_copy<key_compare>(m_flat_tree.key_comp()); }
            ...
            iterator find(const key_type &x) { return container_detail::force_copy<iterator>(m_flat_tree.find(x)); }
            ...
            std::pair<const_iterator, const_iterator> equal_range(const key_type &x) const {
                return container_detail::force_copy<std::pair<const_iterator, const_iterator> >(
                        m_flat_tree.lower_bound_range(x));
            }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator!=(const flat_map &x, const flat_map &y) { return !(x == y); }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            friend void swap(flat_map &x, flat_map &y) { x.swap(y); }
...
//!specialization for optimizations
    ...
    struct has_trivial_destructor_after_move<boost::container::flat_map<K, T, C, Allocator> > {
        static const bool value =
                has_trivial_destructor_after_move<Allocator>::value && has_trivial_destructor_after_move<C>::value;
    };
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            //!
            //! <b>Complexity</b>: Constant.
            void swap(flat_multimap &x) { m_flat_tree.swap(x.m_flat_tree); }
            ...
            //!
            //! <b>Complexity</b>: log(size())+count(k)
            size_type count(const key_type &x) const { return m_flat_tree.count(x); }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator!=(const flat_multimap &x, const flat_multimap &y) { return !(x == y); }
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator>(const flat_multimap &x, const flat_multimap &y) { return y < x; }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            friend void swap(flat_multimap &x, flat_multimap &y) { x.swap(y); }
        };
