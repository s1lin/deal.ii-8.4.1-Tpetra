...
//    if and only if the pointer is in the range [start.node, finish.node].
            ...
            public:
                ...
                static std::size_t s_buffer_size() { return deque_buf_size<value_type>::value; }
            ...
            public:
                ...
                deque_iterator(val_alloc_ptr x, index_pointer y)
                ...
                *y),
                ...
                deque_iterator(deque_iterator<Pointer, false> const &x)

                BOOST_CONTAINER_NOEXCEPT
                        : m_cur(x.get_cur()), m_first(x
                .
                ...
                deque_iterator(Pointer cur, Pointer first, Pointer last, index_pointer node)

                BOOST_CONTAINER_NOEXCEPT
                        : m_cur(cur), m_first(first), m_last(last), m_node(node) {}

                deque_iterator<Pointer, false> unconst() const

                BOOST_CONTAINER_NOEXCEPT {
                    return deque_iterator<Pointer, false>(this->get_cur(), this->get_first(), this->get_last(),
                                                          this->get_node());
                }

                reference operator*() const

                BOOST_CONTAINER_NOEXCEPT { return *this->m_cur; }
                ...
                BOOST_CONTAINER_NOEXCEPT { return *this += -n; }
                ...
                friend bool operator==(const deque_iterator &l, const deque_iterator &r)

                BOOST_CONTAINER_NOEXCEPT { return l.m_cur == r.m_cur; }
                ...
                BOOST_CONTAINER_NOEXCEPT { return r < l; }
                ...
                BOOST_CONTAINER_NOEXCEPT { return !(l < r); }
                ...
                friend deque_iterator operator+(difference_type n, deque_iterator x)

                BOOST_CONTAINER_NOEXCEPT { return x += n; }
            };
...
//  exception safety easier.
        ...
        protected:
            ...
            BOOST_CONTAINER_NOEXCEPT { return deque_buf_size<val_alloc_val>::value; }

            val_alloc_ptr priv_allocate_node() { return this->alloc().allocate(s_buffer_size()); }

            void priv_deallocate_node(val_alloc_ptr p)

            BOOST_CONTAINER_NOEXCEPT { this->alloc().deallocate(p, s_buffer_size()); }

            ptr_alloc_ptr priv_allocate_map(size_type n) { return this->ptr_alloc().allocate(n); }

            void priv_deallocate_map(ptr_alloc_ptr p, size_type n)

            BOOST_CONTAINER_NOEXCEPT { this->ptr_alloc().deallocate(p, n); }
            ...
            deque_base(size_type num_elements, const allocator_type &a)
                    : members_(a) { this->priv_initialize_map(num_elements); }
            ...
            explicit deque_base (BOOST_RV_REF(deque_base)

            x)
            :

            members_ ( boost::move(x
...
//      }
        ...
        protected:
            struct members_holder
                    : public ptr_alloc_t, public allocator_type {
                members_holder()
                        : map_allocator_type(), allocator_type(), m_map(0), m_map_size(0), m_start(),
                          m_finish(m_start) {}

                explicit members_holder(const allocator_type &a)
                        : map_allocator_type(a), allocator_type(a), m_map(0), m_map_size(0), m_start(),
                          m_finish(m_start) {}

                template<class ValAllocConvertible, class PtrAllocConvertible>
                members_holder (BOOST_FWD_REF(PtrAllocConvertible)

                pa,
                BOOST_FWD_REF(ValAllocConvertible)
                va)
                :
            ...
            BOOST_CONTAINER_NOEXCEPT { return members_; }
        ...
        public:
            ...
            iterator;
            typedef BOOST_CONTAINER_IMPDEF(typename Base::const_iterator)
            const_iterator;
        ...
        private:                      // Internal typedefs
            ...
            static size_type s_buffer_size() { return Base::s_buffer_size(); }
        ...
        public:
            ...
            deque(size_type n, const value_type &value,
                  const allocator_type &a = allocator_type())
                    : Base(n, a) { this->priv_fill_initialize(value); }
            ...
            void assign(FwdIt first, FwdIt last, typename container_detail::enable_if_c
            ...
            BOOST_CONTAINER_NOEXCEPT { return Base::alloc(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->members_.m_start; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->members_.m_finish; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->members_.m_finish); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->members_.m_finish); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->members_.m_start); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->members_.m_start); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->members_.m_finish == this->members_.m_start; }
            ...
            BOOST_CONTAINER_NOEXCEPT { return allocator_traits_type::max_size(this->alloc()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return *(end() - 1); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return *(cend() - 1); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->members_.m_start[difference_type(n)]; }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            BOOST_CONTAINER_NOEXCEPT {
                if (this->members_.m_start.m_cur != this->members_.m_start.m_last - 1) {
                    allocator_traits_type::destroy
                            (this->alloc(), container_detail::to_raw_pointer(this->members_.m_start.m_cur)
                            );
            ...
            BOOST_CONTAINER_NOEXCEPT {
                if (this->members_.m_finish.m_cur != this->members_.m_finish.m_first) {
                    ...
                    allocator_traits_type::destroy
                            (this->alloc(), container_detail::to_raw_pointer(this->members_.m_finish.m_cur)
                            );
                } else
            ...
            //!
            //! <b>Complexity</b>: Linear to the number of elements in the container.
            friend bool operator>(const deque &x, const deque &y) { return y < x; }
            ...
            //!
            //! <b>Complexity</b>: Constant.
            friend void swap(deque &x, deque &y) { x.swap(y); }
        ...
        private:
            ...
            void priv_push_front_simple_commit() { --this->members_.m_start.m_cur; }

            void priv_destroy_range(iterator p, iterator p2) {
                for (; p != p2; ++p) {
                    allocator_traits_type::destroy
                            (this->alloc(), container_detail::to_raw_pointer(container_detail::iterator_to_pointer(p))
                            );
                }
            }
            ...
            iterator priv_reserve_elements_at_back(size_type n) {
                ...
                if (n > vacancies) {
                    ...
                    size_type s = (size_type) (this->members_.m_map_size -
                                               (this->members_.m_finish.m_node - this->members_.m_map));
                    if (new_nodes + 1 > s) {
            ...
            void priv_reallocate_map(size_type nodes_to_add, bool add_at_front) {
                ...
                if (this->members_.m_map_size > 2 * new_num_nodes) {
                    ...
                    if (new_nstart < this->members_.m_start.m_node)
                        ...
                        boost::move_backward
                                (this->members_.m_start.m_node, this->members_.m_finish.m_node + 1,
                                 new_nstart + old_num_nodes);
                } else {
                    size_type new_map_size =
                            this->members_.m_map_size +
                            container_detail::max_value(this->members_.m_map_size, nodes_to_add) + 2;
