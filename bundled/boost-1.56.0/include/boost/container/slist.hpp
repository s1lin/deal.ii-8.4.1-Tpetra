...
//! \tparam Allocator The allocator used for all internal memory management
        ...
        public:
            ...
            explicit slist(size_type n)
                    : AllocHolder(allocator_type()) { this->resize(n); }
            ...
            BOOST_CONTAINER_NOEXCEPT {} //AllocHolder clears the slist
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->cbefore_begin(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_iterator(end()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->icont().previous(p.get())); }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            //!
            //! <b>Complexity</b>: Amortized constant time.
            void pop_front() { this->icont().pop_front_and_dispose(Destroyer(this->node_alloc())); }
            ...
            iterator erase_after(const_iterator before_first, const_iterator last) {
                return iterator(this->icont().erase_after_and_dispose(before_first.get(), last.get(),
            ...
            void swap(slist &x) { AllocHolder::swap(x); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice_after(prev_pos, static_cast<slist &>(x)); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice_after(prev_pos, static_cast<slist &>(x), prev); }
...
#include BOOST_PP_LOCAL_ITERATE()
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->erase_after(previous(p))); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return iterator(this->erase_after(previous(first), last)); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice_after(this->previous(p), x); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<slist &>(x)); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice_after(this->previous(p), x, this->previous(i)); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<slist &>(x), i); }
            ...
            BOOST_CONTAINER_NOEXCEPT { this->splice(p, static_cast<slist &>(x), first, last); }
