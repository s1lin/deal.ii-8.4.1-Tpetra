...
//! derived from false_type otherwise.
        ...
        get_outermost_allocator(Alloc &a) { return container_detail::outermost_allocator_imp<Alloc>::get(a); }

        template<typename Alloc>
        const typename container_detail::outermost_allocator_imp<Alloc>::type &
        get_outermost_allocator(const Alloc &a) { return container_detail::outermost_allocator_imp<Alloc>::get(a); }
...
#include BOOST_PP_LOCAL_ITERATE()
         ...
         /*
            ...
            inline void dispatch_allocator_prefix_suffix
                    (boost::true_type use_alloc_prefix, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p,
                     BOOST_FWD_REF(Args) ...
        ...
        >
        inline void dispatch_allocator_prefix_suffix
                (boost::false_type use_alloc_prefix, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p,
                 BOOST_FWD_REF(Args)...
    ...
    inline void dispatch_uses_allocator
            (boost::true_type uses_allocator, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p,
             BOOST_FWD_REF(Args)...
...
>
inline void dispatch_uses_allocator
        (boost::false_type uses_allocator, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p,
         BOOST_FWD_REF(Args)...
...
public:
    ...
    outer_allocator_type (::boost::move(other
...
public:
    ...
    friend void swap(scoped_allocator_adaptor_base &l, scoped_allocator_adaptor_base &r) { l.swap(r); }

    inner_allocator_type &inner_allocator()

    BOOST_CONTAINER_NOEXCEPT { return m_inner; }
    ...
    BOOST_CONTAINER_NOEXCEPT { return static_cast<outer_allocator_type &>(*this); }

    const outer_allocator_type &outer_allocator() const

    BOOST_CONTAINER_NOEXCEPT { return static_cast<const outer_allocator_type &>(*this); }

    scoped_allocator_type select_on_container_copy_construction() const {
        return scoped_allocator_type
                (internal_type_t(), outer_traits_type::select_on_container_copy_construction(this->outer_allocator()),
...
public:
    ...
    inner_allocator_type const &inner_allocator() const { return static_cast<const inner_allocator_type &>(*this); }

    outer_allocator_type &outer_allocator() { return static_cast<outer_allocator_type &>(*this); }

    const outer_allocator_type &outer_allocator() const { return static_cast<const outer_allocator_type &>(*this); }
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    scoped_allocator_adaptor &operator=(BOOST_RV_REF(scoped_allocator_adaptor)other) {
        return static_cast<scoped_allocator_adaptor &>(base_type::operator=(
                boost::move(static_cast<base_type &>(other))));
    }
...
#endif
    construct(T *p, BOOST_FWD_REF(Args)...

    args)
    {
        container_detail::dispatch_uses_allocator
                (uses_allocator < T, inner_allocator_type > (), get_outermost_allocator(this->outer_allocator()),
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    void construct(std::pair<T1, T2> *p) { this->construct_pair(p); }

    template<class T1, class T2>
    void construct(container_detail::pair <T1, T2> *p) { this->construct_pair(p); }
    ...
    template<class T1, class T2, class U, class V>
    void construct(std::pair<T1, T2> *p, const std::pair<U, V> &x) { this->construct_pair(p, x); }
    ...
    template<class T1, class T2, class U, class V>
    void construct(container_detail::pair <T1, T2> *p, BOOST_RV_REF_BEG container_detail::pair <U, V> BOOST_RV_REF_END
                   x) { this->construct_pair(p, x); }
