...
// allocator and whose size is this->m_storage.
            ...
            public:
                ...
                basic_string_base (BOOST_RV_REF(basic_string_base)

                b)
                :

                members_ (boost::move(b
            ...
            protected:
                ...
                union repr_t {
                    ...
                    const long_t &
                    long_repr() const { return *static_cast<const long_t *>(static_cast<const void *>(&r)); }

                    short_t &short_repr() { return s; }

                    long_t &long_repr() { return *static_cast<long_t *>(static_cast<void *>(&r)); }
                };
                ...
                const Allocator &alloc() const { return members_; }

                Allocator &alloc() { return members_; }
            ...
            protected:
                bool is_short() const { return static_cast<bool>(this->members_.m_repr.s.h.is_short != 0); }

                void is_short(bool yes) {
                    const bool was_short = this->is_short();
                    if (yes && !was_short) {
                        allocator_traits_type::destroy
                                (this->alloc(), static_cast<long_t *>(static_cast<void *>(&this->members_.m_repr.r))
                                );
            ...
            protected:
                ...
                size_type next_capacity(size_type additional_objects) const {
                    ...
                    get(allocator_traits_type::max_size(this->alloc()), this->priv_storage(), additional_objects);
                }
                ...
                void construct(pointer p, const value_type &value = value_type()) {
                    allocator_traits_type::construct
                            (this->alloc(), container_detail::to_raw_pointer(p), value
                            );
                }
                ...
                void destroy(pointer p) {
                    allocator_traits_type::destroy
                            (this->alloc(), container_detail::to_raw_pointer(p)
                            );
                }
                ...
                void deallocate_block() { this->deallocate(this->priv_addr(), this->priv_storage()); }

                size_type max_size() const { return allocator_traits_type::max_size(this->alloc()) - 1; }

            protected:
                size_type priv_capacity() const { return this->priv_storage() - 1; }

                pointer priv_short_addr() const {
                    return pointer_traits::pointer_to(
                            const_cast<value_type &>(this->members_.m_repr.short_repr().data[0]));
                }

                pointer priv_long_addr() const { return this->members_.m_repr.long_repr().start; }
                ...
                void priv_long_addr(pointer addr) { this->members_.m_repr.long_repr().start = addr; }

                size_type priv_storage() const { return this->is_short() ? priv_short_storage() : priv_long_storage(); }

                size_type priv_short_storage() const { return InternalBufferChars; }

                size_type priv_long_storage() const { return this->members_.m_repr.long_repr().storage; }
                ...
                size_type priv_short_size() const { return this->members_.m_repr.short_repr().h.length; }

                size_type priv_long_size() const { return this->members_.m_repr.long_repr().length; }
                ...
                void swap_data(basic_string_base &other) {
                    if (this->is_short()) {
                        ...
                        if (other.is_short()) {
                            ...
                            boost::container::swap_dispatch(this->members_.m_repr.long_repr(),
                                                            other.members_.m_repr.long_repr());
                        }
                    }
                }
            };
...
//! \tparam Allocator The allocator, used for internal memory management.
        ...
        public:
            ...
            iterator;
            typedef BOOST_CONTAINER_IMPDEF(const_pointer)
            const_iterator;
        ...
        public:                         // Constructor, destructor, assignment.
            ...
            //are two step copies optimized for capacity
                    : base_t(allocator_traits_type::select_on_container_copy_construction(a),
                             n + 1) { this->priv_terminate_string(); }
            ...
            basic_string()
                    : base_t() { this->priv_terminate_string(); }
            ...
            BOOST_CONTAINER_NOEXCEPT
                    : base_t(a) { this->priv_terminate_string(); }
            ...
            basic_string &operator=(const CharT *s) { return this->assign(s, s + Traits::length(s)); }

            //! <b>Effects</b>: Assignment from character.
            basic_string &operator=(CharT c) { return this->assign(static_cast<size_type>(1), c); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->alloc(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->priv_addr(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->priv_end_addr(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->priv_end_addr()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return reverse_iterator(this->priv_addr()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->priv_end_addr()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return const_reverse_iterator(this->priv_addr()); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return !this->priv_size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return base_t::max_size(); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->priv_capacity(); }
            ...
            void reserve(size_type res_arg) { this->priv_reserve(res_arg); }
                ...
                if (this->priv_storage() > InternalBufferChars) {
                    ...
                    if (this->priv_size() < InternalBufferChars) {
                        ...
                        Traits::copy(container_detail::to_raw_pointer(this->priv_short_addr()),
                                     container_detail::to_raw_pointer(long_addr), long_size + 1);
                        this->is_short(true);
            ...
            BOOST_CONTAINER_NOEXCEPT { return *(this->priv_addr() + n); }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &append(const basic_string &s) { return this->append(s.begin(), s.end()); }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &append(const CharT *s, size_type n) { return this->append(s, s + n); }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &append(const CharT *s) { return this->append(s, s + Traits::length(s)); }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &assign(const basic_string &s) { return this->operator=(s); }
            ...
            BOOST_CONTAINER_NOEXCEPT { return this->swap_data(ms), *this; }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &assign(const CharT *s, size_type n) { return this->assign(s, s + n); }
            ...
            //!
            //! <b>Returns</b>: *this
            basic_string &assign(const CharT *s) { return this->assign(s, s + Traits::length(s)); }
            ...
            iterator
            insert(const_iterator p, ForwardIter first, ForwardIter last, typename container_detail::enable_if_c
            ...
            basic_string &replace(size_type pos1, size_type n1, const basic_string &str) {
                ...
                const pointer addr = this->priv_addr();
                return this->replace(const_iterator(addr + pos1), const_iterator(addr + pos1 + len), str.begin(),
                                     str.end());
            }
            ...
            BOOST_CONTAINER_NOEXCEPT { return container_detail::to_raw_pointer(this->priv_addr()); }
            ...
            size_type find(const basic_string &s, size_type pos = 0) const { return find(s.c_str(), pos, s.size()); }
            ...
            size_type find(const CharT *s, size_type pos = 0) const { return this->find(s, pos, Traits::length(s)); }
            ...
            size_type rfind(const CharT *s, size_type pos = npos) const { return rfind(s, pos, Traits::length(s)); }
            ...
            size_type find_first_of(CharT c, size_type pos = 0) const { return find(c, pos); }
            ...
            size_type find_last_of(CharT c, size_type pos = npos) const { return rfind(c, pos); }
        ...
        private:
            ...
            void priv_shrink_to_fit_dynamic_buffer
                ...
                if (this->alloc().allocation_command
                        (shrink_in_place | nothrow_allocation, this->priv_long_storage(), this->priv_long_size() + 1,
                         received_size, this->priv_long_addr()).first) {
                    this->priv_storage(received_size);
                }
            }

            void priv_construct_null(pointer p) { this->construct(p, CharT(0)); }

            // Helper functions used by constructors.  It is a severe error for
            // any of them to be called anywhere except from within constructors.
            void priv_terminate_string() { this->priv_construct_null(this->priv_end_addr()); }
...
// Operator+
        ...
        inline
        basic_string<CharT, Traits, Allocator> operator+
                (const basic_string <CharT, Traits, Allocator> &x, BOOST_RV_REF_BEG basic_string
                 <CharT, Traits, Allocator> BOOST_RV_REF_END my) {
...
// Operator== and operator!=
        ...
        template<class CharT, class Traits, class Allocator>
        inline bool
        operator!=(const CharT *s, const basic_string <CharT, Traits, Allocator> &y) { return !(s == y); }

        template<class CharT, class Traits, class Allocator>
        inline bool
        operator!=(const basic_string <CharT, Traits, Allocator> &x, const CharT *s) { return !(x == s); }
...
//      ::s_compare(x.begin(), x.end(), s, s + n) < 0;
        ...
        template<class CharT, class Traits, class Allocator>
        inline bool
        operator<=(const CharT *s, const basic_string <CharT, Traits, Allocator> &y) { return !(y < s); }

        template<class CharT, class Traits, class Allocator>
        inline bool
        operator<=(const basic_string <CharT, Traits, Allocator> &x, const CharT *s) { return !(s < x); }
