    ...
    namespace container {
        ...
        namespace container_detail {
            ...
            public:
                ...
                static_storage_allocator(const static_storage_allocator &)

                BOOST_CONTAINER_NOEXCEPT {}

                static_storage_allocator &operator=(const static_storage_allocator &)

                BOOST_CONTAINER_NOEXCEPT {}

                T *internal_storage() const

                BOOST_CONTAINER_NOEXCEPT { return const_cast<T *>(static_cast<const T *>(static_cast<const void *>(&storage))); }

                T *internal_storage()

                BOOST_CONTAINER_NOEXCEPT { return static_cast<T *>(static_cast<void *>(&storage)); }
...
//!@tparam Capacity The maximum number of elements static_vector can store, fixed at compile time.
        ...
        public:
            ...
            //! @par Complexity
            //!   Linear O(N).
            static_vector (BOOST_RV_REF(static_vector)
