...
namespace boost {
    namespace iostreams {
        ...
        template<typename T>
        typename int_type_of<T>::type get(T &t) { return detail::read_device_impl<T>::get(detail::unwrap(t)); }
        ...
        std::streamsize
        read(T &t, Source &src, typename char_type_of<T>::type *s,
...
//------------------Definition of read_filter_impl----------------------------//
    ...
    struct read_filter_impl<multichar_tag> {
        ...
        static std::streamsize read
                (T &t, Source &src, typename char_type_of<T>::type *s, std::streamsize n) { return t.read(src, s, n); }
    };
