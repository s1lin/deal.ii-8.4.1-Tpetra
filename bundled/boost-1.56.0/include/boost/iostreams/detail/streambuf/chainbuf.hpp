...
//#endif
            ...
            translate(typename std_traits::int_type c) { return translate_int_type<std_traits, chain_traits>(c); }

            delegate_type &delegate() { return static_cast<delegate_type &>(chain_.front()); }
            ...
            struct sentry {
                sentry(chainbuf<Chain, Mode, Access> *buf) : buf_(buf) { buf_->set_pointers(); }
