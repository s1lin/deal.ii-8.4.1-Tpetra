...
namespace boost {
            ...
            namespace traits {
                ...
                namespace detail {
                    ...
                    struct value_type_is_substitute
                            : is_substitute<
                                    typename container_value<T>::type, typename container_value<Attribute>::type> {
                    };
    ...
    template<typename T, typename Attribute>
    struct is_substitute<T, Attribute, typename enable_if<
    ...
    struct has_kv_in_map
            : mpl::eval_if<
                    fusion::result_of::has_key < Map, Key>, mpl::apply<
                    is_substitute<
                            fusion::result_of::value_at_key < mpl::_1, Key>, Value>, Map>
    , mpl::false_> {
};
...
struct variant_kv
        : mpl::equal_to<
          ...
          mpl::size<mpl::filter_view < typename Variant::types, has_kv_in_map < mpl::_1, p_value, Attribute>>>
>
{
};
