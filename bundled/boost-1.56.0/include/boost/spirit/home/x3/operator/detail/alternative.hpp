...
namespace boost {
    namespace spirit {
        namespace x3 {
            ...
            struct pass_variant_attribute :
                    mpl::if_c<traits::has_attribute<Parser, Context>::value, pass_parser_attribute<Parser, Attribute, Context>, pass_variant_unused>::type {
            ...
            struct pass_variant_attribute<alternative<L, R>, Attribute, Context> :
                    mpl::if_c<traits::has_attribute<alternative<L, R>, Context>::value, pass_variant_used < Attribute>,
        ...
        typedef typename
        mpl::push_back<
                typename get_alternative_types<LL, LR, C>::type, typename traits::attribute_of<R, C>::type
        >::type
                type;
    };
    ...
    typedef typename
    mpl::push_front<
            typename get_alternative_types<RL, RR, C>::type, typename traits::attribute_of<L, C>::type
    >::type
            type;
};
...
typedef
mpl::joint_view<
        typename get_alternative_types<LL, LR, C>::type, typename get_alternative_types<RL, RR, C>::type
>
        type;
};
...
bool
parse_alternative(Parser const &p, Iterator &first, Iterator const &last, Context const &context, RContext &rcontext,
                  Attribute &attr) {
