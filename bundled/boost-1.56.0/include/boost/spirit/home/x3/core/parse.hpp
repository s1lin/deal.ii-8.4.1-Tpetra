...
namespace boost {
    namespace spirit {
        namespace x3 {
            ...
            inline bool
            parse_main(
                    Iterator &first, Iterator last, Parser const &p, Attribute &attr) {
            ...
            inline bool
            parse(
                    Iterator const &first_, Iterator last, Parser const &p, Attribute &attr) {
            ...
            inline bool
            parse(
                    Iterator &first, Iterator last, Parser const &p) {
            ...
            inline bool
            parse(
                    Iterator const &first_, Iterator last, Parser const &p) {
                Iterator first = first_;
                return parse_main(first, last, p, unused);
            }
            ...
            inline bool
            phrase_parse_main(
                    Iterator &first, Iterator last, Parser const &p, Skipper const &s, Attribute &attr,
            ...
            inline bool
            phrase_parse(
                    Iterator const &first_, Iterator last, Parser const &p, Skipper const &s, Attribute &attr,
                    skip_flag post_skip = skip_flag::post_skip) {
                Iterator first = first_;
                return phrase_parse_main(first, last, p, s, attr, post_skip);
            }
            ...
            inline bool
            phrase_parse(
                    Iterator &first, Iterator last, Parser const &p, Skipper const &s,
                    skip_flag post_skip = skip_flag::post_skip) {
            ...
            inline bool
            phrase_parse(
                    Iterator const &first_, Iterator last, Parser const &p, Skipper const &s,
                    skip_flag post_skip = skip_flag::post_skip) {
                Iterator first = first_;
                return phrase_parse_main(first, last, p, s, unused, post_skip);
            }
