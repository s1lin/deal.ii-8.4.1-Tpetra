...
namespace boost {
    namespace spirit {
        namespace x3 {
            ...
            template<
                    typename F, typename Iterator, typename Context, typename RuleContext, typename Attribute>
            auto call(
                    F f, Iterator &first, Iterator const &last, Context const &context, RuleContext &rcontext,
                    Attribute &attr) {
