    ...
    namespace spirit {
        namespace x3 {
            ...
            struct action : unary_parser<Subject, action<Subject, Action>> {
                ...
                bool call_action(
                        Iterator &first, Iterator const &last, Context const &context, RuleContext &rcontext,
                ...
                template<typename Iterator, typename Context, typename RuleContext, typename Attribute>
                bool parse_main(Iterator &first, Iterator const &last, Context const &context, RuleContext &rcontext,
                                Attribute &attr) const {
                    Iterator save = first;
                ...
                template<typename Iterator, typename Context, typename RuleContext>
                bool parse(Iterator &first, Iterator const &last, Context const &context, RuleContext &rcontext,
                           unused_type) const {
                    typedef typename
