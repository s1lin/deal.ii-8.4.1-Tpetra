        ...
        namespace x3 {
            ...
            struct symbols : parser<symbols<Char, T, Lookup, Filter>> {
                ...
                symbols(std::string const &name = "symbols")
                        : add(*this), remove(*this), lookup(new Lookup()), name_(name) {
                }
                ...
                value_type &at(Str const &str) {
                    return *lookup->add(traits::get_string_begin<Char>(str), traits::get_string_end<Char>(str), T());
                }
                ...
                value_type *find(Str const &str) {
                    return find_impl(traits::get_string_begin<Char>(str), traits::get_string_end<Char>(str));
                }
            ...
            public:
                ...
                struct adder {
                    ...
                    operator()(Str const &s, T const &val = T()) const {
                        sym.lookup->add(traits::get_string_begin<Char>(s), traits::get_string_end<Char>(s), val);
                        return *this;
                    }
                    ...
                    operator,(Str const &s) const {
                        sym.lookup->add(traits::get_string_begin<Char>(s), traits::get_string_end<Char>(s), T());
                        return *this;
                    }
                ...
                struct remover {
                    ...
                    remover const &
                    operator()(Str const &s) const {
                        sym.lookup->remove(traits::get_string_begin<Char>(s), traits::get_string_end<Char>(s));
                        return *this;
                    }
            ...
            struct get_info<symbols<Char, T, Lookup, Filter>> {
                ...
                result_type operator()(symbols<Char, T, Lookup, Filter
                > const &symbols) const {
                    return symbols.name();
                }
            };
