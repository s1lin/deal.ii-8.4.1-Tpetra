...
struct use_lazy_terminal<
        karma::domain, tag::char_code < tag::string, CharEncoding>
, 1 /*arity*/
> : mpl::true_ {
};
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct any_string
                ...
                generate(OutputIterator &sink, Context &context, Delimiter const &d,
                    ...
                    return
                            karma::detail::string_generate(sink, traits::extract_from<attribute_type>(attr, context),
                                                           char_encoding(), Tag()) &&
            ...
            struct literal_string
                ...
                bool generate(OutputIterator &sink, Context &context, Delimiter const &d, Attribute const &attr) const {
                    ...
                    if (!detail::string_compare(
                            get_c_string(
                                    traits::extract_from<attribute_type>(attr, context)), get_c_string(str_),
                            char_encoding(), Tag())) {
                        return false;
                    }
            ...
            typedef any_string<
                    typename spirit::detail::get_encoding_with_case<
                            Modifiers, CharEncoding, lower || upper>::type, typename detail::get_casetag<Modifiers,
                            lower || upper>::type
            > result_type;
        ...
        typedef literal_string<
                const_string, typename spirit::detail::get_encoding_with_case<
...
: detail::make_string_direct<
        typename traits::char_encoding_from_char<
                typename traits::char_type_of<A0>::type>::type, Modifiers, A0, true>
{
};
