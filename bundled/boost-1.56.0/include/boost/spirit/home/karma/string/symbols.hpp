    ...
    namespace spirit {
        namespace traits {
            ...
            struct symbols_lookup {
                ...
                typedef typename
                mpl::eval_if<traits::is_container<T>, traits::container_value<T>, sequence_type>::type type;
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            namespace detail {
                ...
                struct generate_encoded {
                    typedef typename
                    proto::terminal<tag::char_code < Tag, CharEncoding> >
                    ::type
                            encoding_type;
            ...
            struct symbols
                    ...
                    >::type, symbols<Attribute, T, Lookup, CharEncoding, Tag> >
            , primitive_generator <
        ...
        symbols(symbols<Attribute, T, Lookup, CharEncoding_, Tag_>
        const& syms)
        :
    ...
    template<typename CharEncoding_, typename Tag_>
    symbols &
            operator=(symbols < Attribute, T, Lookup, CharEncoding_, Tag_ >
    const& rhs) {
    *
    lookup = *rhs.lookup;
    name_ = rhs.name_;
...
struct symbols<Attribute, unused_type, Lookup, CharEncoding, Tag>
        ...
        >::type, symbols<Attribute, unused_type, Lookup, CharEncoding, Tag>
>
...
template<typename CharEncoding_, typename Tag_>
symbols(symbols<Attribute, unused_type, Lookup, CharEncoding_, Tag_>
const& syms)
:
...
template<typename CharEncoding_, typename Tag_>
symbols &
        operator=(symbols < Attribute, unused_type, Lookup, CharEncoding_, Tag_ >
const& rhs)
{
*
lookup = *rhs.lookup;
...
typedef typename mpl::if_c<
        lower || upper, symbols<
                Attribute, T, Lookup, typename spirit::detail::get_encoding_with_case<
                        Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                        lower || upper>::type>, reference_>::type
        result_type;
