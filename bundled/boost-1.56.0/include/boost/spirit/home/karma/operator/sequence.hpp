            ...
            struct base_sequence : nary_generator<Derived> {
                ...
                struct attribute {
                    ...
                    typedef typename traits::build_attribute_sequence<
                            Elements, Context, traits::sequence_attribute_transform, Iterator, karma::domain
                    >::type all_attributes;
                ...
                bool generate_impl(OutputIterator &sink, Context &ctx, Delimiter const &d, Attribute &attr_, Pred1,
                                   Pred2) const {
                ...
                bool generate_impl(OutputIterator &sink, Context &ctx, Delimiter const &d, Attribute const &attr_,
