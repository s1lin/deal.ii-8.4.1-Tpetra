        ...
        namespace traits {
            ...
            struct extract_from_attribute {
                ...
                typedef typename mpl::eval_if<
                        is_one_element_sequence, detail::value_at_c<Attribute, 0>, mpl::identity<Attribute const&>
                >
                ::type type;
            ...
            template<typename Context>
            static type call(reference_wrapper < Attribute >
            const& attr,
            Context &ctx
            ) {
            return
            extract_from<Exposed>(attr
            .
