...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            format_delimited(
                    Expr const &expr, Delimiter const &d, BOOST_SCOPED_ENUM(delimit_flag) pre_delimit =
            ...
            format_delimited(
                    Expr const &xpr, Delimiter const &d, BOOST_SCOPED_ENUM(delimit_flag) pre_delimit,
