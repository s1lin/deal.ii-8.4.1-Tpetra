        ...
        namespace karma {
            ...
            struct any_stream_generator
                ...
                static bool generate(
                        ...
                        > &sink, Context &context, Delimiter const &d, Attribute const &attr) {
            ...
            struct make_stream {
                ...
                typedef any_stream_generator<
                        Char, typename spirit::detail::get_encoding_with_case<
            ...
            struct make_any_stream {
                ...
                typedef lit_stream_generator<
                        const_attribute, Char, typename spirit::detail::get_encoding_with_case<
                                Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                                lower || upper>::type
                > result_type;
