        ...
        namespace karma {
            namespace detail {
                ...
                struct format_manip {
                    ...
                    format_manip(Expr const &xpr, Delimiter const &d, BOOST_SCOPED_ENUM(delimit_flag) pre_delimit,
                                 Attribute const &a)
            ...
            struct format_delimited<Expr, Delimiter, typename enable_if<
                    traits::matches < karma::domain, Expr> >::type> {
