...
struct use_terminal<karma::domain, terminal_ex < tag::stateful_tag < Policies, tag::bool_, T>
, fusion::vector1 <A0> > >
: mpl::true_ {
};
            ...
            namespace detail {
                ...
                struct make_bool_literal {
                    ...
                    typedef literal_bool_generator<
                            bool, typename spirit::detail::get_encoding_with_case<
                                    Modifiers, unused_type,
                                    lower || upper>::type, typename detail::get_casetag<Modifiers,
                                    lower || upper>::type, bool_policies<>, false
                    > result_type;
            ...
            struct make_bool_direct {
                ...
                typedef literal_bool_generator<
                        T, typename spirit::detail::get_encoding_with_case<
                                ...
                                lower || upper>::type, Policies, false
                > result_type;
...
namespace detail {
    ...
    struct basic_bool_literal {
        ...
        typedef literal_bool_generator<
                bool, typename spirit::detail::get_encoding_with_case<
                        Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                        lower || upper>::type, bool_policies<>, true
        > result_type;
