...
struct use_terminal<karma::domain, terminal_ex < tag::int_generator < T, Radix, force_sign>
, fusion::vector1 <A0> >
> : mpl::true_ {
};
...
struct use_lazy_terminal<
        karma::domain, tag::int_generator < T, Radix, force_sign>
, 1 // arity
> : mpl::true_ {
};
        ...
        namespace karma {
            ...
            private:
                ...
                static bool insert_int(OutputIterator &sink, Attribute const &attr) {
                    return sign_inserter::call(sink, traits::test_zero(attr), traits::test_negative(attr),
                                               force_sign) &&
            ...
            namespace detail {
                ...
                struct make_int {
                    ...
                    typedef any_int_generator<
                            T, typename spirit::detail::get_encoding_with_case<
                                    Modifiers, unused_type,
                                    lower || upper>::type, typename detail::get_casetag<Modifiers,
                                    lower || upper>::type, Radix, force_sign
                    > result_type;
                ...
                struct make_int_direct {
                    ...
                    typedef literal_int_generator<
                            T, typename spirit::detail::get_encoding_with_case<
                                    Modifiers, unused_type,
                                    lower || upper>::type, typename detail::get_casetag<Modifiers,
                                    lower || upper>::type, Radix, force_sign, false
                    > result_type;
    ...
    struct basic_int_literal {
        ...
        typedef literal_int_generator<
                T, typename spirit::detail::get_encoding_with_case<
                        ...
                        lower || upper>::type, 10, false, true
        > result_type;
...
typedef literal_int_generator<
        typename remove_const<A0>::type, typename spirit::detail::get_encoding_with_case<
                Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                lower || upper>::type, 10, false, true
> result_type;
