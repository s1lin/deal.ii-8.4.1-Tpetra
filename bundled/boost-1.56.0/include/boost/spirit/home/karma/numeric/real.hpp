...
struct use_terminal<karma::domain, terminal_ex < tag::stateful_tag < Policies, tag::double_, T>
, fusion::vector1 <A0> > >
: mpl::true_ {
};
...
struct use_lazy_terminal<
        karma::domain, tag::stateful_tag < Policies, tag::double_, T>
, 1 // arity
> : mpl::true_ {
};
            ...
            namespace detail {
                ...
                struct make_real {
                    ...
                    typedef any_real_generator<
                            T, Policies, typename spirit::detail::get_encoding_with_case<
                                    Modifiers, unused_type,
                                    lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type
                    > result_type;
...
namespace detail {
    ...
    struct basic_real_literal {
        ...
        typedef literal_real_generator<
                T, real_policies<T>, typename spirit::detail::get_encoding_with_case<
                        Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                        lower || upper>::type, true
        > result_type;
...
typedef literal_real_generator<
        typename remove_const<A0>::type, real_policies<A0>, typename spirit::detail::get_encoding_with_case<
                Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers,
                lower || upper>::type, true
> result_type;
