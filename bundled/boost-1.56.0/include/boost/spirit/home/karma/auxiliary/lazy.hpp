    ...
    namespace spirit {
        namespace karma {
            ...
            namespace detail {
                ...
                bool
                lazy_generate_impl(Generator const &g, OutputIterator &sink, Context &context, Delimiter const &delim,
                ...
                template<typename Generator, typename OutputIterator, typename Context, typename Delimiter, typename Attribute>
                bool lazy_generate_impl_main(Generator const &g, OutputIterator &sink, Context &context,
            ...
            struct lazy_generator : generator<lazy_generator<Function, Modifiers> > {
                ...
                info what(Context &context) const {
                    return info("lazy", compile<karma::domain>(func(unused, context),
            ...
            struct lazy_directive
                ...
                bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d, Attribute const &attr) const {
                    return detail::lazy_generate_impl_main(compile<karma::domain>(
                            proto::make_expr<proto::tag::subscript>(
                                    function(unused, ctx), subject), karma_modify()(tag::lazy_eval(), modifiers)), sink,
                                                           ctx, d, attr);
                }
                ...
                info what(Context &ctx) const {
                    return info("lazy-directive", compile<karma::domain>(
                            proto::make_expr<proto::tag::subscript>(
                                    function(unused, ctx), subject), karma_modify()(tag::lazy_eval(), modifiers))
                            .what(ctx)
                    );
                }
            ...
            typedef lazy_generator<phoenix::actor < Eval>, Modifiers>
            result_type;
