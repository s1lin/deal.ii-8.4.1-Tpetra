...
namespace boost {
    ...
    static void
            call(lex::lexertl::token < Iterator, mpl::vector0<>, HasState, Idtype >
    const& t
    ,
    Attribute &attr
    ) {
...
{
static void
        call(lex::lexertl::token < Iterator, mpl::vector<>, HasState, Idtype >
const& t
,
Attribute &attr
)
...
{
static void
        call(lex::lexertl::token < Iterator, lex::omit, HasState, Idtype >
const& t
,
Attribute &attr
)
...
{
static void
        call(lex::lexertl::token < Iterator, AttributeTypes, HasState, Idtype >
const& t
,
