...
namespace boost {
    namespace spirit {
        namespace lex {
            ...
            position_token(id_type
            id,
            std::size_t state, token_value_type
            const& v)
            :
            base_type(id, state, unused
            ),
...
namespace detail {
    ...
    struct position_token_value_typesequence {
        typedef typename mpl::insert<
                AttributeTypes, typename mpl::begin<AttributeTypes>::type, IteratorPair
        >::type sequence_type;
        ...
        namespace traits {
            ...
            struct assign_to_attribute_from_value<Attribute, lex::lexertl::position_token<Iterator, AttributeTypes, HasState, Idtype> > {
                ...
                call(lex::lexertl::position_token<
                        Iterator, AttributeTypes, HasState, Idtype> const &t, Attribute &attr) {
            ...
            struct assign_to_attribute_from_value<Attribute, lex::lexertl::position_token<Iterator, mpl::vector0<>, HasState, Idtype> > {
                static void
                call(lex::lexertl::position_token<
                        Iterator, mpl::vector0<>, HasState, Idtype> const &t, Attribute &attr) {
...
//     {};
            ...
            struct assign_to_attribute_from_value<Attribute, lex::lexertl::position_token<Iterator, mpl::vector<>, HasState, Idtype> > {
                static void
                call(lex::lexertl::position_token<
                        Iterator, mpl::vector<>, HasState, Idtype> const &t, Attribute &attr) {
                    //  The default type returned by the token_def parser component (if
                    //  it has no token value type assigned) is the pair of iterators
                    //  to the matched character sequence.
                    spirit::traits::assign_to(t.begin(), t.end(), attr);
...
//     {};
            ...
            struct assign_to_attribute_from_value<Attribute, lex::lexertl::position_token<Iterator,
                    mpl::vector1 < Attr>, HasState, Idtype> > {
            static void
                    call(lex::lexertl::position_token <
...
{
static void
        call(lex::lexertl::position_token < Iterator, lex::omit, HasState, Idtype >
const& t
,
Attribute &attr
)
...
{
static void
        call(lex::lexertl::position_token < Iterator, AttributeTypes, HasState, Idtype >
const& t
,
