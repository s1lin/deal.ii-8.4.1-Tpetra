    ...
    namespace spirit {
        namespace lex {
            namespace lexertl {
                ...
                bool generate_static(Lexer const &, std::basic_ostream<typename Lexer::char_type> &,
                ...
                private:
                    ...
                    struct iterator_data_type {
                        ...
                        iterator_data_type(
                                ...
                                boost::lexer::basic_rules<char_type> const &rules, semantic_actions_type const &actions)
                ...
                public:
                    ...
                    //  tokens.
                    iterator_type
                    begin(Iterator &first, Iterator const &last, char_type const *initial_state = 0) const {
...
//                 std::swap(rules, rules_);
                ...
                private:
                    ...
                    template<typename Lexer, typename F>
                    friend bool generate_static(Lexer const &, std::basic_ostream<typename Lexer::char_type> &,
                                                typename Lexer::char_type const *, F);
                };
