            ...
            namespace lexertl {
                namespace detail {
                    ...
                    struct wrap_action {
                        ...
                        template<typename F>
                        static void arg4_action(F *f, Iterator &start, Iterator &end, BOOST_SCOPED_ENUM(pass_flags) &
                        ...
                        template<typename F>
                        static void arg3_action(F *f, Iterator &start, Iterator &end, BOOST_SCOPED_ENUM(pass_flags) &
                        ...
                        static FunctionType call(void (*f)(A0, A1, A2)) {
                            void(*pf)
                            (void(*)(A0, A1, A2), Iterator &, Iterator &
                        ...
                        static void arg2_action(F *f, Iterator &start, Iterator &end,
                                                BOOST_SCOPED_ENUM(pass_flags) &, IdType, Context
