...
//                 }
                ...
                public:
                    ...
                    lexer_def_(LexerDef &def_, string_type const &state_,
                            ...
                            : proto_base_type(terminal_type::make(alias())), add(this_()), add_pattern(this_()),
                    ...
                    lexer_def_
                    operator()(string_type const &state, string_type const &targetstate = string_type()) const {
                        return lexer_def_(def, state, targetstate);
                    }
