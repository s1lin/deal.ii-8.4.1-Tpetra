    ...
    namespace spirit {
        namespace lex {
            ...
            inline typename expression::lookahead<
                    typename phoenix::as_actor<T>::type, typename phoenix::as_actor<std::size_t>::type
            >::type const
            ...
            inline typename expression::lookahead<
                    typename phoenix::as_actor<Idtype>::type, typename phoenix::as_actor<std::size_t>::type
            >::type const
                    lookahead(token_def < Attribute, Char, Idtype >
            const& tok) {
            ...
            // lexer.
            BOOST_ASSERT(std::size_t(~0)
            != state &&
            "token_def instance not associated with lexer yet");

            return
            expression::lookahead<id_actor_type, state_actor_type>::make(
        ...
        ///////////////////////////////////////////////////////////////////////////
        inline BOOST_SCOPED_ENUM(pass_flags)
