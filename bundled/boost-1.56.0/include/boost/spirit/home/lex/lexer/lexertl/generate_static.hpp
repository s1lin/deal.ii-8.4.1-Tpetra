        ...
        namespace lex {
            namespace lexertl {
                namespace detail {
                    ...
                    template<typename Char>
                    inline bool
                    generate_cpp_state_table(std::basic_ostream <Char> &os_, Char const *name_suffix, bool bol,
                                             bool eol) {
                    ...
                    generate_cpp(boost::lexer::basic_state_machine<Char> const &sm_,
                                 boost::lexer::basic_rules<Char> const &rules_, std::basic_ostream <Char> &os_,
                                 Char const *name_suffix, F generate_function_body) {
...
//         std::size_t const lookups_ = sm_.data()._lookup->front()->size();
                        ...
                        if (!generate_cpp_state_table<Char>(os_, name_suffix, sm_.data()._seen_BOL_assertion,
                ...
                inline bool
                generate_static(Lexer const &lexer, std::basic_ostream<typename Lexer::char_type> &os,
                ...
                template<typename Lexer>
                inline bool
                generate_static_dfa(Lexer const &lexer, std::basic_ostream<typename Lexer::char_type> &os,
                                    typename Lexer::char_type const *name_suffix =
                                    detail::L<typename Lexer::char_type>()) {
                    return generate_static(lexer, os, name_suffix,
                                           &detail::generate_function_body_dfa<typename Lexer::char_type>);
                ...
                template<typename Lexer>
                inline bool
                generate_static_switch(Lexer const &lexer, std::basic_ostream<typename Lexer::char_type> &os,
                                       typename Lexer::char_type const *name_suffix =
                                       detail::L<typename Lexer::char_type>()) {
                    return generate_static(lexer, os, name_suffix,
