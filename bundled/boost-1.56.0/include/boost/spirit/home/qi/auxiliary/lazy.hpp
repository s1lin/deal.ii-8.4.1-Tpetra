...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            namespace detail {
                ...
                bool lazy_parse_impl(Parser const &p, Iterator &first, Iterator const &last, Context &context,
                                     Skipper const &skipper, Attribute &attr, mpl::false_) {
                    return p.parse(first, last, context, skipper, attr);
                }

                template<typename Parser, typename Iterator, typename Context, typename Skipper, typename Attribute>
                bool lazy_parse_impl(Parser const &p, Iterator &first, Iterator const &last, Context &context,
                                     Skipper const &skipper, Attribute & /*attr*/, mpl::true_) {
                ...
                template<typename Parser, typename Iterator, typename Context, typename Skipper, typename Attribute>
                bool lazy_parse_impl_main(Parser const &p, Iterator &first, Iterator const &last, Context &context,
            ...
            struct lazy_directive
                ...
                struct attribute {
                    ...
                    proto::result_of::make_expr<
                            proto::tag::subscript, directive_expr_type, Subject
                    >::type
                            expr_type;
                ...
                lazy_directive(
                        Function const &function_, Subject const &subject_, Modifiers const &modifiers_)
                ...
                bool parse(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                    ...
                    return detail::lazy_parse_impl_main(compile<qi::domain>(
                            proto::make_expr<proto::tag::subscript>(
                                    function(unused, context), subject), qi_modify()(tag::lazy_eval(), modifiers)),
                                                        first, last, context, skipper, attr);
                }
            ...
            typedef lazy_parser<phoenix::actor < Eval>, Modifiers>
            result_type;
            result_type operator()(phoenix::actor < Eval >
            const& f
            ,
            Modifiers const &modifiers
            ) const {
            return
            result_type(f, modifiers
            );
        }
    };
    ...
    struct make_directive<lazy_terminal<Terminal, Actor, Arity>, Subject, Modifiers> {
        ...
        result_type operator()(
                lazy_terminal<Terminal, Actor, Arity> const &lt, Subject const &subject,
        ...
        namespace traits {
            ...
            struct handles_container<
                    ...
                    : handles_container<
                            ...
                            attribute<Context, Iterator>::parser_type, Attribute, Context, Iterator> {
            };
