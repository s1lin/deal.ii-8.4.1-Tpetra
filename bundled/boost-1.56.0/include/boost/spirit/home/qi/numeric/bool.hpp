...
struct use_terminal<qi::domain, terminal_ex < tag::stateful_tag < BoolPolicies, tag::bool_, T>
, fusion::vector1 <A0> > >
: mpl::true_ {
};
...
struct use_lazy_terminal<
        qi::domain, tag::stateful_tag < BoolPolicies, tag::bool_, T>
, 1 // arity
> : mpl::true_ {
};
}}
        ...
        namespace qi {
            ...
            namespace detail {
                ...
                struct bool_impl {
                    ...
                    static bool parse(Iterator &first, Iterator const &last, Attribute &attr, BoolPolicies const &p,
                                      bool allow_true = true, bool disallow_false = false) {
                        if (first == last)
                            return false;
            ...
            struct make_direct_bool {
                ...
                , literal_bool_parser<T, Policies, false> >
                ::type
                        result_type;
            ...
            struct make_literal_bool {
                ...
                , literal_bool_parser<T, Policies> >
                ::type
                        result_type;
