            ...
            struct sequence_base // this class is shared by sequence and expect
                ...
                struct attribute {
                    ...
                    typedef typename traits::build_attribute_sequence<
                            Elements, Context, traits::sequence_attribute_transform, Iterator, qi::domain
                    >::type all_attributes;
                ...
                bool parse_impl(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                    ...
                    if (spirit::any_if(elements, attr_local, Derived::fail_function(iter, last, context, skipper),
                                       predicate()))
                        return false;
                    first = iter;
                    return true;
