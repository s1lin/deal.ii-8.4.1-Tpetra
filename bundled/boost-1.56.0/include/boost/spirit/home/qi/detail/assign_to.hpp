...
namespace boost {
    ...
    struct assign_to_attribute_from_value {
        ...
        typedef typename mpl::eval_if<
                is_one_element_sequence, fusion::result_of::at_c < Attribute, 0>
...
template<typename Attribute, typename T>
struct assign_to_attribute_from_value<Attribute, boost::optional<T>, typename disable_if<
        is_same < Attribute, boost::optional<T> > >::type>
{
static void
...
template<typename Attribute, typename T>
struct assign_to_container_from_value<Attribute, boost::optional<T>, typename disable_if<
        is_same < Attribute, boost::optional<T> > >::type>
{
static void
call(boost::optional<T> const &val, Attribute &attr) {
