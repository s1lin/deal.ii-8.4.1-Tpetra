...
struct use_lazy_terminal<                           // and char_("a-z0-9")
        qi::domain, tag::char_code < tag::char_, CharEncoding>
, 1 // arity
> : mpl::true_ {
};
...
namespace boost {
    namespace spirit {
            ...
            namespace detail {
                ...
                struct basic_literal {
                    ...
                    static bool const no_attr =
                            !has_modifier<
                                    Modifiers, tag::lazy_eval
                            >::value;

                    typedef literal_char<
                            typename spirit::detail::get_encoding_with_case<
                                    Modifiers, Encoding, no_case>::type, no_attr, no_case>
                            result_type;
        ...
        , Modifiers> {
        static bool const no_case =
                has_modifier < Modifiers, tag::char_code_base<tag::no_case>
        >::value;
    ...
    typedef literal_char<
            typename spirit::detail::get_encoding_with_case<
                    Modifiers, encoding, no_case>::type, true, no_case>
            result_type;
