    ...
    namespace spirit {
        namespace qi {
            ...
            struct no_skip_directive : unary_parser<no_skip_directive<Subject> > {
                ...
                typename disable_if<detail::is_unused_skipper < Skipper>, bool>

                ::type
                parse(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                      Attribute &attr_) const {
                    return subject.parse(first, last, context, detail::unused_skipper<Skipper>(skipper), attr_);
                }

                template<typename Iterator, typename Context, typename Skipper, typename Attribute>
                typename enable_if<detail::is_unused_skipper < Skipper>, bool>
