...
namespace boost {
    namespace spirit {
        ...
        struct f_chlit : public char_parser<f_chlit<ChGenT> > {
            ...
            template<typename T>
            bool test(T ch) const { return ch == chgen(); }
        ...
        f_ch_p(ChGenT chgen) { return f_chlit<ChGenT>(chgen); }
        ...
        f_range_p(ChGenAT first, ChGenBT last) { return f_range<ChGenAT, ChGenBT>(first, last); }
        ...
        f_chseq_p(IterGenAT first, IterGenBT last) { return f_chseq<IterGenAT, IterGenBT>(first, last); }
        ...
        f_str_p(IterGenAT first, IterGenBT last) { return f_strlit<IterGenAT, IterGenBT>(first, last); }
