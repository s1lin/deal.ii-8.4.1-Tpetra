...
////////////////////////////////////////
            ...
            struct default_case {
                ...
                template<typename ParserT>
                static type
                get(parser <ParserT> const &p) { return get_default_parser<type, CaseT::is_default>::get(p); }
            };
...
//  of the case parser chain.
            ...
            struct default_case<CaseT, true> {
                ...
                template<typename ParserT>
                static type
                get(parser <ParserT> const &p) { return get_default_parser_simple<type, value>::get(p); }
            };
...
//  chain.
            ...
            struct chain_parser {
                ...
                static left_t
                left(CaseT const &p) { return chain_parser<Depth - 1, our_left_t>::left(p.left()); }

                static right_t
                right(CaseT const &p) { return chain_parser<Depth - 1, our_left_t>::right(p.left()); }
            };
...
///////////////////////////////////////////////////////////////////////////////
            ...
            compound_case_parser(parser<LeftT>
            const &lhs,
            parser <RightT> const &rhs
            )
            :
            base_t(lhs
            .
