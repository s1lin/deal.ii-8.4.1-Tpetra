...
#pragma warning(disable:4512) //assignment operator could not be generated
    ...
    struct actor : public BaseT {
        ...
        template<typename A>
        typename actor_result<BaseT, tuple < A & > >

        ::type
        operator()(A &a) const;

        template<typename A, typename B>
        typename actor_result<BaseT, tuple < A & , B &> >

        ::type
        operator()(A &a, B &b) const;

        template<typename A, typename B, typename C>
        typename actor_result<BaseT, tuple < A & , B &, C &> >
...
//////////////////////////////////
    template<typename BaseT>
    template<typename A>
    inline typename actor_result<BaseT, tuple < A & > >
...
//////////////////////////////////
    template<typename BaseT>
    template<typename A, typename B>
    inline typename actor_result<BaseT, tuple < A & , B &> >
...
//////////////////////////////////
    template<typename BaseT>
    template<typename A, typename B, typename C>
    inline typename actor_result<BaseT, tuple < A & , B &, C &> >
