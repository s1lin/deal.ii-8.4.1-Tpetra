...
for (
const_tree_iterator it = node.children.begin();
it !=
end;
++it)
{
if (
find_node (*it, node_to_search, found_node
))
return true;
}
}
...
{
if (
impl::get_node_range<T>(it, node_to_search, nodes
))
return true;
}
}
