...
//////////////////////////////////
        ...
        namespace impl {
            ...
            struct grammar_helper_list {
                ...
                grammar_helper_list(grammar_helper_list const & /*x*/) {   // Does _not_ copy the helpers member !
                }

                grammar_helper_list &operator=(grammar_helper_list const &x) {   // Does _not_ copy the helpers member !
                    return *this;
                }
                ...
                size() const { return helpers.size(); }

                typename vector_t::reverse_iterator
                rbegin() { return helpers.rbegin(); }

                typename vector_t::reverse_iterator
                rend() { return helpers.rend(); }
            ...
            struct grammar_helper : private grammar_helper_base<GrammarT> {
                ...
                grammar_helper(helper_weak_ptr_t &p)
                        : definitions_cnt(0), self(this_()) { p = self; }
...
# endif
            ...
            public:
                ...
                parse_main(ScannerT const &scan) const { return impl::grammar_parser_parse<N>(&target_grammar, scan); }
