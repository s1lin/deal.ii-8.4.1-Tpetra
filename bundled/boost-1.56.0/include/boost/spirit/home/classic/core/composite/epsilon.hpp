...
///////////////////////////////////////////////////////////////////////////////
        ...
        struct condition_parser : parser<condition_parser<CondT, positive_> > {
            ...
            negate() const { return condition_parser<CondT, !positive_>(cond); }
    ...
    BOOST_WORKAROUND(__SUNPRO_CC, <= 0x580)
        ...
        operator~(condition_parser<CondT, positive> const &p) { return p.negate(); }
...
///////////////////////////////////////////////////////////////////////////////
        ...
        explicit empty_match_parser(SubjectT
        const& p) :
        base_t(p) {}
        ...
        negate() const { return negated_empty_match_parser<SubjectT>(this->subject()); }
    };
    ...
    explicit negated_empty_match_parser(SubjectT
    const& p) :
    base_t(p) {}
    ...
    negate() const { return empty_match_parser<SubjectT>(this->subject()); }
};
...
struct empty_match_parser_gen {
    ...
    generate(parser <SubjectT> const &subject) { return empty_match_parser<SubjectT>(subject.derived()); }
};
...
struct negated_empty_match_parser_gen {
    ...
    generate(parser <SubjectT> const &subject) { return negated_empty_match_parser<SubjectT>(subject.derived()); }
};

//////////////////////////////
template<typename SubjectT>
inline negated_empty_match_parser <SubjectT>
        operator~(empty_match_parser < SubjectT >
const& p)
{
return p.
...
inline empty_match_parser <SubjectT>
        operator~(negated_empty_match_parser < SubjectT >
const& p)
{
return p.
...
struct epsilon_parser : public parser<epsilon_parser> {
    ...
    template<typename ScannerT>
    typename parser_result<self_t, ScannerT>::type
    parse(ScannerT const &scan) const { return scan.empty_match(); }
