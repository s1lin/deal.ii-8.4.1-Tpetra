...
static typename container_iterator<container_type>::type
        call(fusion::extension::adt_attribute_proxy < T, N, Const >
const& c)
{
return c.
...
static bool
        is_valid(fusion::extension::adt_attribute_proxy < T, N, Const >
const& val)
{
return
has_optional_value(val
.
...
{
return
attribute_size<embedded_type>::call(val
.
