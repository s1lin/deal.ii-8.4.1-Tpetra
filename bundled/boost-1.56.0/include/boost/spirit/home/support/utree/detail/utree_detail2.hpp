...
namespace boost {
    namespace spirit {
        ...
        inline utree::utree(basic_string < Base, type_ >
        const& bin) {
        s.
    ...
    template<typename Base, utree_type::info type_>
    inline utree &utree::operator=(basic_string < Base, type_ >
    const& bin) {
    free();
...
template<typename F>
typename boost::result_of< F(utree const &)
...
template<typename F>
typename boost::result_of< F(utree const &, utree const &)
...
template<typename F>
typename boost::result_of< F(utree const &, utree &)
...
template<typename F>
typename boost::result_of< F(utree &, utree const &)
...
inline utree::reference get(utree::reference ut, utree::size_type i) { return detail::index_impl::apply(ut, i); }

inline utree::const_reference
get(utree::const_reference ut, utree::size_type i) { return detail::index_impl::apply(ut, i); }
...
struct utree_cast {
    ...
    To operator()(From const &val) const {
        ...
        typedef typename boost::mpl::eval_if<
                is_iterator_range<To>, boost::is_same<From, To>, boost::is_convertible<From, To>
        >::type is_convertible;
