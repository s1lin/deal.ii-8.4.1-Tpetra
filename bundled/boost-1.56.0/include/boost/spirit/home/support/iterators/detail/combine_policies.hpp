    ...
    namespace spirit {
        namespace iterator_policies {
            ...
            struct multi_pass_unique<T, Ownership, Checking, Input, Storage, false, false, true>
                ...
                template<typename MultiPass>
                inline static void advance_input(MultiPass &mp) { Input::advance_input(mp); }

                template<typename MultiPass>
                inline static typename MultiPass::reference get_input(MultiPass &mp) { return Input::get_input(mp); }

                template<typename MultiPass>
                inline static bool input_at_eof(MultiPass const &mp) { return Input::input_at_eof(mp); }
            ...
            struct multi_pass_unique<T, Ownership, Checking, Input, Storage, false, true, false>
                ...
                template<typename MultiPass>
                inline static void docheck(MultiPass const &mp) { Checking::docheck(mp); }
            };
            ...
            struct multi_pass_unique<T, Ownership, Checking, Input, Storage, true, false, false>
                ...
                template<typename MultiPass>
                inline static void clone(MultiPass &mp) { Ownership::clone(mp); }

                template<typename MultiPass>
                inline static bool release(MultiPass &mp) { return Ownership::release(mp); }

                template<typename MultiPass>
                inline static bool is_unique(MultiPass const &mp) { return Ownership::is_unique(mp); }
            };
            ...
            struct default_policy {
                ...
                template<typename T>
                struct unique
                        : multi_pass_unique<T, typename Ownership::unique, typename Checking::unique, typename Input::BOOST_NESTED_TEMPLATE unique<T>, typename Storage::BOOST_NESTED_TEMPLATE unique<
                    ...
                    typedef typename Input::BOOST_NESTED_TEMPLATE unique
                    <T>
                            input_policy;
                ...
                template<typename T>
                struct shared
                        : multi_pass_shared<T, typename Ownership::shared, typename Checking::shared, typename Input::BOOST_NESTED_TEMPLATE shared<T>, typename Storage::BOOST_NESTED_TEMPLATE shared<
                                typename Input::BOOST_NESTED_TEMPLATE unique<T>::value_type> > {
                    typedef typename Ownership::shared ownership_policy;
                    typedef typename Checking::shared checking_policy;
                    typedef typename Input::BOOST_NESTED_TEMPLATE shared
                    <T>
                            input_policy;
