    ...
    namespace spirit {
        ...
        namespace detail {
            ...
            any_ns(First1 const &first1, First2 const &first2, Last const &last, F &f, mpl::false_) {
                return (0 != (f(*first1, *first2) |
                              detail::any_ns(
                                      fusion::next(first1), fusion::next(first2), last, f, fusion::result_of::equal_to<
            ...
            any_ns(First const &first, Last const &last, F &f, mpl::false_) {
                return (0 != (f(*first) |
                              detail::any_ns(
                                      fusion::next(first), last, f, fusion::result_of::equal_to<
        ...
        any_ns(Sequence1 const &seq1, Sequence2 &seq2, F f) {
            return detail::any_ns(
                    fusion::begin(seq1), fusion::begin(seq2), fusion::end(seq1), f, fusion::result_of::equal_to<
