        ...
        namespace detail {
            ...
            namespace result_of {
                ...
                struct attribute_next {
                    ...
                    typedef typename
                    mpl::eval_if<
                            pred, fusion::result_of::next < Iterator2>
            ...
            namespace result_of {
                ...
                struct attribute_value {
                    ...
                    typedef typename
                    mpl::eval_if<
                            pred, fusion::result_of::deref < Iterator2>
            ...
            template<
                    typename Pred, typename First1, typename Last1, typename First2, typename Last2, typename F>
            inline bool
            any_if(First1 const &first1, First2 const &first2, Last1 const &last1, Last2 const &last2, F &f,
                   mpl::false_) {
                ...
                return f(*first1, attribute) ||
                       detail::any_if<Pred>(
                               fusion::next(first1), attribute_next<Pred, First1, Last2>(first2), last1, last2, f,
