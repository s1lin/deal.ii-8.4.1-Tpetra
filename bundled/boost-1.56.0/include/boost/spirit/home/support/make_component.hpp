        ...
        namespace detail {
            ...
            struct make_terminal_impl
                ...
                result_type operator()(
                        ...
                        typename make_terminal_impl::state_param /*state*/, typename make_terminal_impl::data_param data
                ) const {
...
struct make_unary : proto::transform<make_unary<Domain, Tag, Grammar> > {
    ...
    struct impl : proto::transform_impl<Expr, State, Data> {
        ...
        result_type operator()(
                typename impl::expr_param expr, typename impl::state_param state, typename impl::data_param data
        ) const {
            return typename impl::make_component_()(
                    detail::make_cons(
                            Grammar()(proto::child(expr), state, data)), data
            );
        }
    };
};
...
struct make_binary {
    ...
    struct impl : proto::transform_impl<Expr, State, Data> {
        ...
        typedef typename
        result_of::make_cons<
                lhs_component, typename result_of::make_cons<rhs_component>::type
        >::type
                elements_type;
...
struct make_directive : proto::transform<make_directive<Domain, Grammar> > {
    ...
    struct impl : proto::transform_impl<Expr, State, Data> {
        ...
        typedef typename Grammar::
        template result<Grammar(
                typename proto::result_of::child_c<Expr, 1>::type, State, modifier_type
        )>::type
                rhs_component;

        typedef typename
        result_of::make_cons<
                tag_type, typename result_of::make_cons<rhs_component>::type
        >::type
                elements_type;
...
struct make_action : proto::transform<make_action<Domain, Grammar> > {
    ...
    struct impl : proto::transform_impl<Expr, State, Data> {
        typedef typename Grammar::
        template result<Grammar(
                typename proto::result_of::child_c<Expr, 0>::type, State, Data
        )>::type
                lhs_component;
        ...
        typename mpl::eval_if_c<
                ...
                >::type::value, proto::result_of::child_c < Expr, 1>
        ...
        result_type operator()(
            ...
            return
                    (*this)(
                            expr, state, data, typename phoenix::is_actor<
                                    typename proto::result_of::child_c<Expr, 1>::type
                            >::type()
                    );
        }
