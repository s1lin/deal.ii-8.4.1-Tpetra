    ...
    namespace spirit {
        ...
        struct make_lazy<F, A0> {
            ...
            operator()(F f, A0 const &_0_) const {
                ...
                return result_type::make(child_type(
                        phoenix::detail::expression::function_eval<F, A0>::make(f, _0_), f.proto_base().child0
                ));
            }
        };
        ...
        struct make_lazy<F, A0, A1> {
            ...
            operator()(F f, A0 const &_0_, A1 const &_1_) const {
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(child_type(
                        phoenix::detail::expression::function_eval<F, A0, A1>::make(f, _0_, _1_), f.proto_base().child0
                ));
            }
        };
        ...
        struct terminal
                ...
                proto::terminal<
                        terminal_ex<
                                Terminal, typename detail::result_of::make_vector<
                                        typename detail::to_nonlazy_arg<A0>::type, typename detail::to_nonlazy_arg<A1>::type, typename detail::to_nonlazy_arg<A2>::type>::type>
                >::type
                        type;
            };
            ...
            struct result_helper<true, A0, A1, A2> {
                typedef typename
                make_lazy<this_type, typename detail::to_lazy_arg<A0>::type, typename detail::to_lazy_arg<A1>::type, typename detail::to_lazy_arg<A2>::type>::type
                        type;
            };
            ...
            struct result {
                typedef typename
                result_helper<
                        detail::contains_actor<A0, A1, A2>::value, A0, A1, A2
                >::type
                        type;
            };
            ...
            struct result<This(A0)> {
                typedef typename
                result_helper<
                        detail::contains_actor<A0, unused_type, unused_type>::value, A0, unused_type, unused_type
                >::type
                        type;
            };
            ...
            struct result<This(A0, A1)> {
                typedef typename
                result_helper<
                        detail::contains_actor<A0, A1, unused_type>::value, A0, A1, unused_type
                >::type
                        type;
            };
            ...
            operator()(A0 const &_0_, typename detail::contains_actor<A0>::is_false = 0) const {
                typedef typename result<A0>::type result_type;
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(
                        child_type(
                                detail::make_vector(_0_), this->proto_base().child0)
                );
            }
            ...
            operator()(A0 const &_0_, A1 const &_1_, typename detail::contains_actor<A0, A1>::is_false = 0) const {
                ...
                return result_type::make(
                        child_type(
                                detail::make_vector(_0_, _1_), this->proto_base().child0)
                );
            }
            ...
            operator()(A0 const &_0_, A1 const &_1_, A2 const &_2_,
                ...
                return result_type::make(
                        child_type(
                                detail::make_vector(_0_, _1_, _2_), this->proto_base().child0)
                );
            }
            ...
            template<typename A0>
            typename result<A0>::type
            operator()(A0 const &_0_, typename detail::contains_actor<A0>::is_true = 0) const {
                return make_lazy<this_type, typename phoenix::as_actor<A0>::type>()(*this,
                                                                                    phoenix::as_actor<A0>::convert(
                                                                                            _0_));
            }
            ...
            operator()(A0 const &_0_, A1 const &_1_, typename detail::contains_actor<A0, A1>::is_true = 0) const {
                return make_lazy<this_type, typename phoenix::as_actor<A0>::type, typename phoenix::as_actor<A1>::type>()(
                        *this, phoenix::as_actor<A0>::convert(_0_), phoenix::as_actor<A1>::convert(_1_));
            }
            ...
            operator()(A0 const &_0_, A1 const &_1_, A2 const &_2_,
                ...
                return make_lazy<this_type, typename phoenix::as_actor<A0>::type, typename phoenix::as_actor<A1>::type, typename phoenix::as_actor<A2>::type>()(
                        *this, phoenix::as_actor<A0>::convert(_0_), phoenix::as_actor<A1>::convert(_1_),
