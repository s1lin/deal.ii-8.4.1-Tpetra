...
//        {};
    ...
    struct is_weak_substitute_impl<T, Expected,
            typename enable_if<
                    mpl::and_ <
                    is_container < T>, is_container < Expected>
...
template<typename T>
struct is_weak_substitute<T, T, typename enable_if<
...
struct compute_compatible_component_variant<Variant, Expected, mpl::false_, typename enable_if<detail::has_types<Variant> >::type> {
    ...
    typedef typename
    mpl::find_if<types, is_same < Expected, mpl::_1> >
    ::type
            iter;
    ...
    typedef typename
    mpl::eval_if<type, mpl::deref < iter>, mpl::identity <unused_type> >
    ::type
            compatible_type;
...
namespace detail {
    ...
    struct attribute_size_impl<Attribute, typename enable_if<
            mpl::and_ <
            fusion::traits::is_sequence < Attribute>, mpl::not_ < traits::is_container < Attribute> >
    >
    >::type> {
...
struct attribute_size_impl<Attribute, typename enable_if<
        mpl::and_ <
        traits::is_container < Attribute>, mpl::not_ < traits::is_iterator_range < Attribute> >
>
>::type>
{
...
static type call(optional < Attribute >
const& val)
{
if (!val)
return 0;
...
static type call(variant < BOOST_VARIANT_ENUM_PARAMS(T) >
const& val)
{
return
...
struct build_attribute_sequence {
    struct element_attribute {
        ...
        struct result<F(Element)> {
            typedef typename
            Transform<
                    typename attribute_of<Element, Context, Iterator>::type, Domain
            >::type
                    type;
        };
