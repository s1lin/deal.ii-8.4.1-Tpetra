                ...
                namespace detail {
                    ...
                    public:
                        parse_dispatcher(const Elements &elements, Iterator &first, Iterator const &last,
                                         Context &context, Skipper const &skipper, Flags &flags, Counters &counters,
                                         attr_reference attr) :
                                elements(elements), first(first), last(last), context(context), skipper(skipper),
                        ...
                        bool call_subject_unused(
                                Subject const &subject, Iterator &first, Iterator const &last, Context &context,
                        ...
                        bool call(T &idx, mpl::false_) const {
                            ...
                            if (
                                ...
                                return call_subject_unused(fusion::at_c<T::value>(elements), first, last, context,
                                                           skipper, idx);
                            }
                            return false;
                        }
                        ...
                        bool call(T &idx, mpl::true_) const {
                            ...
                            if (
                                ...
                                return call_subject(fusion::at_c<T::value>(elements), first, last, context, skipper,
                                                    idx);
                            }
                            return false;
                        }
                    ...
                    struct string_keywords {
                        ...
                        typedef typename mpl::or_<
                                no_case_modifier,
                                mpl::and_ <
                                all_directives_of_same_type, all_ikwd
                        >
                        >
                        ::type
                                no_case;
                        ...
                        typedef typename mpl::or_<
                                all_directives_of_same_type, no_case_modifier
                        ...
                        bool operator()(Component const &component) {
                            ...
                            if (
                                    extract_keyword::call(
                                            fusion::at_c<
                                                    Component::value, typename ParseDispatcher::elements_type
                                            >(dispatcher.elements)
                                    )
                                            .keyword.parse(
