        ...
        namespace repository {
            namespace qi {
                ...
                struct keywords : spirit::qi::nary_parser<keywords<Elements, Modifiers> > {
                    ...
                    BOOST_MPL_ASSERT_RELATION( non_kwd_subject_count::value,
                    ==, 0 );
                    ...
                    bool parse_impl(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                        ...
                        parser_visitor_type parse_visitor(elements, first, last, context, skipper, flags, counters,
                                                          attr);
                    ...
                    bool parse_impl(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                        ...
                        parser_visitor_type parse_visitor(elements, first, last, context, skipper, flags, counters,
                                                          attr);
                        no_case_parser_visitor_type no_case_parse_visitor(elements, first, last, context, skipper,
                                                                          flags, counters, attr);
                        ...
                        while (true) {
                            ...
                            if (string_keywords_inst.parse(first, last, parse_visitor, no_case_parse_visitor,
                                                           skipper)) {
                                save = first;
                            } else {
                                first = save;
