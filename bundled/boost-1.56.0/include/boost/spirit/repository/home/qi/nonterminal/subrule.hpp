        ...
        namespace repository {
            namespace qi {
                ...
                struct subrule_group
                    ...
                    bool
                    parse_subrule_id(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                                     Attribute &attr) const {
                    ...
                    bool
                    parse_subrule(Def const &def, Iterator &first, Iterator const &last, Context & /*caller_context*/,
                    ...
                    bool parse_subrule(Def const &def, Iterator &first, Iterator const &last, Context &caller_context,
                                       Skipper const &skipper, Attribute &attr, Params const &params) const {
                        // compute context type for this subrule
                        typedef typename Def::locals_type subrule_locals_type;
                        typedef typename Def::attr_type subrule_attr_type;
                        typedef typename Def::attr_reference_type subrule_attr_reference_type;
...
#include <boost/spirit/home/qi/nonterminal/detail/fcall.hpp>
                ...
                struct subrule
                    ...
                    bool
                    parse(Iterator &first, Iterator const &last, subrule_context <Group, Attributes, Locals> &context,
                          Skipper const &skipper, Attribute &attr) const {
