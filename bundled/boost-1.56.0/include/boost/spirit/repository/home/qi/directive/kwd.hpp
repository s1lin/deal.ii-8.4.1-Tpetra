        ...
        namespace repository {
            namespace qi {
                ...
                struct kwd_parser
                    ...
                    kwd_parser(Subject const &subject, typename add_reference<KeywordType>::type keyword,
                               LoopIter const &iter)
                    ...
                    bool parse_impl(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper,
                    ...
                    bool parse(Iterator &first, Iterator const &last, Context &context,
                               skipper_keyword_marker<Skipper, NoCasePass> const &skipper, Attribute &attr) const {
                ...
                struct complex_kwd_parser
                    ...
                    complex_kwd_parser(Subject const &subject, typename add_reference<KeywordType>::type keyword,
                                       LoopIter const &iter)
                            : subject(subject), iter(iter), keyword(keyword) {}
    ...
    namespace spirit {
        namespace qi {
            ...
            struct make_directive_internal_2_args {
                ...
                template<typename Terminal>
                result_type create_kwd(Terminal const &term, Subject const &subject, Modifiers const &modifiers,
