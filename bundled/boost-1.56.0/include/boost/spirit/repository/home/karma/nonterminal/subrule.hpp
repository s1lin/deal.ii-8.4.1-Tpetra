        ...
        namespace repository {
            namespace karma {
                ...
                struct subrule_group
                    ...
                    bool generate(OutputIterator &sink, Context &context, Delimiter const &delimiter,
                    ...
                    bool
                    generate(OutputIterator &sink, Context &context, Delimiter const &delimiter, Attribute const &attr,
                    ...
                    bool generate_subrule_id(OutputIterator &sink, Context &context, Delimiter const &delimiter,
                                             Attribute const &attr) const {
                    ...
                    bool generate_subrule(Def const &def, OutputIterator &sink, Context & /*caller_context*/,
                        ...
                        context_type context(*this, traits::pre_transform<spirit::karma::domain, subrule_attr_type>(
                ...
                struct subrule
                    ...
                    struct def_type_helper {
                        ...
                        typedef subrule_definition<
                                ID_, locals_type, attr_type, attr_reference_type, parameter_types, params_size, subject_type, Auto
                        > const type;
                    };
                    ...
                    bool generate(OutputIterator &sink, subrule_context <Group, Attributes, Locals> &context,
                                  Delimiter const &delimiter, Attribute const &attr) const {
                    ...
                    bool generate(OutputIterator &sink, subrule_context <Group, Attributes, Locals> &context,
                                  Delimiter const &delimiter, Attribute const &attr, Params const &params) const {
                        return context.group.template generate_subrule_id<ID_>(
