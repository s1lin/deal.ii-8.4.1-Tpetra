...
#define    BOOST_QUATERNION_NOT_EQUAL_GENERATOR  \
        ...
        template<typename T>
        inline bool operator!=(T const &lhs, quaternion<T> const &rhs) BOOST_QUATERNION_NOT_EQUAL_GENERATOR

        template<typename T>
        inline bool operator!=(quaternion<T> const &lhs, T const &rhs) BOOST_QUATERNION_NOT_EQUAL_GENERATOR

        template<typename T>
        inline bool
        operator!=(::std::complex<T> const &lhs, quaternion<T> const &rhs) BOOST_QUATERNION_NOT_EQUAL_GENERATOR

        template<typename T>
        inline bool
        operator!=(quaternion<T> const &lhs, ::std::complex<T> const &rhs) BOOST_QUATERNION_NOT_EQUAL_GENERATOR

        template<typename T>
        inline bool operator!=(quaternion<T> const &lhs, quaternion<T> const &rhs) BOOST_QUATERNION_NOT_EQUAL_GENERATOR
...
#undef    BOOST_QUATERNION_NOT_EQUAL_GENERATOR
        ...
        ::std::basic_istream<charT, traits> &operator>>(::std::basic_istream<charT, traits> &is,
            ...
            if (cc ==
                '(')                            // read "(", possible: (a), (a,b), (a,b,c), (a,b,c,d), (a,(c)), (a,(c,d)), ((a)), ((a),c), ((a),(c)), ((a),(c,d)), ((a,b)), ((a,b),c), ((a,b),(c)), ((a,b,),(c,d,))
            {
                ...
                if (cc ==
                    '(')                        // read "((", possible: ((a)), ((a),c), ((a),(c)), ((a),(c,d)), ((a,b)), ((a,b),c), ((a,b),(c)), ((a,b,),(c,d,))
                {
                    is.putback(ch);
                    ...
                    if (cc == ')')                    // format: ((a)) or ((a,b))
                    {
                        q = quaternion<T>(a, b);
                               ...
                               ',')                // read "((a)," or "((a,b),", possible: ((a),c), ((a),(c)), ((a),(c,d)), ((a,b),c), ((a,b),(c)), ((a,b,),(c,d,))
                    {
                        ...
                        if (cc ==
                            ')')                    // format: ((a),c), ((a),(c)), ((a),(c,d)), ((a,b),c), ((a,b),(c)) or ((a,b,),(c,d,))
                        {
                ...
                } else                                // read "(a", possible: (a), (a,b), (a,b,c), (a,b,c,d), (a,(c)), (a,(c,d))
                {
                    ...
                    if (cc == ')')                    // format: (a)
                    {
                        q = quaternion<T>(a);
                               ...
                               ',')                // read "(a,", possible: (a,b), (a,b,c), (a,b,c,d), (a,(c)), (a,(c,d))
                    {
