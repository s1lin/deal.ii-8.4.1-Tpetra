    ...
    namespace math {
        namespace ef {
            ...
            public:
                ...
                e_float operator-() const { return -m_value; }

                e_float const &operator+() const { return *this; }
...
// Comparison:
            inline bool operator==(const e_float &a, const e_float &b) { return a.value() == b.value() ? true : false; }
        ...
        namespace detail {
            ...
            template<>
            inline int fpclassify_imp<boost::math::ef::e_float>
            BOOST_NO_MACRO_EXPAND(boost::math::ef::e_float
            x, const generic_tag<true>&) {
            if(x.
    ...
    namespace ef {
        ...
        inline long ltrunc(const e_float &v, const Policy &pol) {
            ...
            if (fabs(r) > (std::numeric_limits<long>::max)())
                return static_cast<long>(policies::raise_rounding_error("boost::math::ltrunc<%1%>(%1%)", 0, 0L, v,
                                                                        pol));
        ...
        inline int iround(const e_float &v, const Policy &pol) {
            ...
            if (fabs(r) > (std::numeric_limits<int>::max)())
                return static_cast<int>(policies::raise_rounding_error("boost::math::iround<%1%>(%1%)", 0, v, 0,
                                                                       pol).value().extract_int64());
            return static_cast<int>(r.value().extract_int64());
        }
        ...
        inline long lround(const e_float &v, const Policy &pol) {
            ...
            e_float r = boost::math::round(v, pol);
            if (fabs(r) > (std::numeric_limits<long>::max)())
                return static_cast<long int>(policies::raise_rounding_error("boost::math::lround<%1%>(%1%)", 0, v, 0L,
                                                                            pol).value().extract_int64());
    ...
    namespace math {
        ...
        namespace policies {
            ...
            struct precision<::boost::math::ef::e_float, Policy> {
                ...
                typedef digits2<
                        ((::std::numeric_limits<::boost::math::ef::e_float>::digits10 + 1) * 1000L) / 301L> digits_2;
        ...
        namespace tools {
            ...
            template<>
            inline int
            digits<::boost::math::ef::e_float>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(::boost::math::ef::e_float)) {
            ...
            inline ::boost::math::ef::e_float forth_root_epsilon<::boost::math::ef::e_float>() {
                return detail::forth_root_epsilon_imp(static_cast< ::boost::math::ef::e_float const *>(0),
                                                      mpl::int_<0>());
            }
        ...
        template<class Policy>
        inline boost::math::ef::e_float
        skewness(const extreme_value_distribution <boost::math::ef::e_float, Policy> & /*dist*/) {
            //
        ...
        template<class Policy>
        inline boost::math::ef::e_float
        skewness(const rayleigh_distribution <boost::math::ef::e_float, Policy> & /*dist*/) {
            // using namespace boost::math::constants;
            return boost::lexical_cast<boost::math::ef::e_float>(
                    "0.63111065781893713819189935154422777984404221106391");
        ...
        template<class Policy>
        inline boost::math::ef::e_float
        kurtosis(const rayleigh_distribution <boost::math::ef::e_float, Policy> & /*dist*/) {
            // using namespace boost::math::constants;
        ...
        template<class Policy>
        inline boost::math::ef::e_float
        kurtosis_excess(const rayleigh_distribution <boost::math::ef::e_float, Policy> & /*dist*/) {
            //using namespace boost::math::constants;
            // Computed using NTL at 150 bit, about 50 decimal digits.
...
//
            ...
            boost::math::ef::e_float digamma_imp(boost::math::ef::e_float x, const mpl::int_<0> *, const Policy &pol) {
                ...
                if (x < 0) {
                    ...
                    //
                    if (remainder == 0) {
                        return policies::raise_pole_error<boost::math::ef::e_float>("boost::math::digamma<%1%>(%1%)", 0,
                                                                                    (1 - x), pol);
                    }
                    result = constants::pi<boost::math::ef::e_float>() /
                             tan(constants::pi<boost::math::ef::e_float>() * remainder);
                }
