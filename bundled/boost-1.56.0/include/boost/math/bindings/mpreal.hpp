...
*/
            ...
            inline mpfr::mpreal epsilon<mpfr::mpreal>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpfr::mpreal)) {
                return ldexp(mpfr::mpreal(1),
                             1 - boost::math::policies::digits<mpfr::mpreal, boost::math::policies::policy<> >());
            }
...
//
            ...
            mpfr::mpreal digamma_imp(mpfr::mpreal x, const mpl::int_<0> *, const Policy &pol) {
                ...
                if (x < 0) {
                    ...
                    //
                    if (remainder == 0) {
                        return policies::raise_pole_error<mpfr::mpreal>("boost::math::digamma<%1%>(%1%)", 0, (1 - x),
                                                                        pol);
                    }
...
//
            template<class Policy>
            mpfr::mpreal
            erf_inv_imp(const mpfr::mpreal &p, const mpfr::mpreal &q, const Policy &, const boost::mpl::int_<64> *) {
