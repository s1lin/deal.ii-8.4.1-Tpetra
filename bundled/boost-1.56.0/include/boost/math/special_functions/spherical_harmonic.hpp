...
//
            ...
            std::complex<T> spherical_harmonic(unsigned n, int m, U theta, U phi, const Policy &pol) {
                ...
                return std::complex<T>(policies::checked_narrowing_cast<T, Policy>(r, function),
        ...
        spherical_harmonic(unsigned n, int m, T1 theta, T2 phi, const Policy &pol) {
            ...
            return detail::spherical_harmonic<result_type, value_type>(n, m, static_cast<value_type>(theta),
        ...
        spherical_harmonic_r(unsigned n, int m, T1 theta, T2 phi, const Policy &pol) {
            ...
            return policies::checked_narrowing_cast<result_type, Policy>(
                    detail::spherical_harmonic_r(n, m, static_cast<value_type>(theta), static_cast<value_type>(phi),
                                                 pol),
        ...
        spherical_harmonic_i(unsigned n, int m, T1 theta, T2 phi, const Policy &pol) {
            ...
            typedef typename policies::evaluation<result_type, Policy>::type value_type;
            return policies::checked_narrowing_cast<result_type, Policy>(
                    detail::spherical_harmonic_i(n, m, static_cast<value_type>(theta), static_cast<value_type>(phi),
                                                 pol),
