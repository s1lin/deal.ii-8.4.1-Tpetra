    ...
    namespace math {
        namespace detail {
            ...
            inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const mpl::int_<53> &) {
                static const unsigned short ord[] = {2, 3, 4, 5, 7, 10, 12, 18, 10, 20, 30, 0, 4, 7, 8, 20, 0,
                                                     0}; // 18 entries
            ...
            inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const mpl::int_<64> &) {
                ...
                static const unsigned short ord[] = {3, 4, 5, 6, 8, 11, 13, 19, 10, 20, 30, 0, 7, 10, 11, 23, 0,
                                                     0}; // 18 entries
            ...
            inline RealType
            owens_t_T2(const RealType h, const RealType a, const unsigned short m, const RealType ah, const Policy &,
                       const mpl::false_ &) {
                BOOST_MATH_STD_USING
                using namespace boost::math::constants;
            ...
            owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const mpl::int_<64> &) {
                ...
                static const RealType c2[] =
                        {
                                BOOST_MATH_BIG_CONSTANT(RealType, 260,
            ...
            inline RealType owens_t_T4(const RealType h, const RealType a, const unsigned short m) {
                ...
                unsigned short ii = 1;
                RealType ai =
                        a * exp(-hs * (static_cast<RealType>(1) - as) * half<RealType>()) * one_div_two_pi<RealType>();
                RealType yi = 1;
                RealType val = 0;
            ...
            owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy &) {
                ...
                return std::pair<RealType, RealType>(val * exp(-hs * half<RealType>()) / (d * root_two_pi<RealType>()),
                                                     err);
            ...
            inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy &pol,
                ...
                static const unsigned short meth[] = {1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4, 4, 4, 4, 5,
                                                      6}; // 18 entries
