        ...
        namespace detail {
            ...
            inline T expint_as_fraction(unsigned n, T z, const Policy &pol) {
                ...
                T result = tools::continued_fraction_b(
                        ...
                        max_iter);
                policies::check_series_iterations<T>("boost::math::expint_continued_fraction<%1%>(unsigned,%1%)",
                                                     max_iter, pol);
            ...
            T expint_imp(unsigned n, T z, const Policy &pol, const Tag &tag) {
                ...
                if (z == 0)
                    return n == 1 ? policies::raise_overflow_error<T>(function, 0, pol) : T(
                            1 / (static_cast<T>(n - 1)));
...
#  pragma warning(pop)
            ...
            T expint_i_imp(T z, const Policy &pol, const mpl::int_<53> &tag) {
                ...
                if (z <= 6) {
                    ...
                    static const T r2 = BOOST_MATH_BIG_CONSTANT(T, 53,
                                                                0.131401834143860282009280387409357165515556574352422001206362e-16);
                    static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 53,
                    ...
                    static const T exp40 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 53,
            ...
            T expint_i_imp(T z, const Policy &pol, const mpl::int_<64> &tag) {
                ...
                if (z <= 6) {
                    ...
                    static const T r2 = BOOST_MATH_BIG_CONSTANT(T, 64,
                                                                0.131401834143860282009280387409357165515556574352422001206362e-16);
                    static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64,
                                                                              0.372507410781366634461991866580119133535689497771654051555657435242200120636201854384926049951548942392));
                    T t = (z / 3) - 1;
                    result = tools::evaluate_polynomial(P, t)
                             / tools::evaluate_polynomial(Q, t);
                    ...
                    static const T exp40 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64,
                                                                                  2.35385266837019985407899910749034804508871617254555467236651e17));
                    static const T Y = 1.013065338134765625F;
                    static const T P[9] = {
            ...
            void expint_i_imp_113a(T &result, const T &z, const Policy &pol) {
                ...
                static const T r3 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113,
                                                                           0.283806480836357377069325311780969887585024578164571984232357e-31));
                static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113,
                                                                          0.372507410781366634461991866580119133535689497771654051555657435242200120636201854384926049951548942392));
                T t = (z / 3) - 1;
                result = tools::evaluate_polynomial(P, t)
                         / tools::evaluate_polynomial(Q, t);
            ...
            T expint_i_imp(T z, const Policy &pol, const mpl::int_<113> &tag) {
                ...
                } else // z > 210
                {
                    ...
                    static const T exp40 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113,
                                                                                  2.35385266837019985407899910749034804508871617254555467236651e17));
