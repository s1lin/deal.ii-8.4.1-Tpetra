...
//
            inline unsigned digamma_large_lim(const mpl::int_<0> *) { return 20; }

            inline unsigned digamma_large_lim(const void *) { return 10; }
...
//
            ...
            T digamma_imp_1_2(T x, const mpl::int_<0> *) {
                ...
                static const T root5 = BOOST_MATH_BIG_CONSTANT(T, 113,
                                                               0.52112228569249997894452490385577338504019838794544e-36);
