...
//
            ...
            T beta_imp(T a, T b, const Lanczos &, const Policy &pol) {
                ...
                if (a <= 0)
                    return policies::raise_domain_error<T>("boost::math::beta<%1%>(%1%,%1%)",
                ...
                */
                ...
                result = Lanczos::lanczos_sum_expG_scaled(a) * Lanczos::lanczos_sum_expG_scaled(b) /
...
//
            ...
            template<class T, class Lanczos, class Policy>
            T ibeta_series(T a, T b, T x, T s0, const Lanczos &, bool normalised, T *p_derivative, T y,
                           const Policy &pol) {
                BOOST_MATH_STD_USING
...
//
            ...
            struct Pn_size {
                ...
                BOOST_STATIC_ASSERT(::boost::math::max_factorial<T>::value
                >= 100);
            };
            ...
            struct Pn_size<float> {
                ...
                BOOST_STATIC_ASSERT(::boost::math::max_factorial<float>::value
                >= 30);
            };
            ...
            struct Pn_size<double> {
                ...
                BOOST_STATIC_ASSERT(::boost::math::max_factorial<double>::value
                >= 60);
            };
...
//
            ...
            T ibeta_imp(T a, T b, T x, const Policy &pol, bool inv, bool normalised, T *p_derivative) {
                ...
                if (x == 0) {
                    if (p_derivative) {
                        *p_derivative = (a == 1) ? (T) 1 : (a < 1) ? T(tools::max_value<T>() / 2) : T(
                                tools::min_value<T>() * 2);
                    }
                ...
                if (x == 1) {
                    if (p_derivative) {
                        *p_derivative = (b == 1) ? T(1) : (b < 1) ? T(tools::max_value<T>() / 2) : T(
                                tools::min_value<T>() * 2);
                    }
                ...
                if (b == 1) {
                    ...
                    T p;
                    if (y < 0.5)
                        p = invert ? T(-boost::math::expm1(a * boost::math::log1p(-y, pol), pol)) : T(
                                exp(a * boost::math::log1p(-y, pol)));
                    else
                ...
                if ((std::min)(a, b) <= 1) {
                    ...
                    if ((std::max)(a, b) <= 1) {
                        ...
                        if ((a >= (std::min)(T(0.2), b)) || (pow(x, a) <= 0.9)) {
                            ...
                            if (y >= 0.3) {
                                if (!invert) {
                                    fract = ibeta_series(a, b, x, T(0), lanczos_type(), normalised, p_derivative, y,
                                                         pol);
                                    BOOST_MATH_INSTRUMENT_VARIABLE(fract);
                                } else {
                                    fract = -(normalised ? 1 : boost::math::beta(a, b, pol));
                                    invert = false;
                                    fract = -ibeta_series(a, b, x, fract, lanczos_type(), normalised, p_derivative, y,
                                                          pol);
                                    BOOST_MATH_INSTRUMENT_VARIABLE(fract);
                                }
                            } else {
                                ...
                                if (!invert) {
                                    fract = beta_small_b_large_a_series(T(a + 20), b, x, y, fract, prefix, pol,
                                                                        normalised);
                                    BOOST_MATH_INSTRUMENT_VARIABLE(fract);
                                } else {
                                    fract -= (normalised ? 1 : boost::math::beta(a, b, pol));
            ...
            T ibeta_derivative_imp(T a, T b, T x, const Policy &pol) {
                ...
                if (x == 0) {
                    return (a > 1) ? 0 :
                           (a == 1) ? 1 / boost::math::beta(a, b, pol) : policies::raise_overflow_error<T>(function, 0,
                                                                                                           pol);
                } else if (x == 1) {
                    return (b > 1) ? 0 :
                           (b == 1) ? 1 / boost::math::beta(a, b, pol) : policies::raise_overflow_error<T>(function, 0,
                                                                                                           pol);
                }
                //
...
//
            ...
            beta(RT1 a, RT2 b, const Policy &, const mpl::true_ *) {
                ...
                return policies::checked_narrowing_cast<result_type, forwarding_policy>(
                        detail::beta_imp(static_cast<value_type>(a), static_cast<value_type>(b), evaluation_type(),
                                         forwarding_policy()), "boost::math::beta<%1%>(%1%,%1%)");
            }
...
//
        ...
        beta(RT1 a, RT2 b, RT3 x, const Policy &) {
            ...
            return policies::checked_narrowing_cast<result_type, forwarding_policy>(
                    detail::ibeta_imp(static_cast<value_type>(a), static_cast<value_type>(b),
        ...
        ibeta_derivative(RT1 a, RT2 b, RT3 x, const Policy &) {
            ...
            return policies::checked_narrowing_cast<result_type, forwarding_policy>(
                    detail::ibeta_derivative_imp(static_cast<value_type>(a), static_cast<value_type>(b),
