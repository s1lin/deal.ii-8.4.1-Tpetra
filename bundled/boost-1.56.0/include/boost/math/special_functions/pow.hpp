    ...
    namespace math {
        ...
        namespace detail {
            ...
            struct power_if_positive {
                ...
                static T result(T base, const Policy &) { return positive_power<N>::result(base); }
            };
        ...
        inline typename tools::promote_args<T>::type pow(T base) { return pow<N>(base, policies::policy<>()); }
