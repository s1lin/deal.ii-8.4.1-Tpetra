        ...
        namespace detail {
            namespace bessel_zero {
                ...
                static T equation_as_9_5_26(const T &v, const T &ai_bi_root) {
                    ...
                    const int my_digits10 = static_cast<int>(static_cast<float>(boost::math::tools::digits<T>() *
                                                                                0.301F));
                ...
                namespace cyl_bessel_j_zero_detail {
                    ...
                    template<class T>
                    bool my_bisection_unreachable_tolerance(const T &, const T &) { return false; }
                    ...
                    T initial_guess(const T &v, const int m, const Policy &pol) {
                        ...
                        if (v < 0) {
                            ...
                            T root_hi = boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(
                                    vv_floor, m, pol);
                            T root_lo;
                            ...
                            if (m == 1) {
                                ...
                                const bool hi_end_of_bracket_is_negative = (boost::math::cyl_bessel_j(v, root_hi, pol) <
                                                                            0);

                                while ((root_lo > boost::math::tools::epsilon<T>())) {
                                    const bool lo_end_of_bracket_is_negative = (
                                            boost::math::cyl_bessel_j(v, root_lo, pol) < 0);
                        ...
                        if (m == 1U) {
                            ...
                            if (v < 2.2F) {
                                ...
                                guess = boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::equation_nist_10_21_40_a(
                                        v);
                            }
                        } else {
                            if (v < 2.2F) {
                                ...
                                const T
                                airy_ai_root(boost::math::detail::airy_zero::airy_ai_zero_detail::initial_guess<T>(m));
                    ...
                    T initial_guess(const T &v, const int m, const Policy &pol) {
                        ...
                        if (v < 0) {
                            ...
                            if (m == 1) {
                                ...
                                const bool hi_end_of_bracket_is_negative = (boost::math::cyl_neumann(v, root_hi, pol) <
                                                                            0);

                                while ((root_lo > boost::math::tools::epsilon<T>())) {
                                    const bool lo_end_of_bracket_is_negative = (
                                            boost::math::cyl_neumann(v, root_lo, pol) < 0);
                        ...
                        if (m == 1U) {
                            ...
                            if (v < 2.2F) {
                                ...
                                guess = boost::math::detail::bessel_zero::cyl_neumann_zero_detail::equation_nist_10_21_40_b(
                                        v);
                            }
                        } else {
                            if (v < 2.2F) {
                                ...
                                const T
                                airy_bi_root(boost::math::detail::airy_zero::airy_bi_zero_detail::initial_guess<T>(m));
