...
//
            ...
            T inverse_students_t_tail_series(T df, T v, const Policy &pol) {
                ...
                d[6] = -df * (df + 1) * (df + 11)
                       *
                       ((((((((((((945 * df) + 31506) * df + 425858) * df + 2980236) * df + 11266745) * df + 20675018) *
                             df + 7747124) * df - 22574632) * df - 8565600) * df + 18108416) * df - 7099392) * df +
                        884736)
            ...
            T inverse_students_t(T df, T u, T v, const Policy &pol, bool *pexact = 0) {
                ...
                if ((floor(df) == df) && (df < 20)) {
                    ...
                    if (df > 0x10000000) {
                        ...
                        //
                        T crossover = ldexp(1.0f, iround(T(df / -0.654f), typename policies::normalise<Policy,
            ...
            inline T fast_students_t_quantile(T df, T p, const Policy &pol) {
                ...
                return policies::checked_narrowing_cast<T, forwarding_policy>(
                        fast_students_t_quantile_imp(static_cast<value_type>(df), static_cast<value_type>(p), pol,
                                                     static_cast<tag_type *>(0)),
