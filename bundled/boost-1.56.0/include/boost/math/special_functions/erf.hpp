                ...
                if (z < 0.5) {
                    ...
                    if (z < 1e-10) {
                        if (z == 0) {
                            ...
                            static const T c = BOOST_MATH_BIG_CONSTANT(T, 53,
                    ...
                    if (z < 1.5f) {
                        ...
                        result = Y +
                                 tools::evaluate_polynomial(P, T(z - 0.5)) / tools::evaluate_polynomial(Q, T(z - 0.5));
                        ...
                        result = Y +
                                 tools::evaluate_polynomial(P, T(z - 1.5)) / tools::evaluate_polynomial(Q, T(z - 1.5));
                        result *= exp(-z * z) / z;
                    } else if (z < 4.5f) {
                        ...
                        result = Y +
                                 tools::evaluate_polynomial(P, T(z - 3.5)) / tools::evaluate_polynomial(Q, T(z - 3.5));
                        result *= exp(-z * z) / z;
                    } else {
