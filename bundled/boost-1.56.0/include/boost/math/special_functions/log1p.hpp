...
//
            ...
            T log1p_imp(T const &x, const Policy &pol,
                        const mpl::int_<0> &) { // The function returns the natural logarithm of 1 + x.
            ...
            template<class T, class Policy>
            T log1p_imp(T const &x, const Policy &pol,
                        const mpl::int_<53> &) { // The function returns the natural logarithm of 1 + x.
                BOOST_MATH_STD_USING
            ...
            template<class T, class Policy>
            T log1p_imp(T const &x, const Policy &pol,
                        const mpl::int_<64> &) { // The function returns the natural logarithm of 1 + x.
                BOOST_MATH_STD_USING
            ...
            template<class T, class Policy>
            T log1p_imp(T const &x, const Policy &pol,
                        const mpl::int_<24> &) { // The function returns the natural logarithm of 1 + x.
                BOOST_MATH_STD_USING
