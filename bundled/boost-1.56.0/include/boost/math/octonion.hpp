...
template<typename T>
inline octonion <T>                        operator+(octonion < T >
const & o)
{
return(o);
}
...
template<typename T>
inline bool                                operator==(octonion < T >
const & lhs,
T const &rhs
)
{
...
template<typename T>
inline bool                                operator==(::std::complex < T >
const & lhs,
...
template<typename T>
inline bool operator!=(T const &lhs, octonion <T> const &rhs) BOOST_OCTONION_NOT_EQUAL_GENERATOR
...
template<typename T>
inline bool
operator!=(::boost::math::quaternion<T> const &lhs, octonion <T> const &rhs) BOOST_OCTONION_NOT_EQUAL_GENERATOR
                    ...
                    } else if (cc == ',')                            // read "((a),"
                    {
                        ...
                        if (cc == '(')                            // read "((a),("
                        {
                            ...
                            if (cc == '(')                            // read "((a),(("
                            {
                                ...
                                is.putback(
                                        ch);                                // we backtrack twice, with the same value!
                                ...
                                } else if (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                {
                                    ...
                                    } else                                    // read "((a),(c,d" or "((a),(e,f"
                                    {
                                                   ...
                                                   ',')                        // read "((a),(e,f," (ambiguity resolution)
                                        {
                                            ...
                                            is
                                                    >> g;                                // read "((a),(e,f,g" (too late to backtrack)
                                            ...
                                            if (cc == ')')                        // read "((a),(e,f,g)"
                                            {
                                                q = ::boost::math::quaternion<T>(c, d,
                                                                                 g);        // "c" was actually "e", and "d" was actually "f"
                                            ...
                                            } else if (cc == ',')                        // read "((a),(e,f,g,"
                                            {
                                                ...
                                                {
                                                    q = ::boost::math::quaternion<T>(c, d, g,
                                                                                     h);    // "c" was actually "e", and "d" was actually "f"
                                            ...
                                            } else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                            {
                                                           ...
                                                           ',')                            // read "((a,b),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if (cc == ')')                            // read "((a,b),(e,f,g)"
                                                    {
                                                        ...
                                                        {
                                                            q = ::boost::math::quaternion<T>(c, d,
                                                                                             g);            // "c" is actually "e" and "d" is actually "f"
                                                               ...
                                                               ',')                            // read "((a,b),(e,f,g,"
                                                    {
                                                            ...
                                                            ')')                            // read "((a,b),(e,f,g,h)"
                                                        {
                                                            ...
                                                            {
                                                                q = ::boost::math::quaternion<T>(c, d, g,
                                                                                                 h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                } else                                        // read "(a,b,c,d" (ambiguity resolution)
                                {
                                    ...
                                    } else if (cc == ',')                            // read "(a,b,c,d,"
                                    {
                                        ...
                                        } else if (cc == ',')                            // read "(a,b,c,d,e,"
                                        {
                                            ...
                                            {
                                                is
                                                        >> g;                                    // read "(a,b,c,d,e,f,g"                                    // read "(a,b,c,d,e,f"
                                                ...
                                                {
                                                    is
                                                            >> h;                                    // read "(a,b,c,d,e,f,g,h"                                    // read "(a,b,c,d,e,f,g"                                    // read "(a,b,c,d,e,f"
...
template<typename T>
inline octonion <T> unreal(octonion < T >
const & o)
{
return(o.
...
template<typename T>
inline octonion <T> conj(octonion < T >
const & o)
{
return(octonion<T>( +o.
...
template<typename T>
inline octonion <T> exp(octonion < T >
const & o)
{
using ::std::exp;
using ::std::cos;
...
template<typename T>
inline octonion <T> cos(octonion < T >
const & o)
{
using ::std::sin;
using ::std::cos;
...
template<typename T>
inline octonion <T> sin(octonion < T >
const & o)
{
using ::std::sin;
using ::std::cos;
...
template<typename T>
inline octonion <T> tan(octonion < T >
const & o)
{
return(
sin(o)
...
template<typename T>
inline octonion <T> cosh(octonion < T >
const & o)
{
...
template<typename T>
inline octonion <T> sinh(octonion < T >
const & o)
{
return((exp(+o)-exp(-o))/static_cast<T>(2));
}
...
template<typename T>
inline octonion <T> tanh(octonion < T >
const & o)
{
return(
sinh(o)
...
{
return(
pow(octonion<T>(static_cast<T>(1))
/o,-n));
}
}
...
namespace detail {
    ...
    template<typename T,
            typename U
    >
    octonion <T> octonion_type_converter(octonion < U >
    const & rhs) {
    return(octonion <T>( static_cast
    <T>(rhs
    .
