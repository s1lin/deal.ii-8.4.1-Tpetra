...
//
            ...
            inline V evaluate_polynomial(const boost::array<T, N> &a, const V &val) {
                typedef mpl::int_ <N> tag_type;
                return detail::evaluate_polynomial_c_imp(static_cast<const T *>(a.data()), val,
                                                         static_cast<tag_type const *>(0));
            }
...
//
            ...
            inline V evaluate_odd_polynomial(const T(&a)[N], const V &z) {
                ...
                return a[0] + z * detail::evaluate_polynomial_c_imp(static_cast<const T *>(a) + 1, V(z * z),
                                                                    static_cast<tag_type const *>(0));
            }
            ...
            inline V evaluate_odd_polynomial(const boost::array<T, N> &a, const V &z) {
                typedef mpl::int_<N - 1> tag_type;
                return a[0] + z * detail::evaluate_polynomial_c_imp(static_cast<const T *>(a.data()) + 1, V(z * z),
                                                                    static_cast<tag_type const *>(0));
            }
