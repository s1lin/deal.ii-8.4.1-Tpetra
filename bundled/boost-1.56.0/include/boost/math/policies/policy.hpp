...
//
                ...
                struct is_default_policy_imp {
                    BOOST_STATIC_CONSTANT(bool, value =
                    sizeof(::boost::math::policies::detail::test_is_default_arg(static_cast<T *>(0))) == 1);
                };
...
//
            ...
            private:
                ...
                typedef typename detail::append_N<reduced_list, default_policy, (14 -
                                                                                 ::boost::mpl::size<reduced_list>::value)>::type result_type;
            public:
                typedef policy<
...
//
            ...
            inline policy<> make_policy() { return policy<>(); }
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4>::type
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5>::type
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7>::type
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8>::type
            make_policy(const A1 &, const A2 &, const A3 &, const A4 &, const A5 &, const A6 &, const A7 &,
                        const A8 &) {
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9>::type
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>::type
            make_policy(const A1 &, const A2 &, const A3 &, const A4 &, const A5 &, const A6 &, const A7 &, const A8 &,
                        const A9 &, const A10 &) {
            ...
            inline typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11>::type
            make_policy(const A1 &, const A2 &, const A3 &, const A4 &, const A5 &, const A6 &, const A7 &, const A8 &,
                        const A9 &, const A10 &, const A11 &) {
...
//
            ...
            namespace detail {
                ...
                struct is_policy_imp {
                    BOOST_STATIC_CONSTANT(bool, value = (
                            sizeof(::boost::math::policies::detail::test_is_policy(static_cast<P *>(0))) == 1));
                };
