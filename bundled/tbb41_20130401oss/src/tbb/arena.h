        ...
        private:
            ...
            static int allocation_size(unsigned max_num_workers) {
                return sizeof(base_type) +
                       num_slots_to_reserve(max_num_workers) * (sizeof(mail_outbox) + sizeof(arena_slot));
            }
            ...
            inline bool
            may_have_tasks(generic_scheduler *, arena_slot &, bool &tasks_present, bool &dequeuing_possible);
