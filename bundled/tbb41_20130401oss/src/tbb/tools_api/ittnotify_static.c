...
static __itt_group_alias group_alias[] = {
        ...
        {"KMP_FOR_TCHECK",   (__itt_group_id) (__itt_group_control | __itt_group_thread | __itt_group_sync |
                                               __itt_group_fsync | __itt_group_mark)},
                    ...
                    if (__itt_ittapi_global.lib != NULL) {
                        ...
                        switch (lib_version) {
                            ...
                            case 1:
                                ...
                                for (i = 0; __itt_ittapi_global.api_list_ptr[i].name != NULL; i++) {
                                    if (__itt_ittapi_global.api_list_ptr[i].group & groups & init_groups) {
                                        *__itt_ittapi_global.api_list_ptr[i].func_ptr = (void *) __itt_get_proc(
                                                __itt_ittapi_global.lib, __itt_ittapi_global.api_list_ptr[i].name);
                                        if (*__itt_ittapi_global.api_list_ptr[i].func_ptr == NULL) {
                                            /* Restore pointers for function with static implementation */
                                            *__itt_ittapi_global.api_list_ptr[i].func_ptr = __itt_ittapi_global.api_list_ptr[i].null_func;
                                            __itt_report_error(__itt_error_no_symbol, lib_name,
                            ...
                            for (i = 0; __itt_ittapi_global.api_list_ptr[i].name != NULL; i++)
                                ...
                                break;
                            case 2:
                                __itt_api_init_ptr = (__itt_api_init_t *) __itt_get_proc(__itt_ittapi_global.lib,
                                                                                         "__itt_api_init");
