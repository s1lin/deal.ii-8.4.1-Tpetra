...
#define DYNAMIC_LINK_WARNING dynamic_link_warning
        ...
        static bool
        resolve_symbols(dynamic_link_handle module, const dynamic_link_descriptor descriptors[], size_t required) {
...
#define ATOMIC_ONCE_DECL( var ) pthread_once_t var = PTHREAD_ONCE_INIT
        ...
        */
        ...
        pin_symbols(dynamic_link_descriptor desc, const dynamic_link_descriptor descriptors[], size_t required) {
        ...
        static dynamic_link_handle
        global_symbols_link(const char *library, const dynamic_link_descriptor descriptors[], size_t required) {
#if _WIN32
            dynamic_link_handle library_handle;
        ...
        dynamic_link_handle
        dynamic_load(const char *library, const dynamic_link_descriptor descriptors[], size_t required) {
#if __TBB_DYNAMIC_LOAD_ENABLED
#if _XBOX
        ...
        bool dynamic_link(const char *library, const dynamic_link_descriptor descriptors[], size_t required,
                          dynamic_link_handle *handle, int flags) {
            // TODO: May global_symbols_link find weak symbols?
            dynamic_link_handle library_handle = (flags & DYNAMIC_LINK_GLOBAL) ? global_symbols_link(library,
                                                                                                     descriptors,
                                                                                                     required) : 0;
