...
namespace tbb {
    ...
    namespace internal {
        ...
        void concurrent_vector_base::internal_grow_to_at_least(size_type new_size, size_type element_size,
        ...
        public:
            static segment_index_t find_segment_end(const concurrent_vector_base &v) {
                ...
                segment_index_t u =
                        v.my_segment == (&(v.my_storage[0])) ? pointers_per_short_segment : pointers_per_long_segment;
                segment_index_t k = 0;
        ...
        void concurrent_vector_base::internal_reserve(size_type n, size_type element_size, size_type max_size) {
            if (n > max_size) {
                __TBB_THROW(std::length_error(
                        "argument to concurrent_vector::reserve exceeds concurrent_vector::max_size()"));
            }
        ...
        void concurrent_vector_base::internal_copy(const concurrent_vector_base &src, size_type element_size,
        ...
        void concurrent_vector_base::internal_assign(const concurrent_vector_base &src, size_type element_size,
        ...
        concurrent_vector_base::size_type
        concurrent_vector_base::internal_grow_by(size_type delta, size_type element_size, internal_array_op1 init) {
            size_type result = my_early_size.fetch_and_add(delta);
            internal_grow(result, result + delta, element_size, init);
            return result;
        }

        void concurrent_vector_base::internal_grow(const size_type start, size_type finish, size_type element_size,
                                                   internal_array_op1 init) {
