...
//! @cond INTERNAL
    namespace internal {
        ...
        protected:
            ...
            internal_reserve( size_type
            n,
            size_type element_size, size_type
            max_size );

            size_type __TBB_EXPORTED_METHOD

            internal_capacity() const;
            ...
            *internal_array_op2)(
            void *dst,
            const void *src, size_type
            n );

            void __TBB_EXPORTED_METHOD
            internal_grow_to_at_least( size_type
            new_size,
            size_type element_size, internal_array_op1
            init );
            ...
            init );
            void *__TBB_EXPORTED_METHOD
            internal_push_back( size_type
            element_size,
            size_type &index
            );
            void __TBB_EXPORTED_METHOD
            internal_clear( internal_array_op1
            destroy,
            bool reclaim_storage
            );
            void __TBB_EXPORTED_METHOD

            internal_copy(const concurrent_vector_base &src, size_type element_size, internal_array_op2 copy);

            void __TBB_EXPORTED_METHOD

            internal_assign(const concurrent_vector_base &src, size_type element_size,
...
/** @ingroup containers */
    ...
    private:
        ...
        initialize_array(void *begin, size_type n);

        //! Construct n instances of T, starting at "begin".
        static void __TBB_EXPORTED_FUNC

        copy_array(void *dst, const void *src, size_type n);
        ...
        destroy_array(void *begin, size_type n);
    };
