    ...
    namespace internal {
            ...
            task *execute() {
                if (is_recycled) {
                    ...
                    internal::function_invoker<function2> *invoker2 = new(
                            allocate_child()) internal::function_invoker<function2>(my_func2);
                    ...
                    if (n > 2) {
                        internal::function_invoker<function3> *invoker3 = new(
                                allocate_child()) internal::function_invoker<function3>(my_func3);
        ...
        public:
            ...
            void add_child(const function &_func) {
                internal::function_invoker<function> *invoker = new(
            ...
            void add_children(const function1 &_func1, const function2 &_func2) {
                ...
                internal::spawner<2, function1, function2, parallel_invoke_noop> &sub_root = *new(
                        allocate_child())internal::spawner<2, function1, function2, parallel_invoke_noop>(_func1,
                                                                                                          _func2, noop);
                spawn(sub_root);
            }
