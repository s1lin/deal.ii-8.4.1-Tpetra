    ...
    namespace interface6 {
        ...
        private:
            ...
            public:
                ...
                handle_object(handle_move_t m) : my_cache_pointer(&m.my_cache_ref),
        ...
        private:
            ...
            struct retrieve_aggregator_operation : aggregator_operation, private internal::no_assign {
                ...
                retrieve_aggregator_operation(key_type key) : aggregator_operation(aggregator_operation::op_retive),
        ...
        private:
            typename map_storage_type::reference retrieve_serial(key_type k, bool &is_new_value_needed) {
                ...
                if (it == my_map_storage.end()) {
                    it = my_map_storage.insert(it, std::make_pair(k, map_value_type(value_type(), 0, my_lru_list.end(),
                                                                                    false)));
