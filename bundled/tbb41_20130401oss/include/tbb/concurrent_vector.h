...
//! @cond INTERNAL
    namespace internal {
        ...
        protected:
            ...
            void *
            __TBB_EXPORTED_METHOD internal_compact(size_type element_size, void *table, internal_array_op1 destroy,
            ...
            void __TBB_EXPORTED_METHOD
            internal_resize(size_type n, size_type element_size, size_type max_size, const void *src,
            ...
            void __TBB_EXPORTED_METHOD
            internal_grow_to_at_least(size_type new_size, size_type element_size, internal_array_op2 init,
                                      const void *src);
    ...
    public:
        ...
        concurrent_vector(std::initializer_list<T> init_list, const allocator_type &a = allocator_type())
            ...
            __TBB_TRY {
                ...
                internal_free_segments(reinterpret_cast<void **>(table), internal_clear(&destroy_array),
                                       my_first_block);
                __TBB_RETHROW();
            }
        ...
        iterator grow_by(size_type delta, const_reference t) {
            return iterator(*this, delta ? internal_grow_by(delta, sizeof(T), &initialize_array_by,
                                                            static_cast<const void *>(&t)) : my_early_size);
        }
...
#pragma warning (pop)
    ...
    template<typename T, class A>
    void
    concurrent_vector<T, A>::internal_free_segments(void *table[], segment_index_t k, segment_index_t first_block) {
        // Free the arrays
        while (k > first_block) {
            --k;
    ...
    T &concurrent_vector<T, A>::internal_subscript(size_type index) const {
        ...
        __TBB_ASSERT((segment_t *) my_segment != my_storage || k < pointers_per_short_table,
