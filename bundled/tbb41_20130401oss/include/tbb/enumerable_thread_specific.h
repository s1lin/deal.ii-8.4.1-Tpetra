    ...
    namespace interface6 {
        ...
        namespace internal {
            ...
            protected:
                ...
                static size_t hash(key_type k) {
                    ...
                    return uintptr_t(k) *
                           tbb::internal::select_size_t_constant<0x9E3779B9, 0x9E3779B97F4A7C15ULL>::value;
                }
        ...
        class enumerable_thread_specific : internal::ets_base<ETS_key_type> {
            ...
            public:
                ...
                generic_range_type(I begin_, I end_, size_t grainsize_ = 1) : blocked_range<I>(begin_, end_,
                                                                                               grainsize_) {}

                template<typename U>
                generic_range_type(const generic_range_type<U> &r) : blocked_range<I>(r.begin(), r.end(),
                                                                                      r.grainsize()) {}
            ...
            void unconstruct_locals() {
                for (typename internal_collection_type::iterator cvi = my_locals.begin();
                     cvi != my_locals.end(); ++cvi) {
                    cvi->unconstruct();
                }
            }
        ...
        public:
            ...
            enumerable_thread_specific() :
                    my_construct_callback(
                            internal::callback_leaf<T, internal::construct_by_default<T> >::make(/*dummy argument*/
                                    0)) {}
