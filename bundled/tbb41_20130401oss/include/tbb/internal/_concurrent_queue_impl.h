...
/** @ingroup containers */
            ...
            class concurrent_queue_iterator_base_v3 : no_assign {
                ...
                friend bool
                operator==(const concurrent_queue_iterator<C, T> &i, const concurrent_queue_iterator<C, U> &j);
            ...
            template<typename Value>
            void
            concurrent_queue_iterator_base_v3<Value>::assign(const concurrent_queue_iterator_base_v3<Value> &other) {
            ...
            void concurrent_queue_iterator_base_v3<Value>::advance() {
                ...
                if (i == queue.my_rep->items_per_page - 1) {
                    typename concurrent_queue_base_v3<Value>::page *&root = my_rep->array[concurrent_queue_rep<Value>::index(
                            k)];
                    root = root->next;
                }
                // advance k
...
/** @ingroup containers */
        ...
        protected:
            ...
            //! Copy constructor
            concurrent_queue_iterator_base_v3(const concurrent_queue_iterator_base_v3 &i) : my_rep(NULL),
                                                                                            my_item(NULL) {
                assign(i);
            }
...
/** Value is either the T or const T type of the container.
    @ingroup containers */
        ...
        class concurrent_queue_iterator : public concurrent_queue_iterator_base,
            ...
            template<typename T, class A>
            friend
            class ::tbb::deprecated::concurrent_queue;
