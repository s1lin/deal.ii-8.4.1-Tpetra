            ...
            public:
                ...
                struct node : tbb::internal::no_assign {
                    ...
                    nodeptr_t atomic_set_next(nodeptr_t new_node, nodeptr_t current_node) {
                        ...
                        nodeptr_t exchange_node = (nodeptr_t) __TBB_CompareAndSwapW((void *) &my_next,
                                                                                    (uintptr_t) new_node,
                ...
                iterator get_iterator(raw_iterator it) {
                    __TBB_ASSERT(it.get_node_ptr() == NULL || !it.get_node_ptr()->is_dummy(),
                ...
                try_insert(raw_iterator it, raw_iterator next, const value_type &value, sokey_t order_key,
                           size_type *new_count) {
...
// Template class for hash compare
            ...
            public:
                ...
                hash_compare(Hasher a_hasher, Key_equality a_keyeq) : my_hash_object(a_hasher),
            ...
            private:
                ...
                std::pair<iterator, bool> internal_insert(const value_type &value) {
                    ...
                    for (;;) {
                        if (where == last || solist_t::get_order_key(where) > order_key) {
                            // Try to insert it in the right place
                            std::pair<iterator, bool> result = my_solist.try_insert(it, where, value, order_key,
                                                                                    &new_count);
                ...
                void adjust_table_size(size_type total_elements, size_type current_size) {
                    ...
                    if (((float) total_elements / (float) current_size) > my_maximum_bucket_size) {
                        ...
                        __TBB_CompareAndSwapW((uintptr_t *) &my_number_of_buckets, uintptr_t(2u * current_size),
