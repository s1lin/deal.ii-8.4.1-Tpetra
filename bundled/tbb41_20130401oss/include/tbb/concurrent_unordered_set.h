...
// Template class for hash set traits
        ...
        public:
            ...
            concurrent_unordered_set(Iterator first, Iterator last, size_type n_of_buckets = 8,
        ...
        public:
            ...
            concurrent_unordered_multiset(const concurrent_unordered_multiset &table, const Allocator &a) : base_type(
                    table, a) {
            }
