...
/* ========================================================================= */
    ...
    for (i = 0; i < n; i++) {
        if (Nv[i] == 0) {
            ...
            AMD_DEBUG1 (("Path compression, i unordered: "
                                ID
                                "\n", i));
            j = Pe[i];
            ASSERT (j >= EMPTY && j < n);
