...
GLOBAL Int UMFPACK_report_symbolic
    ...
    if (prl >= 4) {
        ...
        PRINTF (("\tnumber of entries: "
                        ID
                        "\n", nz));
        PRINTF (("    block size used for dense matrix kernels:   "
                        ID
                        "\n",
                                Symbolic->nb));
        ...
        PRINTF (("\tnumber of frontal chains: "
                        ID
                        "\n", nchains));
        PRINTF (("\tnumber of frontal matrices: "
                        ID
                        "\n", nfr));
        PRINTF (("\tlargest frontal matrix row dimension: "
                        ID
                        "\n", maxnrows));
        PRINTF (("\tlargest frontal matrix column dimension: "
                        ID
                        "\n", maxncols));
    }
    ...
    for (chain = 0; chain < nchains; chain++) {
        ...
        PRINTF4 (("\tLargest frontal matrix in Frontal chain: "
                         ID
                         "-by-"
                         ID
                         "\n",
        ...
        for (frontid = frontid1; frontid <= frontid2; frontid++) {
            ...
            PRINTF4 (("\t    leftmost descendant: "
                             ID
                             "\n",
                                     INDEX(Front_leftmostdesc[frontid])));
            PRINTF4 (("\t    1st new candidate row : "
                             ID
                             "\n",
