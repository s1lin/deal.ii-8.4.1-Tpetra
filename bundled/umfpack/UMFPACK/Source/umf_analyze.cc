...
#pragma ivdep
    ...
    for (j = 0; j < n_col; j = jnext) {
        ...
        if (jlast != EMPTY && Link[j] == jlast) {
            ...
            DEBUG1 (("GOT:last front is child of this one: j "
                            ID
                            " jlast "
                            ID
                            "\n",
        ...
        npivots = j2 - j + 1;
        DEBUG1 (("Number of pivot columns: "
                        ID
                        "\n", npivots));
