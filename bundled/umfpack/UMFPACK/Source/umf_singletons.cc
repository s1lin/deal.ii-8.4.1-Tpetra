    ...
    *p_n1c = 0;
    ...
    if (!found) {
        ...
        for (p = Ap[pivcol]; p < Ap[pivcol + 1]; p++) {
            if (Rdeg[Ai[p]] == 1) {
                DEBUG0 (("Row singleton in first col: "
                                ID
                                " row: "
                                ID
                                "\n",
    ...
    for (k = 0; k < n_col; k++) {
        ...
        if (found) {
            ...
            DEBUG0 (("Found a col singleton: k "
                            ID
                            " pivcol "
                            ID
                            "\n", k, pivcol));
            ...
            for (p = Ap[pivcol]; p < p2; p++) {
                pivrow = Ai[p];
                if (Rdeg[pivrow] == 1) {
                    DEBUG0 (("Row singleton in pivcol: "
                                    ID
                                    " row: "
                                    ID
                                    "\n",
...
GLOBAL Int UMF_singletons
    ...
    DEBUGm4 (("Submatrix square and symmetrically permuted? "
                     ID
                     "\n", is_sym));
    DEBUGm4 (("singletons "
                     ID
