...
%
See also
umfpack, umfpack2, umfpack_details, dmperm
...
diagonal block
back substitution
b (1:k1-1,:) = b (1:k1-1,:) - A (1:k1-1, k1:k2) *
x (k1
:k2,:);
...
function [r, nblocks, is_triangular] =
merge_singletons (r)
%
%
Given r
...
nblocks = length(r) - 1;
bsize = r(2
:nblocks+1) - r (1:nblocks);
t = [0(bsize == 1)];
z = (t(1
:nblocks) == 0 & t (2:nblocks+1) == 1) | t (2:nblocks+1) == 0;
y = [(find(z)) nblocks + 1
];
r = r(y);
nblocks = length(y) - 1;
is_triangular = y(2
:nblocks+1) - y (1:nblocks) > 1;
